...
(assert
 ...
 (not $x12)))
(assert
 (let (($x15 (bvsgt symbol_2 (_ bv5 32))))
...
(assert
 (let (($x26 (bvsgt symbol_1 (_ bv5 32))))
 (not $x26)))
(assert
 (let (($x29 (bvsgt symbol_0 (_ bv5 32))))
 (not $x29)))
(assert
 (bvsgt symbol_5 (_ bv5 32)))
(assert
 (let (($x32 (bvsgt symbol_4 (_ bv5 32))))
 (not $x32)))
(assert
 (let (($x35 (bvsgt symbol_3 (_ bv5 32))))
 (not $x35)))
(check-sat)
