...
(assert
 ...
 (let ((?x52 (bvshl ?x51 (_ bv24 32))))
 (let ((?x53 (bvashr ?x52 (_ bv24 32))))
 (let ((?x65 ((_ extract 7 0) symbol_0)))
 (let ((?x66 ((_ zero_extend 24) ?x65)))
 (let ((?x67 (bvshl ?x66 (_ bv24 32))))
 (let ((?x68 (bvashr ?x67 (_ bv24 32))))
 (and (distinct ?x68 ?x53) true))))))))))
(assert
 (let ((?x17 ((_ extract 7 0) symbol_1)))
 (let ((?x18 ((_ zero_extend 24) ?x17)))
 (let ((?x19 (bvshl ?x18 (_ bv24 32))))
...
(assert
 ...
 (let ((?x67 (bvshl ?x66 (_ bv24 32))))
 (let ((?x68 (bvashr ?x67 (_ bv24 32))))
 (and (distinct ?x68 ?x20) true))))))))))
(assert
 (let ((?x65 ((_ extract 7 0) symbol_0)))
 (let ((?x66 ((_ zero_extend 24) ?x65)))
 (let ((?x67 (bvshl ?x66 (_ bv24 32))))
 (let ((?x68 (bvashr ?x67 (_ bv24 32))))
 (let (($x78 (= ?x68 (_ bv0 32))))
 (not $x78)))))))
(check-sat)
