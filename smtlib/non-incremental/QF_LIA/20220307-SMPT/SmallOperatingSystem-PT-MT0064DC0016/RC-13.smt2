...
(assert (not (and (or (or (<= ExecutingTask FreeMemSegment)(<= TaskReady TaskSuspended))(and (<= 1 TaskSuspended)(<= 1 DiskControllerUnit)))(or (or (<= LoadingMem DiskControllerUnit)(<= CPUUnit DiskControllerUnit))(or (<= LoadingMem TaskOnDisk)(<= TaskOnDisk LoadingMem))))))
