...
(assert (not (or (>= LoadingMem 1)(or (or (not (and (>= CPUUnit 1)(>= TaskReady 1)))(or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(and (>= CPUUnit 1)(>= TaskReady 1))))))
