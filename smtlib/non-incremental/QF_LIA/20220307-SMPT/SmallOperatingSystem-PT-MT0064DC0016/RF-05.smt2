...
(assert (and (and (and (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(not (and (>= CPUUnit 1)(>= TaskReady 1))))(and (>= ExecutingTask 1)(and (>= CPUUnit 1)(>= TaskReady 1))))(not (and (and (and (>= CPUUnit 1)(>= TaskReady 1))(>= TaskReady 1))(not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))))))
