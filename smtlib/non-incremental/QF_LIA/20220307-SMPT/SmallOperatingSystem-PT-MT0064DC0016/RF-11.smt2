...
Generator: SMPT
Application: Reachability query on the instance SmallOperatingSystem-PT-MT0064DC0016 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= TaskOnDisk (+ DiskControllerUnit 48)))
...
(assert (= (+ a4 LoadingMem) 16))
(assert (= (+ FreeMemSegment LoadingMem a5) 64))

(assert (and (or (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= TransferToDisk 1)))(or (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskSuspended 1)))(or (and (>= CPUUnit 1)(>= TaskReady 1))(>= ExecutingTask 1))))(and (and (and (>= ExecutingTask 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(not (>= ExecutingTask 1)))(or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (>= TaskReady 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))))))
