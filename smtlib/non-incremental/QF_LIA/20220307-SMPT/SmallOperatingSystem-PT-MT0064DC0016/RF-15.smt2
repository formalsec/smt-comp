...
(assert (not (or (or (or (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= TaskReady 1))(and (>= TransferToDisk 1)(and (>= CPUUnit 1)(>= TaskSuspended 1))))(not (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))))
