...
(assert (not (or (and (or (<= LoadingMem CPUUnit)(<= TransferToDisk TransferToDisk))(and (<= FreeMemSegment CPUUnit)(<= 1 CPUUnit)))(or (or (<= ExecutingTask TransferToDisk)(<= TaskSuspended FreeMemSegment))(and (<= TransferToDisk TaskOnDisk)(<= 2 TaskOnDisk))))))
