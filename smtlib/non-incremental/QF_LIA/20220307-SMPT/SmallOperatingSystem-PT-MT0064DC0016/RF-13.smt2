...
(assert (and (and (not (or (>= TaskReady 1)(>= LoadingMem 1)))(not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(or (>= TaskReady 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))))
