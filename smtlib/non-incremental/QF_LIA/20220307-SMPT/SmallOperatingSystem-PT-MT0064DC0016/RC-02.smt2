...
(assert (not (or (or (<= 1 DiskControllerUnit)(<= 1 FreeMemSegment))(and (and (<= 2 ExecutingTask)(<= TransferToDisk TransferToDisk))(or (<= TransferToDisk LoadingMem)(<= 2 FreeMemSegment))))))
