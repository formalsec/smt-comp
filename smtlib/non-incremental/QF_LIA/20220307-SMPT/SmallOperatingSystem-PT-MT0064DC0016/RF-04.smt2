...
(assert (not (or (not (and (>= ExecutingTask 1)(not (and (>= CPUUnit 1)(>= TaskSuspended 1)))))(or (not (not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(>= ExecutingTask 1)))))
