...
(assert (and (and (or (not (>= ExecutingTask 1))(not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(not (or (>= TaskReady 1)(>= TaskReady 1))))(not (and (and (>= TransferToDisk 1)(>= LoadingMem 1))(not (>= TaskReady 1))))))
