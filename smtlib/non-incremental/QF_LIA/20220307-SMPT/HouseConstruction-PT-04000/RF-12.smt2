...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-04000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (not (or (or (and (>= p8 1)(>= p9 1))(and (>= p8 1)(>= p9 1)))(and (>= p8 1)(>= p9 1))))(and (or (not (>= p17 1))(and (and (>= p25 1)(>= p26 1)(>= p27 1))(>= p1 1)))(or (not (>= p16 1))(and (>= p16 1)(and (>= p8 1)(>= p9 1)))))))
