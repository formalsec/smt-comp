...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-00010 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (not (or (>= p6 1)(>= p14 1)))(or (not (and (>= p25 1)(>= p26 1)(>= p27 1)))(>= p3 1)))(and (or (or (>= p17 1)(and (>= p10 1)(>= p12 1)(>= p13 1)))(and (>= p1 1)(and (>= p25 1)(>= p26 1)(>= p27 1))))(and (not (>= p7 1))(>= p18 1))))))
