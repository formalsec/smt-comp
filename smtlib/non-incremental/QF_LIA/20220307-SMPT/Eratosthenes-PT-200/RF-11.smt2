...
(assert (not (or (and (or (and (>= p100 1)(>= p20 1))(and (and (>= p147 1)(>= p3 1))(and (>= p120 1)(>= p3 1))))(not (not (and (>= p36 1)(>= p6 1)))))(or (and (>= p70 1)(>= p14 1))(and (and (and (>= p180 1)(>= p45 1))(and (>= p72 1)(>= p4 1)))(and (and (>= p90 1)(>= p15 1))(and (>= p186 1)(>= p31 1))))))))
