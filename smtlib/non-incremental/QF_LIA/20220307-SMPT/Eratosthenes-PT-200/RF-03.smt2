...
(assert (not (or (and (and (>= p195 1)(>= p15 1))(not (not (and (>= p154 1)(>= p14 1)))))(and (or (or (and (>= p190 1)(>= p38 1))(and (>= p154 1)(>= p7 1)))(or (and (>= p30 1)(>= p15 1))(and (>= p105 1)(>= p3 1))))(and (and (>= p72 1)(>= p6 1))(or (and (>= p108 1)(>= p12 1))(and (>= p185 1)(>= p5 1))))))))
