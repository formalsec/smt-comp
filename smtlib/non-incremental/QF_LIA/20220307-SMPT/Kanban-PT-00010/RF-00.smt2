...
Generator: SMPT
Application: Reachability query on the instance Kanban-PT-00010 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (and (not (>= Pback2 1))(and (>= Pm3 1)(and (>= P2 1)(>= P3 1)(>= Pout4 1))))(>= Pback4 1))(and (or (or (>= Pm2 1)(>= Pout1 1))(>= Pback1 1))(not (and (>= Pm2 1)(and (>= P2 1)(>= P3 1)(>= Pout4 1)))))))
