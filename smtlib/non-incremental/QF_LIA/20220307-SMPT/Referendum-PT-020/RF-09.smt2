...
(assert (not (or (and (or (>= voting_12 1)(or (>= voting_17 1)(>= voting_17 1)))(not (and (>= voting_14 1)(>= voting_11 1))))(or (or (or (>= voting_9 1)(>= voting_3 1))(or (>= voting_14 1)(>= voting_13 1)))(and (or (>= voting_18 1)(>= voting_20 1))(and (>= voting_20 1)(>= voting_15 1)))))))
