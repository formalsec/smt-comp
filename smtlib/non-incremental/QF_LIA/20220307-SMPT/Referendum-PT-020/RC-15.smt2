...
(assert (not (or (or (not (<= 3 voted_no_15))(and (<= 3 voted_yes_1)(<= 1 voted_yes_6)))(or (and (<= voted_no_3 voted_yes_11)(<= voting_1 voting_8))(or (<= voted_no_4 voting_10)(<= voted_yes_7 voted_yes_12))))))
