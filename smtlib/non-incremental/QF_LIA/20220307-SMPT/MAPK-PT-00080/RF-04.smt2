...
(assert (not (or (or (not (>= MEK_RafP 1))(or (not (and (>= MEKPP 1)(>= Phase2 1)))(not (>= ERKP_MEKPP 1))))(and (or (and (>= MEKP 1)(>= Phase2 1))(or (and (>= MEKP 1)(>= RafP 1))(>= MEKPP_Phase2 1)))(and (>= MEKP 1)(>= Phase2 1))))))
