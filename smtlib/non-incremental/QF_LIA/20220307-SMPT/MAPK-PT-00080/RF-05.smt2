...
(assert (and (and (and (or (>= RafP_Phase1 1)(and (>= Phase1 1)(>= RafP 1)))(and (and (>= ERKPP 1)(>= Phase3 1))(>= RafP_Phase1 1)))(not (or (>= MEKPP_Phase2 1)(>= MEK_RafP 1))))(and (>= ERKP_MEKPP 1)(or (and (>= ERKP_MEKPP 1)(>= MEK_RafP 1))(not (and (>= MEKP 1)(>= Phase2 1)))))))
