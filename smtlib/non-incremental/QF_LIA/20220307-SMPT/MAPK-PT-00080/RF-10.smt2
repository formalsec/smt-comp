...
(assert (not (or (or (and (>= ERKP_Phase3 1)(and (>= Raf_RasGTP 1)(and (>= ERK 1)(>= MEKPP 1))))(and (>= Raf 1)(>= RasGTP 1)))(and (not (not (and (>= Phase1 1)(>= RafP 1))))(and (not (>= ERKPP_Phase3 1))(and (>= ERKP 1)(>= MEKPP 1)))))))
