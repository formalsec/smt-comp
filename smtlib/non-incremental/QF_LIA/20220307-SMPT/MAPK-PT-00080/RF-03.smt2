...
(assert (and (and (or (not (>= ERK_MEKPP 1))(and (>= MEKP_RafP 1)(and (>= MEKPP 1)(>= Phase2 1))))(and (and (and (>= ERKP 1)(>= Phase3 1))(and (>= MEKP 1)(>= Phase2 1)))(and (>= ERKPP_Phase3 1)(and (>= Phase1 1)(>= RafP 1)))))(or (>= ERKP_MEKPP 1)(or (>= Raf_RasGTP 1)(not (and (>= Raf 1)(>= RasGTP 1)))))))
