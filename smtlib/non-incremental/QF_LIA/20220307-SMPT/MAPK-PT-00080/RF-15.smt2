...
(assert (and (and (and (not (>= Raf_RasGTP 1))(and (>= ERKP 1)(>= MEKPP 1)))(and (not (and (>= Raf 1)(>= RasGTP 1)))(or (>= RafP_Phase1 1)(>= MEKPP_Phase2 1))))(not (or (>= ERKPP_Phase3 1)(or (>= ERK_MEKPP 1)(>= MEKP_RafP 1))))))
