...
(assert (and (and (or (and (>= MEKPP_Phase2 1)(and (>= MEKP 1)(>= Phase2 1)))(or (>= ERKPP_Phase3 1)(>= Raf_RasGTP 1)))(and (>= MEKP_RafP 1)(and (>= ERKPP_Phase3 1)(and (>= Phase1 1)(>= RafP 1)))))(>= RafP_Phase1 1)))
