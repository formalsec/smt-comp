...
(assert (and (or (not (not (>= P2 1)))(not (and (>= P2 1)(and (>= M1 1)(>= P1wM1 1)))))(and (and (and (and (>= M1 1)(>= P1wM1 1))(and (>= P1wP2 1)(>= P2wP1 1)))(and (>= P1d 1)(and (>= P3M2 1)(>= M2 1))))(or (or (and (>= P3M2 1)(>= M2 1))(>= P3 1))(>= P2M2 1)))))
