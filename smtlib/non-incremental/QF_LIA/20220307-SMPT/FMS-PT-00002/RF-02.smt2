...
(assert (and (and (and (or (and (>= M1 1)(>= P1wM1 1))(and (>= P1wP2 1)(>= P2wP1 1)))(not (>= P1M1 1)))(>= P1s 1))(or (and (and (and (>= P3M2 1)(>= M2 1))(and (>= M3 1)(>= P12wM3 1)))(or (>= P1s 1)(>= P2d 1)))(and (>= M3 1)(>= P12wM3 1)))))
