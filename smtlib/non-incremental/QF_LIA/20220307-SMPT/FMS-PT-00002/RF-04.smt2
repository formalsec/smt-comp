...
(assert (and (and (or (not (>= P2M2 1))(not (and (>= M1 1)(>= P1wM1 1))))(and (or (>= P2d 1)(>= P1s 1))(not (and (>= M1 1)(>= P1wM1 1)))))(and (and (and (>= P2s 1)(and (>= P1wP2 1)(>= P2wP1 1)))(>= P2 1))(or (>= P1d 1)(and (>= P1wP2 1)(>= P2wP1 1))))))
