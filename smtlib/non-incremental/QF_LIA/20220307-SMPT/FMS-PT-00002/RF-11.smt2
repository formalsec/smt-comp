...
(assert (and (and (and (not (>= P1d 1))(and (>= P2d 1)(and (>= M2 1)(>= P2wM2 1))))(and (or (and (>= M3 1)(>= P12wM3 1))(>= P2d 1))(and (>= P2M2 1)(>= P12 1))))(and (or (and (and (>= M1 1)(>= P1wM1 1))(>= P2 1))(or (>= P2s 1)(>= P1 1)))(>= P1d 1))))
