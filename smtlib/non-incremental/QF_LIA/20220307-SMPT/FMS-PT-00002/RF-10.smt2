...
(assert (and (and (or (and (>= P2M2 1)(and (>= M2 1)(>= P2wM2 1)))(and (>= P2d 1)(and (>= M3 1)(>= P12wM3 1))))(and (and (>= P2s 1)(>= P12 1))(and (>= P3 1)(>= P1M1 1))))(and (or (>= P1d 1)(>= P1M1 1))(and (not (>= P3 1))(and (>= P3s 1)(and (>= P1wP2 1)(>= P2wP1 1)))))))
