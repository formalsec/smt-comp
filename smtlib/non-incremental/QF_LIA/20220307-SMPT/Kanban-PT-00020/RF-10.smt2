...
Generator: SMPT
Application: Reachability query on the instance Kanban-PT-00020 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (or (>= Pout1 1)(>= Pm1 1))(not (>= Pback1 1)))(and (or (or (and (>= P1 1)(>= Pout2 1)(>= Pout3 1))(and (>= P2 1)(>= P3 1)(>= Pout4 1)))(not (>= Pout1 1)))(and (or (>= Pm1 1)(>= P4 1))(not (>= Pm1 1)))))))
