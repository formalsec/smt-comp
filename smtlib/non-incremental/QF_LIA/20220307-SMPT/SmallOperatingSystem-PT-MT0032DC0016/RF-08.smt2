...
(assert (and (and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= TransferToDisk 1))(and (not (and (>= TransferToDisk 1)(>= TransferToDisk 1)))(and (>= ExecutingTask 1)(and (>= ExecutingTask 1)(>= LoadingMem 1))))))
