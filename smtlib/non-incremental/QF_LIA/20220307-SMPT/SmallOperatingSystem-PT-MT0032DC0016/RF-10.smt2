...
(assert (not (or (or (not (and (>= TransferToDisk 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(or (>= ExecutingTask 1)(not (and (>= CPUUnit 1)(>= TaskSuspended 1)))))(or (and (and (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskReady 1)))(not (>= TransferToDisk 1)))(not (not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))))))
