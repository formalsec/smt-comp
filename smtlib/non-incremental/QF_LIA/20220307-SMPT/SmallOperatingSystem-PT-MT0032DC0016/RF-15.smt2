...
(assert (not (or (and (or (>= TransferToDisk 1)(or (>= TransferToDisk 1)(and (>= CPUUnit 1)(>= TaskSuspended 1))))(or (not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(and (>= CPUUnit 1)(>= TaskReady 1))))(not (not (or (>= LoadingMem 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))))))
