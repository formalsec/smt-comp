...
Generator: SMPT
Application: Reachability query on the instance SmallOperatingSystem-PT-MT0032DC0016 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= TaskOnDisk (+ DiskControllerUnit 16)))
...
(assert (= (+ FreeMemSegment LoadingMem a5) 32))

(assert (and (and (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskSuspended 1)))(or (>= TransferToDisk 1)(>= TransferToDisk 1))))(not (and (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskSuspended 1)))(not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))))
