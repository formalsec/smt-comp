...
(assert (not (or (or (and (or (>= ExecutingTask 1)(>= TaskReady 1))(not (and (>= CPUUnit 1)(>= TaskSuspended 1))))(or (or (>= TaskReady 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(not (and (>= CPUUnit 1)(>= TaskReady 1)))))(>= TransferToDisk 1))))
