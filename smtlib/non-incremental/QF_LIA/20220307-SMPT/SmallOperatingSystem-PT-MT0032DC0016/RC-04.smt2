...
(assert (and (and (and (<= 3 TaskSuspended)(<= TaskOnDisk DiskControllerUnit))(and (<= FreeMemSegment TaskReady)(<= FreeMemSegment ExecutingTask)))(or (or (<= 2 TaskOnDisk)(<= 1 DiskControllerUnit))(or (<= TaskReady TaskReady)(<= FreeMemSegment ExecutingTask)))))
