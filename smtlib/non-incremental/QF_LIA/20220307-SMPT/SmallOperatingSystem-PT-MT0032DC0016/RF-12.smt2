...
(assert (not (or (or (not (and (and (>= CPUUnit 1)(>= TaskReady 1))(>= ExecutingTask 1)))(or (and (>= ExecutingTask 1)(>= ExecutingTask 1))(or (>= LoadingMem 1)(>= TransferToDisk 1))))(and (or (not (and (>= CPUUnit 1)(>= TaskReady 1)))(or (>= ExecutingTask 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(not (or (>= ExecutingTask 1)(>= TaskReady 1)))))))
