...
(assert (and (and (not (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskSuspended 1))))(and (>= CPUUnit 1)(>= TaskSuspended 1)))(or (or (not (>= ExecutingTask 1))(not (>= TransferToDisk 1)))(not (not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))))))
