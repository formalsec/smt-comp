...
Generator: SMPT
Application: Reachability query on the instance Diffusion2D-PT-D05N150 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (and (and (>= cAMP__1_3_ 1)(>= cAMP__4_2_ 1))(or (>= cAMP__1_4_ 1)(>= cAMP__5_4_ 1)))(or (>= cAMP__3_2_ 1)(or (>= cAMP__2_2_ 1)(>= cAMP__5_3_ 1))))(and (and (or (>= cAMP__3_3_ 1)(>= cAMP__2_1_ 1))(or (>= cAMP__4_1_ 1)(>= cAMP__2_2_ 1)))(not (and (>= cAMP__4_4_ 1)(>= cAMP__3_5_ 1))))))
