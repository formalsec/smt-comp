...
Generator: SMPT
Application: Reachability query on the instance Kanban-PT-50000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (or (and (and (and (>= P1 1)(>= Pout2 1)(>= Pout3 1))(>= Pout1 1))(not (or (and (>= P1 1)(>= Pout2 1)(>= Pout3 1))(and (>= P2 1)(>= P3 1)(>= Pout4 1)))))(not (or (not (and (>= P1 1)(>= Pout2 1)(>= Pout3 1)))(or (>= P4 1)(>= Pm2 1))))))
