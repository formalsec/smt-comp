...
(assert (and (and (not (and (and (>= Cabins 1)(>= Entered 1))(>= Dress 1)))(not (and (>= Bags 1)(>= WaitBag 1))))(and (and (and (and (>= Cabins 1)(>= InBath 1))(and (>= Bags 1)(>= WaitBag 1)))(>= Dressed 1))(or (>= Out 1)(and (>= Dressed 1)(and (>= Cabins 1)(>= InBath 1)))))))
