...
Generator: SMPT
Application: Reachability query on the instance Kanban-PT-00100 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (not (or (>= Pm1 1)(>= Pm2 1)))(and (and (>= P1 1)(>= Pout2 1)(>= Pout3 1))(>= Pm1 1)))(or (not (not (>= P4 1)))(not (and (and (>= P1 1)(>= Pout2 1)(>= Pout3 1))(>= Pm3 1)))))))
