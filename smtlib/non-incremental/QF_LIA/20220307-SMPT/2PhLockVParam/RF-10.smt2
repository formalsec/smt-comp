...
(assert (and (or (not (and (>= haveA2 1)(and (>= Clients 1)(>= resA 1))))(not (or (>= haveA2andB 1)(and (>= Clients 1)(>= resA 1)))))(and (and (not (and (>= Clients 1)(>= resA 1)))(or (>= haveA2andB 1)(>= haveA2andB 1)))(not (>= haveA2 1)))))
