...
(assert (and (and (and (or (and (>= haveB 1)(>= resA 1))(and (>= Clients 1)(>= resA 1)))(not (>= haveA2andB 1)))(or (and (>= haveA2andB 1)(and (>= haveA 1)(>= resB 1)))(not (and (>= Clients 1)(>= resA 1)))))(and (>= haveB 1)(>= resA 1))))
