...
(assert (and (and (and (or (and (>= haveA 1)(>= resB 1))(and (>= haveB 1)(>= resA 1)))(or (and (>= haveA 1)(>= resB 1))(>= haveAandB 1)))(and (not (>= haveA2andB 1))(not (>= haveAandB 1))))(and (>= haveAandB 1)(or (and (and (>= haveB 1)(>= resA 1))(>= haveA2 1))(and (>= haveA2 1)(and (>= haveA 1)(>= resB 1)))))))
