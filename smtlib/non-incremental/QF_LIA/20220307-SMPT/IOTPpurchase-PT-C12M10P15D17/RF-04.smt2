...
(assert (and (not (and (>= Payment_p20 1)(>= Delivery_p20 1)(>= Order_p20 1)(>= Organization_p20_2 1)(>= Status_p20 1)(>= p2_2 1)(>= OfferResponce_p10 1)))(or (or (and (>= DeliveryNote_p22_14 1)(>= p6_6 1)(>= Status_p22_13 1))(or (>= p7_1 1)(and (>= DeliveryNote_p22_14 1)(>= p6_6 1)(>= Status_p22_13 1))))(and (not (and (>= p6_2 1)(>= HowDeliver_p12_2 1)))(and (and (>= PayReceipt_p21_15 1)(>= Status_p21_14 1)(>= PaymentNote_p21_16 1)(>= p3_10 1))(>= p5_4 1))))))
