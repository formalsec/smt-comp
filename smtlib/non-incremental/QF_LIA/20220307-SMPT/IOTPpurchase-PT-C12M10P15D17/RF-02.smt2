...
(assert (or (and (not (or (and (>= PayReceipt_p21_12 1)(>= PaymentNote_p21_13 1)(>= Status_p21_11 1)(>= p5_3 1)(>= p11_13 1))(>= ConsumerDelivery_p6_0 1)))(and (>= PaySchemeData_p11_10 1)(>= p3_8 1)))(and (not (or (>= p6_7 1)(and (>= p6_2 1)(>= HowDeliver_p12_2 1))))(>= p8_3 1))))
