...
(assert (not (or (and (not (and (>= PaySchemeData_p21_10 1)(>= p11_11 1)(>= p5_2 1)))(and (>= Organization_p22_2 1)(>= Order_p22_3 1)(>= Delivery_p22_1 1)(>= p7_2 1)(>= p12_3 1)))(not (and (and (>= p8_3 1)(and (>= p3_5 1)(>= PaymentAmount_p11_6 1)))(and (>= MerchantPayment_p4_0 1)(>= PaidFor_p11_1 1)))))))
