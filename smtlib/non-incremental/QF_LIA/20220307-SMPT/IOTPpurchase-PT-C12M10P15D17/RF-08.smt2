...
(assert (and (>= p3_6 1)(and (and (>= p6_2 1)(>= HowDeliver_p12_2 1))(or (and (and (>= PayReceipt_p21_15 1)(>= Status_p21_14 1)(>= PaymentNote_p21_16 1)(>= p3_10 1))(and (>= Status_p20_6 1)(>= p1_3 1)(>= Organization_p20_7 1)(>= Order_p20_8 1)(>= Payment_p20_9 1)(>= Delivery_p20_10 1)))(not (and (>= PayReceipt_p21_15 1)(>= Status_p21_14 1)(>= PaymentNote_p21_16 1)(>= p3_10 1)))))))
