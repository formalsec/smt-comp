...
(assert (and (and (>= PayReceipt_p21_15 1)(>= Status_p21_14 1)(>= PaymentNote_p21_16 1)(>= p3_10 1))(and (not (and (and (>= MerchantPayment_p4_0 1)(>= PaidFor_p11_1 1))(and (>= BrandSelection_p11_5 1)(>= p4_3 1))))(not (not (and (>= Status_p22_11 1)(>= p8_2 1)(>= DeliveryNote_p22_12 1)(>= p12_7 1)))))))
