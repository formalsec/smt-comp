...
(assert (and (not (and (>= MerchantOffer_p2 1)(>= OfferRequest_p10 1)))(and (or (and (and (>= p12_0 1)(>= p6_1 1))(>= ConsumerPayment_p3 1))(and (and (>= PaySchemeData_p11_10 1)(>= p3_8 1))(>= p3_6 1)))(or (or (and (>= p10_0 1)(>= p1_1 1))(and (>= p11_4 1)(>= p3_4 1)))(and (and (>= Status_p20_6 1)(>= p1_3 1)(>= Organization_p20_7 1)(>= Order_p20_8 1)(>= Payment_p20_9 1)(>= Delivery_p20_10 1))(>= p6_3 1))))))
