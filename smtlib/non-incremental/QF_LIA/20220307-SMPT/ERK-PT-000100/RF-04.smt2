...
Generator: SMPT
Application: Reachability query on the instance ERK-PT-000100 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (or (>= MEKPP_ERK 1)(or (>= Raf1Star_RKIP 1)(and (>= RKIPP 1)(>= RP 1))))(not (and (and (>= RKIPP 1)(>= RP 1))(>= RKIPP_RP 1))))(or (and (>= RKIP 1)(>= Raf1Star 1))(or (or (>= Raf1Star_RKIP_ERKPP 1)(>= Raf1Star_RKIP 1))(and (>= RKIPP_RP 1)(and (>= RKIPP 1)(>= RP 1))))))))
