...
(assert (and (and (or (and (>= Raf1Star_RKIP_ERKPP 1)(>= MEKPP_ERK 1))(and (>= Raf1Star_RKIP 1)(>= MEKPP_ERK 1)))(not (and (and (>= ERK 1)(>= MEKPP 1))(>= RKIPP_RP 1))))(not (or (not (>= RKIPP_RP 1))(>= Raf1Star_RKIP_ERKPP 1)))))
