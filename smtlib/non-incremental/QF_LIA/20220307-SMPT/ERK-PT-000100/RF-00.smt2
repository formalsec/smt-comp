...
(assert (not (or (>= Raf1Star_RKIP_ERKPP 1)(or (or (or (>= MEKPP_ERK 1)(>= Raf1Star_RKIP_ERKPP 1))(or (and (>= RKIPP 1)(>= RP 1))(>= MEKPP_ERK 1)))(not (and (and (>= RKIP 1)(>= Raf1Star 1))(>= MEKPP_ERK 1)))))))
