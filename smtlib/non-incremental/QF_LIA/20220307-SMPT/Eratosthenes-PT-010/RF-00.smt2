...
(assert (and (or (and (or (and (>= p8 1)(>= p2 1))(and (>= p4 1)(>= p2 1)))(not (and (>= p6 1)(>= p3 1))))(and (>= p10 1)(>= p2 1)))(and (and (or (and (>= p8 1)(>= p4 1))(and (>= p6 1)(>= p3 1)))(not (and (>= p10 1)(>= p2 1))))(not (not (and (>= p4 1)(>= p2 1)))))))
