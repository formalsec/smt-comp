...
(assert (or (not (and (not (and (>= p4 1)(>= p2 1)))(or (and (>= p6 1)(>= p2 1))(and (>= p6 1)(>= p3 1)))))(or (and (not (and (>= p8 1)(>= p4 1)))(and (and (>= p6 1)(>= p3 1))(and (>= p4 1)(>= p2 1))))(or (and (>= p4 1)(>= p2 1))(and (>= p4 1)(>= p2 1))))))
