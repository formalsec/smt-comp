...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-08000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (and (or (>= p11 1)(and (>= p25 1)(>= p26 1)(>= p27 1)))(>= p2 1))(not (and (>= p25 1)(>= p26 1)(>= p27 1))))(and (>= p3 1)(or (or (>= p5 1)(and (>= p19 1)(>= p20 1)))(and (and (>= p8 1)(>= p9 1))(and (>= p8 1)(>= p9 1))))))))
