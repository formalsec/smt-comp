...
(assert (and (or (or (or (and (>= p400 1)(>= p200 1))(and (>= p123 1)(>= p41 1)))(or (and (>= p360 1)(>= p12 1))(and (>= p168 1)(>= p8 1))))(and (not (and (>= p450 1)(>= p5 1)))(and (and (>= p303 1)(>= p101 1))(and (>= p220 1)(>= p55 1)))))(not (or (or (and (>= p288 1)(>= p18 1))(and (>= p279 1)(>= p93 1)))(not (and (>= p200 1)(>= p25 1)))))))
