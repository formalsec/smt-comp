...
(assert (and (and (not (not (and (>= p488 1)(>= p4 1))))(or (not (and (>= p366 1)(>= p122 1)))(or (and (>= p425 1)(>= p25 1))(and (>= p196 1)(>= p7 1)))))(not (or (not (and (>= p192 1)(>= p8 1)))(or (and (>= p93 1)(>= p31 1))(and (>= p476 1)(>= p34 1)))))))
