...
(assert (and (not (or (or (and (>= p360 1)(>= p2 1))(and (>= p156 1)(>= p12 1)))(and (>= p462 1)(>= p231 1))))(or (or (or (and (>= p396 1)(>= p12 1))(and (>= p121 1)(>= p11 1)))(not (and (>= p153 1)(>= p17 1))))(and (or (and (>= p444 1)(>= p222 1))(and (>= p351 1)(>= p39 1)))(and (>= p165 1)(>= p11 1))))))
