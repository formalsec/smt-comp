...
(assert (not (or (or (not (and (>= RKIPP_RP 1)(>= Raf1Star_RKIP_ERKPP 1)))(or (not (and (>= RKIPP 1)(>= RP 1)))(or (and (>= RKIPP 1)(>= RP 1))(and (>= ERK 1)(>= MEKPP 1)))))(and (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(and (and (>= Raf1Star_RKIP_ERKPP 1)(>= Raf1Star_RKIP 1))(or (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(and (>= RKIP 1)(>= Raf1Star 1))))))))
