...
Generator: SMPT
Application: Reachability query on the instance ERK-PT-000010 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (and (or (and (>= RKIP 1)(>= Raf1Star 1))(>= RKIPP_RP 1))(or (and (>= ERK 1)(>= MEKPP 1))(and (>= RKIPP 1)(>= RP 1))))(and (and (>= Raf1Star_RKIP_ERKPP 1)(and (>= ERKPP 1)(>= Raf1Star_RKIP 1)))(or (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(>= MEKPP_ERK 1))))(or (not (>= Raf1Star_RKIP_ERKPP 1))(or (not (>= Raf1Star_RKIP 1))(or (>= MEKPP_ERK 1)(and (>= ERK 1)(>= MEKPP 1))))))))
