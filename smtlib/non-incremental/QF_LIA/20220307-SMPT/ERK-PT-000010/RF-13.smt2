...
(assert (not (or (not (not (or (>= MEKPP_ERK 1)(and (>= ERK 1)(>= MEKPP 1)))))(or (and (and (and (>= ERK 1)(>= MEKPP 1))(>= Raf1Star_RKIP 1))(or (and (>= ERK 1)(>= MEKPP 1))(and (>= RKIP 1)(>= Raf1Star 1))))(and (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(or (>= RKIPP_RP 1)(>= MEKPP_ERK 1)))))))
