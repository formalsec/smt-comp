...
(assert (not (or (or (or (not (>= Raf1Star_RKIP 1))(or (>= Raf1Star_RKIP_ERKPP 1)(>= RKIPP_RP 1)))(and (or (>= RKIPP_RP 1)(and (>= RKIPP 1)(>= RP 1)))(or (>= MEKPP_ERK 1)(and (>= ERK 1)(>= MEKPP 1)))))(not (not (or (and (>= RKIP 1)(>= Raf1Star 1))(>= Raf1Star_RKIP 1)))))))
