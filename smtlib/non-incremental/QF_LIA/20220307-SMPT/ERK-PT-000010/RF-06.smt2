...
(assert (not (or (or (not (and (>= ERK 1)(>= MEKPP 1)))(or (and (>= Raf1Star_RKIP_ERKPP 1)(>= Raf1Star_RKIP 1))(and (>= ERK 1)(>= MEKPP 1))))(and (or (and (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(>= Raf1Star_RKIP_ERKPP 1))(and (>= MEKPP_ERK 1)(>= Raf1Star_RKIP_ERKPP 1)))(not (and (>= Raf1Star_RKIP_ERKPP 1)(and (>= RKIP 1)(>= Raf1Star 1))))))))
