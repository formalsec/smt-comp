...
(assert (and (not (or (and (>= Raf1Star_RKIP_ERKPP 1)(>= Raf1Star_RKIP_ERKPP 1))(>= RKIPP_RP 1)))(and (and (not (and (>= RKIP 1)(>= Raf1Star 1)))(and (>= RKIPP_RP 1)(>= MEKPP_ERK 1)))(not (not (>= Raf1Star_RKIP_ERKPP 1))))))
