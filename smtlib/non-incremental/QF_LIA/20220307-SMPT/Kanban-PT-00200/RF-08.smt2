...
Generator: SMPT
Application: Reachability query on the instance Kanban-PT-00200 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (>= P4 1)(or (and (not (>= Pm4 1))(or (>= Pm1 1)(>= Pm2 1)))(and (and (and (>= P1 1)(>= Pout2 1)(>= Pout3 1))(and (>= P2 1)(>= P3 1)(>= Pout4 1)))(and (>= Pm4 1)(and (>= P2 1)(>= P3 1)(>= Pout4 1))))))))
