...
(assert (not (or (or (not (or (>= P2s 1)(>= P2d 1)))(and (or (and (>= P3M2 1)(>= M2 1))(and (>= M3 1)(>= P12wM3 1)))(or (and (>= P1wP2 1)(>= P2wP1 1))(and (>= M3 1)(>= P12wM3 1)))))(not (and (and (and (>= P1wP2 1)(>= P2wP1 1))(>= P1d 1))(or (>= P1d 1)(>= P2M2 1)))))))
