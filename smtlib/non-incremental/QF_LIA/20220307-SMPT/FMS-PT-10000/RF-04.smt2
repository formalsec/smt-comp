...
(assert (not (or (and (and (>= P1s 1)(and (>= P3s 1)(and (>= P1wP2 1)(>= P2wP1 1))))(or (or (>= P2d 1)(and (>= M2 1)(>= P2wM2 1)))(and (>= P3M2 1)(>= M2 1))))(or (not (and (>= P12s 1)(>= P1s 1)))(or (not (and (>= P3M2 1)(>= M2 1)))(not (>= P12s 1)))))))
