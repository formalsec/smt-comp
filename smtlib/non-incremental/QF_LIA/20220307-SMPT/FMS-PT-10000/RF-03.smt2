...
(assert (and (or (and (or (>= P12s 1)(>= P2 1))(and (>= P12M3 1)(>= P2d 1)))(and (and (>= P2 1)(and (>= M3 1)(>= P12wM3 1)))(not (and (>= M3 1)(>= P12wM3 1)))))(and (not (not (>= P2s 1)))(and (or (>= P2 1)(>= P1 1))(and (>= P2d 1)(>= P12 1))))))
