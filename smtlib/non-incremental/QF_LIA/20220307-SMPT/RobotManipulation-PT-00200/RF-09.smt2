...
Generator: SMPT
Application: Reachability query on the instance RobotManipulation-PT-00200 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (and (or (and (>= move 1)(>= r_active 1))(>= r_moving 1))(and (>= initialized 1)(>= p_i2 1)))(not (not (>= p_i1 1))))(or (or (and (>= initialize 1)(>= r_stopped 1))(and (>= initialized 1)(>= p_i2 1)))(and (and (>= r_moving 1)(>= p_sc 1))(not (>= p_i1 1)))))))
