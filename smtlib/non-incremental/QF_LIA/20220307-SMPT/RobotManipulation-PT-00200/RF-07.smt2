...
(assert (and (and (not (>= p_i1 1))(not (and (>= off 1)(>= r_active 1))))(or (or (not (and (>= moved 1)(>= p_m 1)))(not (and (>= off 1)(>= r_active 1))))(and (and (>= initialized 1)(>= p_i2 1))(or (>= p_rdy 1)(>= p_rel 1))))))
