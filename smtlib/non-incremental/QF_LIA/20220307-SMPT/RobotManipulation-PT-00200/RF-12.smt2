...
(assert (not (or (not (and (or (>= p_rdy 1)(and (>= access 1)(>= p_rdy 1)))(and (>= off 1)(>= r_active 1))))(or (and (or (>= p_i1 1)(>= p_sc 1))(and (>= move 1)(>= r_active 1)))(and (>= p_i1 1)(and (>= off 1)(>= r_active 1)))))))
