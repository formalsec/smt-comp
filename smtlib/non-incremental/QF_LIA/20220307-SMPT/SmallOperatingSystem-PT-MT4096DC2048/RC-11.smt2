...
(assert (and (or (and (<= LoadingMem FreeMemSegment)(<= 2 TransferToDisk))(or (<= FreeMemSegment TaskReady)(<= DiskControllerUnit TaskSuspended)))(and (or (<= 3 CPUUnit)(<= FreeMemSegment TaskSuspended))(and (<= TaskOnDisk CPUUnit)(<= TaskOnDisk DiskControllerUnit)))))
