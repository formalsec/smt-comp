...
(assert (not (or (and (or (<= ExecutingTask FreeMemSegment)(<= 3 CPUUnit))(not (<= 1 FreeMemSegment)))(and (or (<= 3 TaskOnDisk)(<= 2 LoadingMem))(or (<= 2 TaskReady)(<= FreeMemSegment CPUUnit))))))
