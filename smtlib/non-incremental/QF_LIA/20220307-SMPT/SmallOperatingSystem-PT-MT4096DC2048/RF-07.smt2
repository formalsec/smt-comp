...
(assert (not (or (or (or (and (>= LoadingMem 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(>= TaskReady 1))(and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(or (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= TransferToDisk 1))(or (>= TaskReady 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))))))
