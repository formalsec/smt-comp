...
(assert (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (and (or (>= TaskReady 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(or (and (>= CPUUnit 1)(>= TaskReady 1))(>= TransferToDisk 1)))(not (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= TransferToDisk 1))))))
