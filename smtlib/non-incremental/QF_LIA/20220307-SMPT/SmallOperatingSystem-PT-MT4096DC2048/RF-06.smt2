...
(assert (and (not (not (and (and (>= CPUUnit 1)(>= TaskReady 1))(>= TransferToDisk 1))))(and (and (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(not (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= LoadingMem 1))))))
