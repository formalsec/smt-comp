...
Generator: SMPT
Application: Reachability query on the instance ERK-PT-010000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (and (or (and (and (>= RKIP 1)(>= Raf1Star 1))(and (>= RKIP 1)(>= Raf1Star 1)))(or (and (>= RKIP 1)(>= Raf1Star 1))(>= Raf1Star_RKIP 1)))(and (and (>= Raf1Star_RKIP_ERKPP 1)(>= Raf1Star_RKIP 1))(or (>= RKIPP_RP 1)(>= Raf1Star_RKIP 1))))(or (or (>= Raf1Star_RKIP_ERKPP 1)(not (and (>= RKIPP 1)(>= RP 1))))(not (and (>= Raf1Star_RKIP_ERKPP 1)(and (>= RKIPP 1)(>= RP 1))))))))
