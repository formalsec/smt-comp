...
(assert (and (and (>= MEKPP_ERK 1)(or (and (>= RKIPP_RP 1)(>= Raf1Star_RKIP_ERKPP 1))(or (>= RKIPP_RP 1)(>= MEKPP_ERK 1))))(not (or (and (>= RKIPP_RP 1)(>= MEKPP_ERK 1))(or (>= RKIPP_RP 1)(and (>= ERK 1)(>= MEKPP 1)))))))
