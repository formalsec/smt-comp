...
(assert (not (or (not (not (or (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(and (>= ERK 1)(>= MEKPP 1)))))(and (or (and (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(>= Raf1Star_RKIP_ERKPP 1))(or (and (>= RKIP 1)(>= Raf1Star 1))(and (>= ERK 1)(>= MEKPP 1))))(and (>= Raf1Star_RKIP 1)(and (and (>= RKIP 1)(>= Raf1Star 1))(and (>= ERK 1)(>= MEKPP 1))))))))
