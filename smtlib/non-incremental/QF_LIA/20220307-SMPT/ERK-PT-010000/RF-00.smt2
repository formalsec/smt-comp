...
(assert (not (or (and (not (and (>= RKIPP 1)(>= RP 1)))(>= Raf1Star_RKIP_ERKPP 1))(and (or (and (>= RKIPP_RP 1)(and (>= ERKPP 1)(>= Raf1Star_RKIP 1)))(and (>= RKIP 1)(>= Raf1Star 1)))(or (and (>= RKIP 1)(>= Raf1Star 1))(and (>= Raf1Star_RKIP 1)(>= Raf1Star_RKIP_ERKPP 1)))))))
