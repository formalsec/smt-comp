...
Generator: SMPT
Application: Reachability query on the instance FMS-PT-00050 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= a7 (+ P2wP1 a6)))
(assert (= a8 (+ P3M2 P3)))
(assert (= (+ a2 P12M3 P12s a5 P2M2 a7) 50))
(assert (= (+ M3 P12M3) 2))
(assert (= (+ M2 P2M2) 1))
(assert (= (+ a1 a2 P12M3 P12s P1M1 a4) 50))
(assert (= (+ M1 P1M1) 3))
(assert (= (+ a8 P3s) 50))

(assert (not (or (or (and (not (>= P2d 1))(and (and (>= M1 1)(>= P1wM1 1))(>= P2d 1)))(not (and (>= P3s 1)(>= P2M2 1))))(or (not (>= P12s 1))(and (or (>= P1M1 1)(>= P1d 1))(and (>= P2s 1)(>= P2s 1)))))))
