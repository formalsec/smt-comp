...
(assert (not (or (or (and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(not (>= ExecutingTask 1)))(or (and (>= CPUUnit 1)(>= TaskReady 1))(>= TransferToDisk 1)))(not (and (and (>= TaskReady 1)(>= ExecutingTask 1))(or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))))))
