...
(assert (and (and (and (<= 2 TaskSuspended)(<= 1 TaskOnDisk))(and (<= 1 DiskControllerUnit)(<= TaskSuspended TransferToDisk)))(not (or (<= TaskReady DiskControllerUnit)(<= 1 FreeMemSegment)))))
