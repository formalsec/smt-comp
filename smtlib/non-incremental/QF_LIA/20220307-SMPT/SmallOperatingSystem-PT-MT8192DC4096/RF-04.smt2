...
(assert (and (and (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(or (and (>= LoadingMem 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))(and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= ExecutingTask 1))))(and (>= CPUUnit 1)(>= TaskReady 1))))
