...
(assert (and (and (and (not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(and (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskSuspended 1))))(not (and (>= TransferToDisk 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))(>= ExecutingTask 1)))
