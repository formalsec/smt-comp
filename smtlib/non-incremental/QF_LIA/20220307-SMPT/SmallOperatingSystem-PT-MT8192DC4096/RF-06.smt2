...
(assert (and (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= TaskReady 1)(and (and (>= CPUUnit 1)(>= TaskReady 1))(>= TransferToDisk 1))))(and (and (not (>= LoadingMem 1))(and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= LoadingMem 1)))(not (not (>= TransferToDisk 1))))))
