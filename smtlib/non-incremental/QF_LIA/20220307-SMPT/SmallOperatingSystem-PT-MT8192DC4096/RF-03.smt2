...
(assert (not (or (or (and (>= CPUUnit 1)(>= TaskReady 1))(or (not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(>= ExecutingTask 1)))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))
