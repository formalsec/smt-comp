...
Generator: SMPT
Application: Reachability query on the instance SmallOperatingSystem-PT-MT8192DC4096 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= TaskOnDisk (+ DiskControllerUnit 4096)))
...
(assert (= (+ a4 LoadingMem) 4096))
(assert (= (+ FreeMemSegment LoadingMem a5) 8192))

(assert (not (or (not (and (or (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskReady 1)))(and (>= ExecutingTask 1)(>= TaskReady 1))))(or (or (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= TaskReady 1))(and (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskReady 1))))(and (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= TaskReady 1))(or (>= ExecutingTask 1)(>= TaskReady 1)))))))
