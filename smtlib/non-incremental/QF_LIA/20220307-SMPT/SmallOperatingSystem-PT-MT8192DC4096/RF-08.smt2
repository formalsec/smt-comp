...
(assert (and (not (or (and (>= TaskReady 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (>= ExecutingTask 1)(>= TaskReady 1))))(and (not (not (>= TaskReady 1)))(not (and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= ExecutingTask 1))))))
