...
(assert (not (or (or (or (>= voting_12 1)(not (>= voting_25 1)))(or (and (>= voting_16 1)(>= voting_37 1))(or (>= voting_18 1)(>= voting_33 1))))(not (or (and (>= voting_1 1)(>= voting_31 1))(or (>= voting_50 1)(>= voting_19 1)))))))
