...
Generator: SMPT
Application: Reachability query on the instance Kanban-PT-05000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (and (or (>= Pm4 1)(>= Pback3 1))(not (>= Pm1 1)))(or (not (>= Pm2 1))(and (>= Pm1 1)(>= Pm3 1))))(and (or (and (>= Pback1 1)(>= Pback3 1))(and (>= Pback4 1)(>= Pback3 1)))(not (or (>= Pback4 1)(>= P4 1))))))
