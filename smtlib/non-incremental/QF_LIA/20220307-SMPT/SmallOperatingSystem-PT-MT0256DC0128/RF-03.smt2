...
(assert (and (and (or (and (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskReady 1)))(and (>= ExecutingTask 1)(>= LoadingMem 1)))(and (and (>= TaskReady 1)(>= TransferToDisk 1))(not (and (>= CPUUnit 1)(>= TaskReady 1)))))(>= TransferToDisk 1)))
