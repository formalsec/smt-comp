...
(assert (not (or (or (and (>= LoadingMem 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(or (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (>= CPUUnit 1)(>= TaskReady 1)))(not (and (>= CPUUnit 1)(>= TaskReady 1)))))))
