...
(assert (not (or (not (and (>= TaskReady 1)(and (>= CPUUnit 1)(>= TaskSuspended 1))))(or (not (>= TransferToDisk 1))(and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (>= CPUUnit 1)(>= TaskReady 1)))))))
