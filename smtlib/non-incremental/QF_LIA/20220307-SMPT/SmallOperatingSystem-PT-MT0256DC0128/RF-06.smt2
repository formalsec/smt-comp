...
(assert (not (or (>= ExecutingTask 1)(or (or (not (and (>= CPUUnit 1)(>= TaskSuspended 1)))(not (>= TransferToDisk 1)))(and (or (>= TransferToDisk 1)(>= TransferToDisk 1))(or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= ExecutingTask 1)))))))
