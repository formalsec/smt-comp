...
(assert (and (and (not (and (>= CPUUnit 1)(>= TaskReady 1)))(>= TransferToDisk 1))(not (or (or (>= TransferToDisk 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(>= LoadingMem 1)))))
