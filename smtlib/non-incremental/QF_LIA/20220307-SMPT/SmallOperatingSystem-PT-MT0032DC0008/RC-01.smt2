...
(assert (not (or (or (or (<= 1 TaskReady)(<= TaskSuspended TaskReady))(not (<= 2 DiskControllerUnit)))(and (or (<= 3 FreeMemSegment)(<= 1 FreeMemSegment))(or (<= FreeMemSegment TaskOnDisk)(<= 2 TaskSuspended))))))
