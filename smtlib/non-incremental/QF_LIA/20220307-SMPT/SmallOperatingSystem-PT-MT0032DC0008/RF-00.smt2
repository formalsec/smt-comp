...
(assert (not (or (or (or (not (>= ExecutingTask 1))(or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= ExecutingTask 1)))(and (>= CPUUnit 1)(>= TaskSuspended 1)))(and (>= LoadingMem 1)(not (not (and (>= CPUUnit 1)(>= TaskSuspended 1))))))))
