...
(assert (not (or (or (and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(not (and (>= CPUUnit 1)(>= TaskReady 1))))(not (not (and (>= TaskReady 1)(>= TaskReady 1)))))))
