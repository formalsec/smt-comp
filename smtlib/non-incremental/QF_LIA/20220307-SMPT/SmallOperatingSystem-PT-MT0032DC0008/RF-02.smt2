...
Generator: SMPT
Application: Reachability query on the instance SmallOperatingSystem-PT-MT0032DC0008 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= TaskOnDisk (+ DiskControllerUnit 24)))
...
(assert (not (or (or (or (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(and (>= CPUUnit 1)(>= TaskReady 1)))(and (not (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= TaskReady 1)))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))))
