...
(assert (not (not (and (and (or (and (>= CPUUnit 1)(>= TaskReady 1))(>= TransferToDisk 1))(and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= TaskReady 1)))(not (or (>= ExecutingTask 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))))))
