...
(assert (not (or (and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (not (>= TaskReady 1))(>= LoadingMem 1)))(or (not (>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskReady 1))))))
