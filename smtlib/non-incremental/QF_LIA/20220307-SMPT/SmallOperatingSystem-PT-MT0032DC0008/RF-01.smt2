...
(assert (not (not (and (not (or (>= LoadingMem 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (and (>= CPUUnit 1)(>= TaskReady 1))(>= TransferToDisk 1)))))))
