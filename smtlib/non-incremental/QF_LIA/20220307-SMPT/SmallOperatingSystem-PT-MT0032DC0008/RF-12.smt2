...
(assert (and (and (and (or (and (>= CPUUnit 1)(>= TaskReady 1))(>= ExecutingTask 1))(and (>= TransferToDisk 1)(>= LoadingMem 1)))(not (and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))
