...
(assert (and (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (not (>= TransferToDisk 1))(and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= ExecutingTask 1))))(and (and (>= TransferToDisk 1)(or (>= LoadingMem 1)(>= TransferToDisk 1)))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))))
