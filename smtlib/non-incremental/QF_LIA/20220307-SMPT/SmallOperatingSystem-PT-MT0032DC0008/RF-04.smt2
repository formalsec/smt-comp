...
(assert (not (or (and (>= CPUUnit 1)(>= TaskReady 1))(or (not (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskSuspended 1))))(or (not (>= TaskReady 1))(or (>= LoadingMem 1)(and (>= CPUUnit 1)(>= TaskSuspended 1))))))))
