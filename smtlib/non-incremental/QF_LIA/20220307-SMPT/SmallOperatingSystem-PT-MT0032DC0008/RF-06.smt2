...
(assert (and (or (or (or (>= TaskReady 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(>= TransferToDisk 1))(>= ExecutingTask 1))(and (>= TaskReady 1)(not (and (>= TaskReady 1)(>= TaskReady 1))))))
