...
(assert (not (or (or (or (or (>= Out 1)(>= Dressed 1))(not (and (>= Bags 1)(>= WaitBag 1))))(and (or (>= Dressed 1)(and (>= Cabins 1)(>= InBath 1)))(not (>= Out 1))))(or (not (and (>= Dress 1)(>= Dress 1)))(and (not (>= Dressed 1))(and (and (>= Bags 1)(>= WaitBag 1))(>= Undress 1)))))))
