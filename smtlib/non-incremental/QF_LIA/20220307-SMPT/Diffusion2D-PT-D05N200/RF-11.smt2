...
Generator: SMPT
Application: Reachability query on the instance Diffusion2D-PT-D05N200 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (and (or (or (>= cAMP__5_5_ 1)(>= cAMP__3_5_ 1))(or (>= cAMP__4_3_ 1)(>= cAMP__1_2_ 1)))(not (and (>= cAMP__2_5_ 1)(>= cAMP__2_5_ 1))))(or (and (or (>= cAMP__1_5_ 1)(>= cAMP__3_3_ 1))(>= cAMP__3_3_ 1))(or (and (>= cAMP__3_3_ 1)(>= cAMP__4_5_ 1))(not (>= cAMP__4_4_ 1)))))))
