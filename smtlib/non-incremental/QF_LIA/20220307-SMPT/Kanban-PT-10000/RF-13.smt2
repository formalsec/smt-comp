...
(assert (not (or (or (not (not (>= Pback1 1)))(or (not (and (>= P2 1)(>= P3 1)(>= Pout4 1)))(or (and (>= P2 1)(>= P3 1)(>= Pout4 1))(>= Pm1 1))))(and (and (not (>= Pm1 1))(>= Pback3 1))(and (or (>= Pback4 1)(>= Pm1 1))(and (>= Pm4 1)(>= Pm1 1)))))))
