...
Generator: SMPT
Application: Reachability query on the instance Kanban-PT-10000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (or (not (or (>= Pm2 1)(and (>= P2 1)(>= P3 1)(>= Pout4 1))))(and (and (and (>= P1 1)(>= Pout2 1)(>= Pout3 1))(>= Pback1 1))(and (>= Pback3 1)(>= Pback1 1))))(and (and (not (>= Pm3 1))(>= Pm3 1))(and (not (and (>= P1 1)(>= Pout2 1)(>= Pout3 1)))(not (and (>= P1 1)(>= Pout2 1)(>= Pout3 1)))))))
