...
(assert (not (or (not (and (or (>= Dressed 1)(and (>= Cabins 1)(>= Entered 1)))(or (and (>= Cabins 1)(>= Entered 1))(>= Out 1))))(or (or (or (>= Out 1)(and (>= Cabins 1)(>= InBath 1)))(or (and (>= Cabins 1)(>= InBath 1))(and (>= Bags 1)(>= WaitBag 1))))(and (>= Bags 1)(>= WaitBag 1))))))
