...
(assert (and (and (and (and (>= Cabins 1)(>= Entered 1))(and (>= Dress 1)(>= Dress 1)))(not (or (and (>= Cabins 1)(>= Entered 1))(and (>= Cabins 1)(>= Entered 1)))))(and (or (or (>= Undress 1)(>= Dressed 1))(or (and (>= Cabins 1)(>= Entered 1))(>= Out 1)))(and (>= Bags 1)(>= WaitBag 1)))))
