...
(assert (not (or (or (or (and (>= Dress 1)(>= Dress 1))(and (>= Undress 1)(and (>= Cabins 1)(>= InBath 1))))(or (or (and (>= Cabins 1)(>= InBath 1))(and (>= Cabins 1)(>= Entered 1)))(or (and (>= Cabins 1)(>= Entered 1))(>= Undress 1))))(and (or (or (>= Out 1)(and (>= Cabins 1)(>= Entered 1)))(not (and (>= Bags 1)(>= WaitBag 1))))(not (and (and (>= Cabins 1)(>= InBath 1))(and (>= Cabins 1)(>= Entered 1))))))))
