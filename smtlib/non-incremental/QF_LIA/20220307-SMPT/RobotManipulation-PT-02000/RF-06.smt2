...
(assert (not (or (or (or (not (>= p_rel 1))(or (and (>= initialized 1)(>= p_i2 1))(>= p_rel 1)))(and (>= initialize 1)(>= r_stopped 1)))(or (or (and (and (>= move 1)(>= r_active 1))(and (>= moved 1)(>= p_m 1)))(and (>= p_rdy 1)(and (>= moved 1)(>= p_m 1))))(>= p_rel 1)))))
