...
Generator: SMPT
Application: Reachability query on the instance RobotManipulation-PT-02000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (and (and (>= r_moving 1)(>= p_rel 1))(not (>= p_sc 1)))(or (>= p_sc 1)(not (and (>= off 1)(>= r_active 1)))))(or (or (not (>= p_sc 1))(and (and (>= initialize 1)(>= r_stopped 1))(and (>= move 1)(>= r_active 1))))(or (not (>= p_sc 1))(not (and (>= access 1)(>= p_rdy 1))))))))
