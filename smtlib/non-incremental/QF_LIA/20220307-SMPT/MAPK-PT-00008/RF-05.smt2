...
(assert (and (not (or (or (>= MEK_RafP 1)(>= ERKP_MEKPP 1))(>= Raf_RasGTP 1)))(and (and (>= MEK 1)(>= RafP 1))(and (or (and (>= ERK 1)(>= MEKPP 1))(and (>= ERKP 1)(>= MEKPP 1)))(and (>= MEKP_RafP 1)(>= ERKP_Phase3 1))))))
