...
(assert (not (or (or (>= ERKP_Phase3 1)(not (and (>= ERKP_Phase3 1)(>= ERKPP_Phase3 1))))(and (not (and (>= ERKP 1)(>= Phase3 1)))(or (and (>= MEKP_Phase2 1)(and (>= ERKP 1)(>= MEKPP 1)))(or (>= ERK_MEKPP 1)(>= RafP_Phase1 1)))))))
