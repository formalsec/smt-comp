...
Generator: SMPT
Application: Reachability query on the instance MAPK-PT-00008 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (>= ERKP_MEKPP 1)(or (not (and (>= ERKP 1)(>= Phase3 1)))(or (and (>= ERKPP 1)(>= Phase3 1))(>= MEK_RafP 1))))(and (and (and (>= MEKPP_Phase2 1)(>= MEKPP_Phase2 1))(or (and (>= ERK 1)(>= MEKPP 1))(>= RafP_Phase1 1)))(or (>= ERKP_MEKPP 1)(and (>= Raf_RasGTP 1)(>= MEKP_RafP 1))))))
