...
(assert (not (or (not (not (and (>= ERKP_Phase3 1)(>= Raf_RasGTP 1))))(or (or (not (>= Raf_RasGTP 1))(not (and (>= ERKP 1)(>= MEKPP 1))))(or (or (and (>= ERKPP 1)(>= Phase3 1))(>= Raf_RasGTP 1))(not (>= MEKPP_Phase2 1)))))))
