...
(assert (not (or (and (not (<= ExecutingTask TaskOnDisk))(not (<= 3 TaskReady)))(or (or (<= ExecutingTask DiskControllerUnit)(<= 1 DiskControllerUnit))(and (<= 1 CPUUnit)(<= FreeMemSegment FreeMemSegment))))))
