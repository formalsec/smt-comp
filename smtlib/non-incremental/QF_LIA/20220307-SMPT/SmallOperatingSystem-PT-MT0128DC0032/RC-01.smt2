...
(assert (not (or (or (or (<= TransferToDisk TaskSuspended)(<= 2 ExecutingTask))(or (<= 1 DiskControllerUnit)(<= FreeMemSegment LoadingMem)))(not (or (<= 1 TaskSuspended)(<= TaskOnDisk TaskOnDisk))))))
