...
(assert (and (or (and (<= TaskOnDisk TaskSuspended)(<= 2 LoadingMem))(or (<= DiskControllerUnit LoadingMem)(<= TaskReady CPUUnit)))(and (not (<= 2 TaskSuspended))(not (<= TaskReady TaskOnDisk)))))
