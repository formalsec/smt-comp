...
(assert (or (not (or (or (>= ExecutingTask 1)(>= ExecutingTask 1))(and (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskReady 1)))))(and (not (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= ExecutingTask 1)))(and (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskSuspended 1)))(or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskReady 1)))))))
