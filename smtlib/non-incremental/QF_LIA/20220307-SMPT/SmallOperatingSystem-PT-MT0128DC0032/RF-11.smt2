...
(assert (not (or (and (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(or (>= TaskReady 1)(>= LoadingMem 1)))(not (not (>= LoadingMem 1))))(or (and (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= TransferToDisk 1))(and (>= TaskReady 1)(and (>= CPUUnit 1)(>= TaskReady 1))))(or (>= TaskReady 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))))
