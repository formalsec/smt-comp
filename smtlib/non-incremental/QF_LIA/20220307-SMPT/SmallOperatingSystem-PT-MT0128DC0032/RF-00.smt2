...
(assert (not (or (or (or (or (>= ExecutingTask 1)(and (>= CPUUnit 1)(>= TaskReady 1)))(>= TransferToDisk 1))(and (not (>= TaskReady 1))(or (>= TransferToDisk 1)(>= TransferToDisk 1))))(and (and (and (>= ExecutingTask 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(not (>= ExecutingTask 1)))(not (and (and (>= CPUUnit 1)(>= TaskReady 1))(>= ExecutingTask 1)))))))
