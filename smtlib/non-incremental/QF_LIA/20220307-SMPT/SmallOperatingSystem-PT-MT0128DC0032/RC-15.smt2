...
(assert (not (or (and (and (<= ExecutingTask LoadingMem)(<= 3 ExecutingTask))(<= 1 TransferToDisk))(or (and (<= TaskOnDisk FreeMemSegment)(<= 3 LoadingMem))(<= FreeMemSegment FreeMemSegment)))))
