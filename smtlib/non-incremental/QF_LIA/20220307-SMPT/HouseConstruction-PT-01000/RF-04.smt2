...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-01000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (and (or (>= p18 1)(and (>= p10 1)(>= p12 1)(>= p13 1)))(not (and (>= p8 1)(>= p9 1))))(and (and (and (>= p19 1)(>= p20 1))(>= p11 1))(or (and (>= p10 1)(>= p12 1)(>= p13 1))(and (>= p15 1)(>= p4 1)))))(>= p7 1)))
