...
(assert (not (or (not (or (<= 3 TaskReady)(<= FreeMemSegment ExecutingTask)))(and (or (<= TransferToDisk ExecutingTask)(<= ExecutingTask FreeMemSegment))(or (<= 3 TaskReady)(<= LoadingMem DiskControllerUnit))))))
