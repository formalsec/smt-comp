...
Generator: SMPT
Application: Reachability query on the instance SmallOperatingSystem-PT-MT0064DC0032 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= TaskOnDisk (+ DiskControllerUnit 32)))
...
(assert (not (not (and (and (and (>= CPUUnit 1)(>= TaskReady 1))(not (and (>= CPUUnit 1)(>= TaskReady 1))))(and (and (>= ExecutingTask 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))))))
