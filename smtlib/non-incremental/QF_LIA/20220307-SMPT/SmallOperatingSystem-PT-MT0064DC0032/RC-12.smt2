...
(assert (not (or (or (or (<= TransferToDisk CPUUnit)(<= 1 TaskReady))(not (<= 2 DiskControllerUnit)))(or (or (<= 1 TransferToDisk)(<= FreeMemSegment CPUUnit))(or (<= 2 FreeMemSegment)(<= 3 DiskControllerUnit))))))
