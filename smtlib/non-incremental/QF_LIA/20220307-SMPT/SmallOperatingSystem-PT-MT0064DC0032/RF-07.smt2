...
(assert (and (and (not (not (>= TransferToDisk 1)))(and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= ExecutingTask 1)))(not (or (or (>= LoadingMem 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(and (>= TransferToDisk 1)(>= ExecutingTask 1))))))
