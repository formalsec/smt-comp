...
(assert (not (or (not (and (not (and (>= CPUUnit 1)(>= TaskSuspended 1)))(or (>= TransferToDisk 1)(>= LoadingMem 1))))(or (not (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= ExecutingTask 1)))(and (or (>= LoadingMem 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(not (>= TransferToDisk 1)))))))
