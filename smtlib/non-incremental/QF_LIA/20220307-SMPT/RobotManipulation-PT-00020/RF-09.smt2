...
(assert (not (or (or (or (>= p_i1 1)(and (and (>= move 1)(>= r_active 1))(and (>= move 1)(>= r_active 1))))(and (not (>= p_rdy 1))(or (and (>= initialize 1)(>= r_stopped 1))(and (>= initialize 1)(>= r_stopped 1)))))(and (>= moved 1)(>= p_m 1)))))
