...
(assert (not (or (or (or (not (and (>= initialized 1)(>= p_i2 1)))(or (and (>= off 1)(>= r_active 1))(>= p_rel 1)))(and (and (>= initialize 1)(>= r_stopped 1))(and (and (>= initialized 1)(>= p_i2 1))(and (>= access 1)(>= p_rdy 1)))))(>= p_i1 1))))
