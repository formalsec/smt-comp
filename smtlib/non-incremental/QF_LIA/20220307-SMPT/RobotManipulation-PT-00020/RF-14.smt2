...
Generator: SMPT
Application: Reachability query on the instance RobotManipulation-PT-00020 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (and (or (and (>= initialize 1)(>= r_stopped 1))(and (>= initialized 1)(>= p_i2 1)))(and (and (>= moved 1)(>= p_m 1))(>= r_moving 1)))(not (not (>= r_moving 1))))(not (and (and (and (>= moved 1)(>= p_m 1))(and (>= access 1)(>= p_rdy 1)))(and (>= r_moving 1)(>= p_rel 1)))))))
