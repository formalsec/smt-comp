...
(assert (and (>= p_i1 1)(and (and (and (>= p_rel 1)(and (>= move 1)(>= r_active 1)))(and (and (>= initialized 1)(>= p_i2 1))(and (>= off 1)(>= r_active 1))))(and (and (>= move 1)(>= r_active 1))(and (and (>= move 1)(>= r_active 1))(and (>= access 1)(>= p_rdy 1)))))))
