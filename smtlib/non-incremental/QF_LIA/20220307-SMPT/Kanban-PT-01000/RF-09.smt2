...
Generator: SMPT
Application: Reachability query on the instance Kanban-PT-01000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (and (>= P1 1)(>= Pout2 1)(>= Pout3 1))(not (or (>= P4 1)(>= Pm2 1))))(or (or (and (>= Pm3 1)(>= Pm1 1))(and (>= P1 1)(>= Pout2 1)(>= Pout3 1)))(or (or (and (>= P1 1)(>= Pout2 1)(>= Pout3 1))(>= Pout1 1))(or (>= Pback4 1)(>= Pback2 1))))))
