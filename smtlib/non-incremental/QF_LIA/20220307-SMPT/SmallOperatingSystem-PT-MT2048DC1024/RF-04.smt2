...
(assert (not (or (or (not (and (>= CPUUnit 1)(>= TaskSuspended 1)))(or (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(not (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= TransferToDisk 1))))))
