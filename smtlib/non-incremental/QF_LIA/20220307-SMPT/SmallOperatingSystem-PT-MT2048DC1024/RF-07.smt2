...
(assert (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (not (not (and (>= CPUUnit 1)(>= TaskSuspended 1))))(not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))))
