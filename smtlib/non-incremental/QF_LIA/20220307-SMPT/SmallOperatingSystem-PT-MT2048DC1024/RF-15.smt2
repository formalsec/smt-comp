...
(assert (not (or (or (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (>= TaskReady 1)(>= LoadingMem 1)))(and (or (>= LoadingMem 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))(and (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= LoadingMem 1))))(not (not (and (>= TaskReady 1)(and (>= CPUUnit 1)(>= TaskReady 1))))))))
