...
(assert (not (or (or (or (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= ExecutingTask 1))(not (and (>= CPUUnit 1)(>= TaskSuspended 1))))(and (and (>= CPUUnit 1)(>= TaskSuspended 1))(not (and (>= CPUUnit 1)(>= TaskReady 1)))))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))))
