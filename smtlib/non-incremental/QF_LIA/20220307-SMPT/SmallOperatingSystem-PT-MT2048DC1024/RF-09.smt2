...
(assert (and (not (or (or (>= LoadingMem 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (>= ExecutingTask 1)(>= ExecutingTask 1))))(and (not (not (>= LoadingMem 1)))(or (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(>= LoadingMem 1)))))
