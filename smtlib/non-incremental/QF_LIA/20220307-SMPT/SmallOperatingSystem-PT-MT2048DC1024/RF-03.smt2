...
(assert (not (or (or (or (or (>= LoadingMem 1)(>= ExecutingTask 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(not (and (>= TransferToDisk 1)(>= TransferToDisk 1))))(not (or (not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(and (and (>= CPUUnit 1)(>= TaskReady 1))(>= ExecutingTask 1)))))))
