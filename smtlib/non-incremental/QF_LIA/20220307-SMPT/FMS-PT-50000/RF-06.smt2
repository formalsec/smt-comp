...
Generator: SMPT
Application: Reachability query on the instance FMS-PT-50000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= a7 (+ P2wP1 a6)))
(assert (= a8 (+ P3M2 P3)))
(assert (= (+ a2 P12M3 P12s a5 P2M2 a7) 50000))
(assert (= (+ M3 P12M3) 2))
(assert (= (+ M2 P2M2) 1))
(assert (= (+ a1 a2 P12M3 P12s P1M1 a4) 50000))
(assert (= (+ M1 P1M1) 3))
(assert (= (+ a8 P3s) 50000))

(assert (not (or (or (not (and (and (>= M3 1)(>= P12wM3 1))(>= P2d 1)))(and (or (>= P12 1)(>= P1d 1))(>= P1d 1)))(and (and (not (>= P12 1))(and (>= P3s 1)(>= P2s 1)))(not (or (>= P1M1 1)(and (>= P1wP2 1)(>= P2wP1 1))))))))
