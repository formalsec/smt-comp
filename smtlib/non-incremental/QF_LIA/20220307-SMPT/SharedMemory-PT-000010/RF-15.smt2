...
(assert (not (or (or (not (>= Ext_Mem_Acc_2_6 1))(and (>= OwnMemAcc_2 1)(>= Memory_2 1)))(or (not (and (>= Ext_Bus 1)(>= Memory_10 1)(>= Queue_9 1)))(and (>= Ext_Mem_Acc_4_9 1)(and (>= Ext_Bus 1)(>= Memory_2 1)(>= Queue_9 1)))))))
