...
(assert (not (or (or (or (not (and (>= Ext_Bus 1)(>= Memory_5 1)(>= Queue_6 1)))(and (>= Ext_Mem_Acc_1_2 1)(>= Ext_Mem_Acc_3_8 1)))(or (not (>= Ext_Mem_Acc_4_10 1))(>= Ext_Mem_Acc_4_5 1)))(not (>= Ext_Mem_Acc_4_1 1)))))
