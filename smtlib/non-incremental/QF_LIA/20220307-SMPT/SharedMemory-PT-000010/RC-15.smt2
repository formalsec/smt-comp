...
(assert (and (and (or (<= Ext_Mem_Acc_8_10 Memory_10)(<= Ext_Mem_Acc_10_4 Ext_Mem_Acc_3_9))(and (<= OwnMemAcc_4 Ext_Mem_Acc_4_7)(<= 1 Queue_7)))(and (and (<= 2 Memory_5)(<= 3 Memory_6))(<= OwnMemAcc_2 OwnMemAcc_8))))
