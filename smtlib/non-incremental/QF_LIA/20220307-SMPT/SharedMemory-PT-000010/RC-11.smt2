...
(assert (not (or (or (or (<= 1 Ext_Mem_Acc_2_5)(<= Ext_Mem_Acc_3_4 OwnMemAcc_4))(<= 2 Ext_Mem_Acc_3_9))(or (<= OwnMemAcc_5 Ext_Mem_Acc_10_9)(or (<= Ext_Mem_Acc_1_6 Queue_5)(<= 2 Queue_8))))))
