...
(assert (and (and (>= Ext_Bus 1)(>= Memory_6 1)(>= Queue_5 1))(or (and (not (and (>= Memory_1 1)(>= Ext_Bus 1)(>= Queue_2 1)))(>= Ext_Mem_Acc_2_7 1))(and (and (and (>= Ext_Bus 1)(>= Memory_5 1)(>= Queue_8 1))(>= Ext_Mem_Acc_7_9 1))(and (>= Ext_Bus 1)(>= Memory_5 1)(>= Queue_6 1))))))
