...
(assert (and (and (or (and (>= MEK_RafP 1)(>= ERKP_MEKPP 1))(and (and (>= MEKP 1)(>= RafP 1))(and (>= ERKP 1)(>= Phase3 1))))(>= MEKPP_Phase2 1))(or (or (and (and (>= MEKPP 1)(>= Phase2 1))(and (>= MEKP 1)(>= Phase2 1)))(>= ERK_MEKPP 1))(and (and (>= MEKP_RafP 1)(and (>= MEKP 1)(>= RafP 1)))(or (and (>= MEK 1)(>= RafP 1))(>= MEK_RafP 1))))))
