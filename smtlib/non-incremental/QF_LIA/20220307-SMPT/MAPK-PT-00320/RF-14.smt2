...
(assert (not (or (or (not (and (>= ERK_MEKPP 1)(>= MEKP_Phase2 1)))(not (and (and (>= ERKP 1)(>= MEKPP 1))(>= MEKP_RafP 1))))(and (not (or (and (>= ERKP 1)(>= MEKPP 1))(>= ERK_MEKPP 1)))(not (and (>= Phase1 1)(>= RafP 1)))))))
