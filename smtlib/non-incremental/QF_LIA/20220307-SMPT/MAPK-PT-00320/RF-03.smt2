...
(assert (and (and (and (or (and (>= ERK 1)(>= MEKPP 1))(and (>= ERK 1)(>= MEKPP 1)))(>= ERKP_MEKPP 1))(or (not (and (>= Raf 1)(>= RasGTP 1)))(or (and (>= ERKPP 1)(>= Phase3 1))(and (>= MEKP 1)(>= Phase2 1)))))(or (not (>= ERKP_MEKPP 1))(and (or (>= MEKP_Phase2 1)(and (>= ERKPP 1)(>= Phase3 1)))(>= ERK_MEKPP 1)))))
