...
(assert (and (and (or (>= MEKP_Phase2 1)(>= ERKPP_Phase3 1))(and (not (>= MEK_RafP 1))(>= MEKPP_Phase2 1)))(and (or (or (and (>= MEKP 1)(>= Phase2 1))(>= ERK_MEKPP 1))(and (>= MEKPP_Phase2 1)(>= ERK_MEKPP 1)))(>= ERKP_Phase3 1))))
