...
Generator: SMPT
Application: Reachability query on the instance MAPK-PT-00320 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (and (or (>= Raf_RasGTP 1)(and (>= MEKPP 1)(>= Phase2 1)))(and (>= RafP_Phase1 1)(>= ERK_MEKPP 1)))(and (not (>= ERKPP_Phase3 1))(and (and (>= ERK 1)(>= MEKPP 1))(>= ERKP_Phase3 1))))(and (or (and (>= MEKP_Phase2 1)(>= ERKPP_Phase3 1))(and (>= MEK 1)(>= RafP 1)))(and (not (and (>= ERKP 1)(>= MEKPP 1)))(and (>= ERKP_Phase3 1)(>= RafP_Phase1 1))))))
