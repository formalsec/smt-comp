...
(assert (not (or (and (<= ExecutingTask LoadingMem)(<= ExecutingTask TaskReady))(or (or (<= 3 CPUUnit)(<= TaskOnDisk CPUUnit))(and (<= 3 TransferToDisk)(<= TaskReady DiskControllerUnit))))))
