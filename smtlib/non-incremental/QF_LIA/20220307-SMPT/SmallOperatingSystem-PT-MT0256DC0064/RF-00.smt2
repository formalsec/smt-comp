...
(assert (not (or (and (not (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(not (and (>= ExecutingTask 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))))(or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(not (not (>= LoadingMem 1)))))))
