...
(assert (and (and (or (<= 1 TransferToDisk)(<= LoadingMem TaskOnDisk))(or (<= 2 CPUUnit)(<= CPUUnit FreeMemSegment)))(and (or (<= 2 TaskOnDisk)(<= TaskSuspended LoadingMem))(and (<= FreeMemSegment CPUUnit)(<= 2 TaskSuspended)))))
