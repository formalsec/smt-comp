...
(assert (and (or (or (and (>= ExecutingTask 1)(>= TransferToDisk 1))(>= TaskReady 1))(not (and (>= TaskReady 1)(>= ExecutingTask 1))))(not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))
