...
Generator: SMPT
Application: Reachability query on the instance SmallOperatingSystem-PT-MT0256DC0064 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= TaskOnDisk (+ DiskControllerUnit 192)))
...
(assert (= (+ FreeMemSegment LoadingMem a5) 256))

(assert (and (or (not (or (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(and (and (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskSuspended 1)))(and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= TaskReady 1))))(and (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (or (and (>= CPUUnit 1)(>= TaskReady 1))(>= ExecutingTask 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))))
