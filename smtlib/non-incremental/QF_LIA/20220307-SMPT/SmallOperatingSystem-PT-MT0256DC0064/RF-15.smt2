...
(assert (not (not (not (or (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))))))
