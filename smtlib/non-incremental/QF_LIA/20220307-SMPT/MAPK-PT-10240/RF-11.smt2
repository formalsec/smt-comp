...
Generator: SMPT
Application: Reachability query on the instance MAPK-PT-10240 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (and (>= Raf 1)(>= RasGTP 1))(or (or (and (>= Phase1 1)(>= RafP 1))(>= ERKP_Phase3 1))(or (and (>= ERK 1)(>= MEKPP 1))(>= ERKP_Phase3 1))))(or (or (or (>= MEK_RafP 1)(>= MEKP_RafP 1))(or (>= ERKP_MEKPP 1)(>= MEKP_RafP 1)))(not (and (and (>= MEKP 1)(>= Phase2 1))(>= ERK_MEKPP 1)))))))
