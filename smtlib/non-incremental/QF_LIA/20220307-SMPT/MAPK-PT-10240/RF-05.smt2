...
(assert (and (and (not (and (>= MEKP 1)(>= RafP 1)))(and (not (>= ERKP_Phase3 1))(or (>= ERKP_MEKPP 1)(and (>= ERKP 1)(>= MEKPP 1)))))(and (or (>= ERK_MEKPP 1)(and (>= MEK_RafP 1)(>= ERKPP_Phase3 1)))(not (not (>= ERKP_Phase3 1))))))
