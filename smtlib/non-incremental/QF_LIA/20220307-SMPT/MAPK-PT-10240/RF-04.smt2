...
(assert (and (and (and (and (>= MEKPP_Phase2 1)(and (>= MEK 1)(>= RafP 1)))(and (>= Raf_RasGTP 1)(>= RafP_Phase1 1)))(and (and (>= Raf 1)(>= RasGTP 1))(or (and (>= MEKP 1)(>= Phase2 1))(>= ERKP_MEKPP 1))))(>= ERK_MEKPP 1)))
