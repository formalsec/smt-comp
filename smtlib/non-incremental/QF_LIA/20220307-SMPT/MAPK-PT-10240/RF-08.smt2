...
(assert (not (or (and (or (>= Raf_RasGTP 1)(or (>= ERKP_MEKPP 1)(>= ERKPP_Phase3 1)))(>= ERKPP_Phase3 1))(or (or (not (>= MEK_RafP 1))(not (>= ERKP_MEKPP 1)))(or (and (and (>= ERKPP 1)(>= Phase3 1))(and (>= ERKP 1)(>= MEKPP 1)))(not (>= MEKPP_Phase2 1)))))))
