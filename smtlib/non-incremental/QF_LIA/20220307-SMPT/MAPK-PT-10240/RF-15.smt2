...
(assert (not (or (or (not (and (and (>= ERKPP 1)(>= Phase3 1))(>= ERKP_Phase3 1)))(>= Raf_RasGTP 1))(or (and (not (>= ERKP_Phase3 1))(and (and (>= ERKPP 1)(>= Phase3 1))(>= MEK_RafP 1)))(or (not (>= ERKP_MEKPP 1))(not (>= RafP_Phase1 1)))))))
