...
(assert (not (or (not (and (and (>= ERKPP_Phase3 1)(and (>= MEK 1)(>= RafP 1)))(and (>= RafP_Phase1 1)(and (>= MEK 1)(>= RafP 1)))))(and (and (not (and (>= ERK 1)(>= MEKPP 1)))(and (>= ERKP_MEKPP 1)(>= MEKPP_Phase2 1)))(not (and (>= MEK_RafP 1)(and (>= Raf 1)(>= RasGTP 1))))))))
