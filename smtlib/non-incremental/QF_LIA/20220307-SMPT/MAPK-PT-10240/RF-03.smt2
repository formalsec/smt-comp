...
(assert (and (not (or (not (>= MEKPP_Phase2 1))(and (>= ERKPP_Phase3 1)(>= ERKPP_Phase3 1))))(and (and (or (and (>= MEKPP 1)(>= Phase2 1))(>= ERKPP_Phase3 1))(not (>= MEKPP_Phase2 1)))(and (not (and (>= MEKPP 1)(>= Phase2 1)))(and (>= ERK_MEKPP 1)(>= Raf_RasGTP 1))))))
