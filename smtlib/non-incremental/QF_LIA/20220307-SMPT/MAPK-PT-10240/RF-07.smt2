...
(assert (not (not (and (and (and (>= Raf_RasGTP 1)(>= MEK_RafP 1))(or (and (>= ERKPP 1)(>= Phase3 1))(and (>= ERKP 1)(>= MEKPP 1))))(and (and (>= RafP_Phase1 1)(>= MEKP_RafP 1))(and (and (>= MEKPP 1)(>= Phase2 1))(and (>= ERKP 1)(>= MEKPP 1))))))))
