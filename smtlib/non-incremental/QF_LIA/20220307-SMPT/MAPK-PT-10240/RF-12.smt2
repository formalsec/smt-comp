...
(assert (and (and (>= ERKPP_Phase3 1)(and (not (>= MEKPP_Phase2 1))(or (>= ERKPP_Phase3 1)(>= ERKPP_Phase3 1))))(or (and (>= Raf_RasGTP 1)(and (and (>= ERK 1)(>= MEKPP 1))(>= ERKP_MEKPP 1)))(and (or (>= MEK_RafP 1)(and (>= MEK 1)(>= RafP 1)))(or (>= ERKP_MEKPP 1)(>= MEKP_RafP 1))))))
