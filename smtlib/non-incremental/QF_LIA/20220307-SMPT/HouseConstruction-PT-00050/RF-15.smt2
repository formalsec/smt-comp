...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-00050 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (not (or (>= p18 1)(>= p2 1)))(and (not (>= p14 1))(not (>= p2 1))))(not (and (and (and (>= p19 1)(>= p20 1))(and (>= p25 1)(>= p26 1)(>= p27 1)))(and (>= p5 1)(>= p2 1)))))))
