...
(assert (not (and (and (or (or (and (>= RKIP 1)(>= Raf1Star 1))(>= RKIPP_RP 1))(or (>= MEKPP_ERK 1)(>= Raf1Star_RKIP_ERKPP 1)))(and (>= ERKPP 1)(>= Raf1Star_RKIP 1)))(or (not (and (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(>= RKIPP_RP 1)))(>= MEKPP_ERK 1)))))
