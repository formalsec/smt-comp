...
Generator: SMPT
Application: Reachability query on the instance ERK-PT-000001 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (not (not (and (>= RKIPP 1)(>= RP 1))))(not (and (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(and (>= RKIPP 1)(>= RP 1)))))(and (or (or (>= RKIPP_RP 1)(>= RKIPP_RP 1))(or (>= Raf1Star_RKIP 1)(and (>= RKIPP 1)(>= RP 1))))(not (and (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(>= RKIPP_RP 1)))))))
