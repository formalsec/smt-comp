...
(assert (not (or (not (and (and (>= F14 1)(>= Section_13 1))(and (>= F6 1)(>= Section_5 1))))(or (or (and (>= F22 1)(>= Section_21 1))(and (>= F6 1)(>= Section_5 1)))(and (and (>= F19 1)(>= Section_18 1))(and (>= F14 1)(>= Section_13 1)))))))
