...
(assert (not (or (or (or (and (>= F19 1)(>= Section_18 1))(not (and (>= F17 1)(>= Section_16 1))))(or (not (and (>= F21 1)(>= Section_20 1)))(or (and (>= F21 1)(>= Section_20 1))(and (>= F1 1)(>= Section_24 1)))))(and (and (and (and (>= F2 1)(>= Section_1 1))(and (>= F18 1)(>= Section_17 1)))(not (and (>= F7 1)(>= Section_6 1))))(and (>= F20 1)(>= Section_19 1))))))
