...
(assert (not (and (not (not (or (and (>= F14 1)(>= Section_13 1))(and (>= F14 1)(>= Section_13 1)))))(or (not (and (and (>= F11 1)(>= Section_10 1))(and (>= F15 1)(>= Section_14 1))))(or (and (>= F17 1)(>= Section_16 1))(not (and (>= F14 1)(>= Section_13 1))))))))
