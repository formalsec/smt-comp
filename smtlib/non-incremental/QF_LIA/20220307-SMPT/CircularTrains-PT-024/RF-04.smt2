...
(assert (and (and (or (not (and (>= F3 1)(>= Section_2 1)))(and (>= F18 1)(>= Section_17 1)))(and (and (and (>= F19 1)(>= Section_18 1))(and (>= F3 1)(>= Section_2 1)))(or (and (>= F7 1)(>= Section_6 1))(and (>= F22 1)(>= Section_21 1)))))(or (and (and (>= F23 1)(>= Section_22 1))(not (and (>= F3 1)(>= Section_2 1))))(and (not (and (>= F11 1)(>= Section_10 1)))(not (and (>= F17 1)(>= Section_16 1)))))))
