...
(assert (and (and (or (and (>= F12 1)(>= Section_11 1))(and (>= F5 1)(>= Section_4 1)))(or (not (and (>= F2 1)(>= Section_1 1)))(not (and (>= F2 1)(>= Section_1 1)))))(and (and (and (>= F10 1)(>= Section_9 1))(and (>= F3 1)(>= Section_2 1)))(or (and (and (>= F4 1)(>= Section_3 1))(and (>= F4 1)(>= Section_3 1)))(and (>= F24 1)(>= Section_23 1))))))
