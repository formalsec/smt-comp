...
(assert (not (not (and (and (and (and (>= F10 1)(>= Section_9 1))(and (>= F14 1)(>= Section_13 1)))(not (and (>= F14 1)(>= Section_13 1))))(or (and (and (>= F19 1)(>= Section_18 1))(and (>= F6 1)(>= Section_5 1)))(not (and (>= F4 1)(>= Section_3 1))))))))
