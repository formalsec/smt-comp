...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-00500 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (or (not (or (and (>= p15 1)(>= p4 1))(and (>= p25 1)(>= p26 1)(>= p27 1))))(or (not (and (>= p21 1)(>= p23 1)))(and (>= p11 1)(>= p22 1))))(and (or (or (and (>= p8 1)(>= p9 1))(and (>= p10 1)(>= p12 1)(>= p13 1)))(>= p5 1))(and (and (>= p10 1)(>= p12 1)(>= p13 1))(and (>= p21 1)(>= p23 1))))))
