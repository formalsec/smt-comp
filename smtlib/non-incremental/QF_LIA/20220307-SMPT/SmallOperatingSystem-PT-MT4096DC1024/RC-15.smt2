...
(assert (and (and (not (<= 3 TaskReady))(<= DiskControllerUnit TaskReady))(and (and (<= TaskSuspended DiskControllerUnit)(<= FreeMemSegment TransferToDisk))(or (<= FreeMemSegment TaskOnDisk)(<= 3 ExecutingTask)))))
