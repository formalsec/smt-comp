...
(assert (and (or (and (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= ExecutingTask 1))(or (>= ExecutingTask 1)(and (>= CPUUnit 1)(>= TaskReady 1))))(and (and (>= TransferToDisk 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(not (>= ExecutingTask 1))))(and (and (>= CPUUnit 1)(>= TaskSuspended 1))(not (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= TransferToDisk 1))))))
