...
(assert (not (or (or (and (<= ExecutingTask TaskReady)(<= CPUUnit ExecutingTask))(<= 1 DiskControllerUnit))(and (<= FreeMemSegment TaskSuspended)(or (<= 2 DiskControllerUnit)(<= 1 TaskReady))))))
