...
(assert (and (or (and (<= 1 TaskSuspended)(<= 2 LoadingMem))(or (<= TransferToDisk FreeMemSegment)(<= TaskOnDisk FreeMemSegment)))(not (or (<= CPUUnit TaskOnDisk)(<= TaskSuspended LoadingMem)))))
