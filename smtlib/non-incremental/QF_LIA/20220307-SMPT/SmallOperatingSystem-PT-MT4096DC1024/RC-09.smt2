...
(assert (and (or (and (<= TaskSuspended TaskSuspended)(<= LoadingMem TransferToDisk))(and (<= 3 ExecutingTask)(<= TaskOnDisk TaskSuspended)))(<= DiskControllerUnit TransferToDisk)))
