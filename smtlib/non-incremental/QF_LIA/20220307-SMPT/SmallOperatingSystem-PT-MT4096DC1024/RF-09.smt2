...
(assert (not (not (and (or (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskSuspended 1))))(not (or (>= TaskReady 1)(and (>= CPUUnit 1)(>= TaskSuspended 1))))))))
