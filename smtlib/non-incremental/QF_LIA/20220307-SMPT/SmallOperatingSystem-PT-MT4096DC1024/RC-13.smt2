...
(assert (not (or (and (or (<= TransferToDisk TaskOnDisk)(<= TaskOnDisk FreeMemSegment))(or (<= 2 TaskReady)(<= CPUUnit CPUUnit)))(or (and (<= 2 CPUUnit)(<= TaskOnDisk TransferToDisk))(or (<= TaskSuspended ExecutingTask)(<= CPUUnit FreeMemSegment))))))
