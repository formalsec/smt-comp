...
Generator: SMPT
Application: Reachability query on the instance SmallOperatingSystem-PT-MT4096DC1024 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= TaskOnDisk (+ DiskControllerUnit 3072)))
...
(assert (= (+ a4 LoadingMem) 1024))
(assert (= (+ FreeMemSegment LoadingMem a5) 4096))

(assert (not (or (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(or (and (>= LoadingMem 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= TransferToDisk 1))))(not (or (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= TaskReady 1))(and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))))))
