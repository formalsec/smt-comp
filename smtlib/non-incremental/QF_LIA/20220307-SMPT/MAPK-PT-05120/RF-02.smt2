...
(assert (and (not (or (and (>= MEKPP 1)(>= Phase2 1))(not (>= MEKP_Phase2 1))))(and (or (or (>= MEKP_Phase2 1)(>= MEK_RafP 1))(not (and (>= ERK 1)(>= MEKPP 1))))(and (and (>= Raf_RasGTP 1)(and (>= MEKPP 1)(>= Phase2 1)))(not (>= MEKP_Phase2 1))))))
