...
(assert (not (or (or (and (or (>= Raf_RasGTP 1)(and (>= ERK 1)(>= MEKPP 1)))(not (>= ERKP_MEKPP 1)))(not (and (>= MEKP_RafP 1)(and (>= ERK 1)(>= MEKPP 1)))))(not (or (or (>= MEKP_Phase2 1)(>= RafP_Phase1 1))(or (>= ERKP_Phase3 1)(>= ERKP_Phase3 1)))))))
