...
Generator: SMPT
Application: Reachability query on the instance MAPK-PT-05120 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (or (and (or (>= ERKP_Phase3 1)(>= ERKPP_Phase3 1))(not (>= RafP_Phase1 1)))(and (>= RafP_Phase1 1)(>= MEK_RafP 1)))(and (and (and (and (>= MEK 1)(>= RafP 1))(and (>= ERKP 1)(>= MEKPP 1)))(and (>= MEK_RafP 1)(>= ERK_MEKPP 1)))(not (and (>= ERKPP 1)(>= Phase3 1))))))
