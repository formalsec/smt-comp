...
(assert (not (not (and (and (and (>= Out 1)(and (>= Cabins 1)(>= Entered 1)))(not (and (>= Cabins 1)(>= Entered 1))))(and (and (and (>= Cabins 1)(>= InBath 1))(>= Dress 1))(and (>= Dress 1)(and (>= Cabins 1)(>= Entered 1))))))))
