...
Generator: SMPT
Application: Reachability query on the instance Diffusion2D-PT-D05N050 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (not (>= cAMP__3_4_ 1))(and (and (>= cAMP__3_3_ 1)(>= cAMP__4_3_ 1))(and (>= cAMP__3_4_ 1)(>= cAMP__2_3_ 1))))(and (and (>= cAMP__4_4_ 1)(not (>= cAMP__2_4_ 1)))(and (not (>= cAMP__2_2_ 1))(not (>= cAMP__4_2_ 1))))))
