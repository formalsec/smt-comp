...
Generator: SMPT
Application: Reachability query on the instance Diffusion2D-PT-D05N300 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (and (not (>= cAMP__2_3_ 1))(or (>= cAMP__2_4_ 1)(>= cAMP__3_3_ 1)))(not (or (>= cAMP__1_3_ 1)(>= cAMP__3_2_ 1))))(and (not (and (>= cAMP__4_2_ 1)(>= cAMP__5_4_ 1)))(and (and (>= cAMP__5_2_ 1)(>= cAMP__1_5_ 1))(or (>= cAMP__4_4_ 1)(>= cAMP__3_5_ 1))))))
