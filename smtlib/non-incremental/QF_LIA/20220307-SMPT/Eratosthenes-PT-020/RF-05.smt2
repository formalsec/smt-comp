...
(assert (and (and (and (not (and (>= p18 1)(>= p9 1)))(not (and (>= p14 1)(>= p2 1))))(not (or (and (>= p14 1)(>= p7 1))(and (>= p16 1)(>= p4 1)))))(and (and (not (and (>= p12 1)(>= p4 1)))(and (>= p15 1)(>= p3 1)))(not (not (and (>= p14 1)(>= p7 1)))))))
