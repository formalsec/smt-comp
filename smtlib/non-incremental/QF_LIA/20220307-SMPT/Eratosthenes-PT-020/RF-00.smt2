...
(assert (and (and (not (or (and (>= p18 1)(>= p9 1))(and (>= p14 1)(>= p2 1))))(and (>= p18 1)(>= p9 1)))(and (or (not (and (>= p6 1)(>= p3 1)))(or (and (>= p10 1)(>= p5 1))(and (>= p6 1)(>= p2 1))))(not (and (and (>= p14 1)(>= p2 1))(and (>= p12 1)(>= p3 1)))))))
