...
(assert (not (or (or (or (not (and (>= p15 1)(>= p5 1)))(and (>= p15 1)(>= p3 1)))(and (not (and (>= p16 1)(>= p8 1)))(not (and (>= p10 1)(>= p5 1)))))(and (or (not (and (>= p20 1)(>= p10 1)))(and (>= p10 1)(>= p5 1)))(and (or (and (>= p15 1)(>= p5 1))(and (>= p6 1)(>= p2 1)))(not (and (>= p20 1)(>= p5 1))))))))
