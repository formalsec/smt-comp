...
(assert (not (or (or (not (and (>= Cells_0_0 1)(>= Columns_0_0 1)(>= Regions_0_0 1)(>= Rows_0_0 1)))(not (and (>= Cells_0_0 1)(>= Columns_0_0 1)(>= Regions_0_0 1)(>= Rows_0_0 1))))(and (or (and (>= Cells_0_0 1)(>= Columns_0_0 1)(>= Regions_0_0 1)(>= Rows_0_0 1))(and (>= Cells_0_0 1)(>= Columns_0_0 1)(>= Regions_0_0 1)(>= Rows_0_0 1)))(not (and (>= Cells_0_0 1)(>= Columns_0_0 1)(>= Regions_0_0 1)(>= Rows_0_0 1)))))))
