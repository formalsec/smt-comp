...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-02000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (or (and (and (and (and (>= p10 1)(>= p12 1)(>= p13 1))(>= p17 1))(and (and (>= p10 1)(>= p12 1)(>= p13 1))(>= p11 1)))(or (or (>= p6 1)(>= p14 1))(and (>= p22 1)(>= p7 1))))(and (or (>= p7 1)(and (>= p2 1)(>= p1 1)))(and (and (and (>= p19 1)(>= p20 1))(and (>= p10 1)(>= p12 1)(>= p13 1)))(and (and (>= p25 1)(>= p26 1)(>= p27 1))(>= p2 1))))))
