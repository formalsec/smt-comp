...
(assert (not (and (or (or (or (>= p_1_1_0 1)(>= p_0_2_1 1))(and (>= p_0_1_1 1)(>= p_1_0_2 1)))(and (not (>= p_0_1_1 1))(not (>= p_1_1_1 1))))(or (and (and (>= p_2_2_0 1)(>= p_0_1_0 1))(or (>= p_1_2_1 1)(>= p_0_2_2 1)))(or (or (>= p_2_0_1 1)(>= p_2_0_2 1))(not (>= p_1_1_1 1)))))))
