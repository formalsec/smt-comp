...
(assert (not (or (not (and (and (and (>= MEKP 1)(>= Phase2 1))(>= ERKP_Phase3 1))(and (>= ERKP_Phase3 1)(>= MEKP_Phase2 1))))(or (or (>= MEKP_RafP 1)(or (and (>= MEKPP 1)(>= Phase2 1))(>= RafP_Phase1 1)))(>= MEKPP_Phase2 1)))))
