...
(assert (not (and (or (or (and (>= Raf_RasGTP 1)(and (>= ERKP 1)(>= Phase3 1)))(>= MEKP_RafP 1))(and (>= Raf 1)(>= RasGTP 1)))(or (not (and (>= MEKP_RafP 1)(>= MEKP_Phase2 1)))(or (and (>= ERK 1)(>= MEKPP 1))(or (and (>= Raf 1)(>= RasGTP 1))(>= MEKP_RafP 1)))))))
