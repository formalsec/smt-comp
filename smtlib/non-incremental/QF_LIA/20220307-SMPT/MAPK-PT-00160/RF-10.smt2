...
Generator: SMPT
Application: Reachability query on the instance MAPK-PT-00160 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (and (and (>= ERKP_Phase3 1)(>= ERKPP_Phase3 1))(>= ERK_MEKPP 1))(not (and (>= MEK_RafP 1)(>= MEKP_Phase2 1))))(or (and (or (>= MEKP_RafP 1)(and (>= ERK 1)(>= MEKPP 1)))(and (>= ERKPP_Phase3 1)(>= Raf_RasGTP 1)))(or (>= Raf_RasGTP 1)(and (>= ERKP_Phase3 1)(and (>= ERKP 1)(>= MEKPP 1)))))))
