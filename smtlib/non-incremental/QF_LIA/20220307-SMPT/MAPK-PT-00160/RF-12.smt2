...
(assert (and (and (not (not (>= ERKP_Phase3 1)))(or (not (>= ERKPP_Phase3 1))(>= ERKP_Phase3 1)))(and (or (and (>= ERKP_MEKPP 1)(>= MEKP_Phase2 1))(or (>= ERK_MEKPP 1)(>= MEKP_RafP 1)))(and (or (>= MEKP_RafP 1)(>= ERKP_MEKPP 1))(and (>= MEKPP_Phase2 1)(>= RafP_Phase1 1))))))
