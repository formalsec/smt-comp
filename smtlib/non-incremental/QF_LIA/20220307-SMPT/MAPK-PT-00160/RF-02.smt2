...
(assert (not (or (and (or (not (>= ERKP_MEKPP 1))(>= ERKP_Phase3 1))(or (not (and (>= MEK 1)(>= RafP 1)))(not (>= RafP_Phase1 1))))(not (and (>= ERKPP_Phase3 1)(or (and (>= Raf 1)(>= RasGTP 1))(>= ERKP_Phase3 1)))))))
