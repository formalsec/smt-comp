...
(assert (not (or (and (and (not (>= MEK_RafP 1))(or (and (>= ERKP 1)(>= Phase3 1))(and (>= Phase1 1)(>= RafP 1))))(or (or (and (>= MEKP 1)(>= RafP 1))(and (>= ERKP 1)(>= Phase3 1)))(not (>= ERKPP_Phase3 1))))(or (and (>= Raf 1)(>= RasGTP 1))(>= ERKPP_Phase3 1)))))
