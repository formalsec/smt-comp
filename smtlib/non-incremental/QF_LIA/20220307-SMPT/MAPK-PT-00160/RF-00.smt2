...
(assert (not (or (or (>= ERK_MEKPP 1)(or (or (and (>= ERKP 1)(>= Phase3 1))(>= MEK_RafP 1))(>= MEKPP_Phase2 1)))(or (and (not (and (>= Raf 1)(>= RasGTP 1)))(and (>= MEKPP_Phase2 1)(>= RafP_Phase1 1)))(not (and (>= ERK_MEKPP 1)(and (>= MEK 1)(>= RafP 1))))))))
