...
Generator: SMPT
Application: Reachability query on the instance Kanban-PT-02000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (not (and (>= Pback4 1)(>= Pm2 1)))(or (and (>= Pm1 1)(>= Pm4 1))(and (>= P4 1)(>= Pout1 1))))(or (and (and (>= Pback1 1)(>= Pm1 1))(>= Pm4 1))(and (and (>= P2 1)(>= P3 1)(>= Pout4 1))(not (and (>= P2 1)(>= P3 1)(>= Pout4 1)))))))
