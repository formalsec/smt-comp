...
(assert (and (and (and (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(or (>= ExecutingTask 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(not (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= ExecutingTask 1))))(or (>= TaskReady 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))))
