...
(assert (and (not (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= ExecutingTask 1))))(not (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(not (>= ExecutingTask 1))))))
