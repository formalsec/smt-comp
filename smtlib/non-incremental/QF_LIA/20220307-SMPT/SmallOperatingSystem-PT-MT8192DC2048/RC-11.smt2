...
(assert (not (or (or (and (<= 1 LoadingMem)(<= 3 FreeMemSegment))(or (<= 3 FreeMemSegment)(<= FreeMemSegment ExecutingTask)))(or (and (<= DiskControllerUnit CPUUnit)(<= TaskOnDisk TaskReady))(and (<= ExecutingTask FreeMemSegment)(<= 3 TaskReady))))))
