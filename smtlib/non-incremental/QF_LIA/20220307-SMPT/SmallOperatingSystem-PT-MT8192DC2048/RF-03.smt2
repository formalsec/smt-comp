...
(assert (not (or (>= TransferToDisk 1)(or (or (not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(not (and (>= CPUUnit 1)(>= TaskSuspended 1))))(and (>= CPUUnit 1)(>= TaskSuspended 1))))))
