...
(assert (and (or (and (not (and (>= F2 1)(>= Section_1 1)))(not (and (>= F9 1)(>= Section_8 1))))(and (not (and (>= F3 1)(>= Section_2 1)))(not (and (>= F8 1)(>= Section_7 1)))))(or (not (and (and (>= F10 1)(>= Section_9 1))(and (>= F6 1)(>= Section_5 1))))(and (not (and (>= F12 1)(>= Section_11 1)))(and (and (>= F9 1)(>= Section_8 1))(and (>= F6 1)(>= Section_5 1)))))))
