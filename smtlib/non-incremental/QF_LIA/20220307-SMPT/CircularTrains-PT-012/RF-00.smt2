...
(assert (not (and (and (or (or (and (>= F6 1)(>= Section_5 1))(and (>= F5 1)(>= Section_4 1)))(and (and (>= F7 1)(>= Section_6 1))(and (>= F10 1)(>= Section_9 1))))(and (>= F9 1)(>= Section_8 1)))(not (and (and (>= F11 1)(>= Section_10 1))(or (and (>= F4 1)(>= Section_3 1))(and (>= F8 1)(>= Section_7 1))))))))
