...
(assert (not (not (and (and (or (and (>= F5 1)(>= Section_4 1))(and (>= F11 1)(>= Section_10 1)))(not (and (>= F7 1)(>= Section_6 1))))(and (and (and (>= F10 1)(>= Section_9 1))(and (>= F8 1)(>= Section_7 1)))(and (>= F2 1)(>= Section_1 1)))))))
