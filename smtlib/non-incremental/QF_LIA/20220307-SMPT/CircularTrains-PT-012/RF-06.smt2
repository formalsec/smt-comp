...
(assert (and (or (or (not (and (>= F5 1)(>= Section_4 1)))(or (and (>= F5 1)(>= Section_4 1))(and (>= F9 1)(>= Section_8 1))))(or (and (and (>= F12 1)(>= Section_11 1))(and (>= F1 1)(>= Section_12 1)))(or (and (>= F3 1)(>= Section_2 1))(and (>= F4 1)(>= Section_3 1)))))(not (or (not (and (>= F4 1)(>= Section_3 1)))(not (and (>= F7 1)(>= Section_6 1)))))))
