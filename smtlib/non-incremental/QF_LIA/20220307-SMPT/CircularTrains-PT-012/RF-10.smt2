...
(assert (not (or (and (>= F11 1)(>= Section_10 1))(and (not (and (>= F9 1)(>= Section_8 1)))(and (and (and (>= F4 1)(>= Section_3 1))(and (>= F9 1)(>= Section_8 1)))(or (and (>= F3 1)(>= Section_2 1))(and (>= F5 1)(>= Section_4 1))))))))
