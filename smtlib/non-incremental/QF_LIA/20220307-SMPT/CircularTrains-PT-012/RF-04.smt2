...
(assert (not (and (or (not (and (>= F11 1)(>= Section_10 1)))(and (and (>= F5 1)(>= Section_4 1))(and (>= F2 1)(>= Section_1 1))))(and (and (and (>= F12 1)(>= Section_11 1))(and (>= F5 1)(>= Section_4 1)))(not (and (>= F6 1)(>= Section_5 1)))))))
