...
(assert (not (and (or (and (and (>= F5 1)(>= Section_4 1))(and (>= F2 1)(>= Section_1 1)))(and (>= F6 1)(>= Section_5 1)))(or (and (or (and (>= F5 1)(>= Section_4 1))(and (>= F6 1)(>= Section_5 1)))(and (and (>= F11 1)(>= Section_10 1))(and (>= F5 1)(>= Section_4 1))))(and (>= F7 1)(>= Section_6 1))))))
