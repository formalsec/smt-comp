...
(assert (not (or (and (and (>= F2 1)(>= Section_1 1))(not (not (and (>= F4 1)(>= Section_3 1)))))(and (and (and (>= F5 1)(>= Section_4 1))(and (>= F6 1)(>= Section_5 1)))(or (and (>= F4 1)(>= Section_3 1))(and (and (>= F9 1)(>= Section_8 1))(and (>= F11 1)(>= Section_10 1))))))))
