...
(assert (not (and (or (and (>= Mutex_2 1)(>= WaitMutex_1_2 1))(and (>= Message_2_2 1)(and (>= WaitMutex_1_1 1)(>= Mutex_1 1))))(or (or (>= MesBuffReply_1_2 1)(>= all_active_1 1))(and (>= Message_1_2 1)(and (>= RecBuff_1_2 1)(>= all_passive_1 1)))))))
