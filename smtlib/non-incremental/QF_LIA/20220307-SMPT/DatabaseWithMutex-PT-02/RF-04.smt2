...
(assert (not (and (or (or (>= Modify_1_1 1)(>= Modify_1_2 1)(>= Modify_2_2 1)(>= Modify_2_1 1))(and (or (>= all_active_1 1)(>= all_active_2 1)(>= all_active_2 1)(>= all_active_1 1))(or (and (>= Acknowledge_2_2 1)(>= Active_1_2 1))(and (>= Acknowledge_1_2 1)(>= Active_2_2 1))(and (>= Acknowledge_2_1 1)(>= Active_1_1 1))(and (>= Acknowledge_1_1 1)(>= Active_2_1 1)))))(and (not (or (or (and (>= Mutex_1 1)(>= WaitMutex_2_1 1))(and (>= WaitMutex_1_1 1)(>= Mutex_1 1))(and (>= Mutex_2 1)(>= WaitMutex_2_2 1))(and (>= Mutex_2 1)(>= WaitMutex_1_2 1)))(or (and (>= Acknowledge_2_2 1)(>= Active_1_2 1))(and (>= Acknowledge_1_2 1)(>= Active_2_2 1))(and (>= Acknowledge_2_1 1)(>= Active_1_1 1))(and (>= Acknowledge_1_1 1)(>= Active_2_1 1)))))(or (or (or (and (>= RecBuff_1_2 1)(>= all_passive_1 1))(and (>= RecBuff_2_2 1)(>= all_passive_2 1))(and (>= RecBuff_1_1 1)(>= all_passive_1 1))(and (>= RecBuff_2_1 1)(>= all_passive_2 1)))(or (>= MesBuffReply_2_2 1)(>= MesBuffReply_1_2 1)(>= MesBuffReply_2_1 1)(>= MesBuffReply_1_1 1)))(or (and (>= RecBuff_1_2 1)(>= all_passive_1 1))(and (>= RecBuff_2_2 1)(>= all_passive_2 1))(and (>= RecBuff_1_1 1)(>= all_passive_1 1))(and (>= RecBuff_2_1 1)(>= all_passive_2 1))))))))
