...
(assert (not (or (>= MesBuffReply_1_2 1)(not (or (not (and (>= Acknowledge_2_1 1)(>= Active_1_1 1)))(or (and (>= RecBuff_2_2 1)(>= all_passive_2 1))(and (>= Acknowledge_1_2 1)(>= Active_2_2 1))))))))
