...
(assert (not (not (and (and (not (or (>= MesBuffReply_2_2 1)(>= MesBuffReply_1_2 1)(>= MesBuffReply_2_1 1)(>= MesBuffReply_1_1 1)))(not (or (>= updating_2_1 1)(>= updating_1_1 1)(>= updating_1_2 1)(>= updating_2_2 1))))(or (>= all_active_1 1)(>= all_active_2 1)(>= all_active_2 1)(>= all_active_1 1))))))
