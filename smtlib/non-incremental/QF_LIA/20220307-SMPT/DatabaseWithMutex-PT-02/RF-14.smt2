...
(assert (not (or (>= Modify_2_2 1)(or (and (not (>= updating_1_2 1))(not (>= Message_1_1 1)))(and (and (and (>= RecBuff_1_1 1)(>= all_passive_1 1))(>= Modify_2_1 1))(and (>= Mutex_2 1)(>= WaitMutex_2_2 1)))))))
