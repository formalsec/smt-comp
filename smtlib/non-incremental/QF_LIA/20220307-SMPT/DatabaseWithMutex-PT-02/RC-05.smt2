...
(assert (not (or (and (not (<= (+ all_passive_2 all_passive_1) (+ all_active_1 all_active_2)))(<= (+ WaitMutex_1_1 WaitMutex_2_2 WaitMutex_1_2 WaitMutex_2_1) (+ updating_2_1 updating_1_1 updating_1_2 updating_2_2)))(<= (+ Mutex_2 Mutex_1) (+ Modify_2_2 Modify_2_1 Modify_1_1 Modify_1_2)))))
