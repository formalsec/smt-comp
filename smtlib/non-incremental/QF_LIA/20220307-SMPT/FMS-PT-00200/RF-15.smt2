...
Generator: SMPT
Application: Reachability query on the instance FMS-PT-00200 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= a7 (+ P2wP1 a6)))
(assert (= a8 (+ P3M2 P3)))
(assert (= (+ a2 P12M3 P12s a5 P2M2 a7) 200))
(assert (= (+ M3 P12M3) 2))
(assert (= (+ M2 P2M2) 1))
(assert (= (+ a1 a2 P12M3 P12s P1M1 a4) 200))
(assert (= (+ M1 P1M1) 3))
(assert (= (+ a8 P3s) 200))

(assert (and (or (or (not (>= P12M3 1))(or (and (>= M2 1)(>= P2wM2 1))(>= P2d 1)))(or (and (and (>= P1wP2 1)(>= P2wP1 1))(and (>= M1 1)(>= P1wM1 1)))(or (>= P12M3 1)(and (>= M2 1)(>= P2wM2 1)))))(not (or (or (>= P2d 1)(>= P2M2 1))(not (>= P2d 1))))))
