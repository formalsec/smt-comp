...
(assert (and (not (or (not (and (>= CPUUnit 1)(>= TaskSuspended 1)))(not (and (>= CPUUnit 1)(>= TaskReady 1)))))(not (or (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskReady 1)))))))
