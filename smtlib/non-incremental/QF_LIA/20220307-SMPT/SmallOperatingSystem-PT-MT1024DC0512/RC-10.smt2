...
(assert (and (or (and (<= 2 TaskOnDisk)(<= 2 FreeMemSegment))(and (<= TaskSuspended ExecutingTask)(<= 2 DiskControllerUnit)))(and (not (<= LoadingMem LoadingMem))(and (<= 2 ExecutingTask)(<= TaskOnDisk FreeMemSegment)))))
