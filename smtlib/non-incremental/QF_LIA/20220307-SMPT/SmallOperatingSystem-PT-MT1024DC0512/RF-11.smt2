...
(assert (not (not (and (and (and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= ExecutingTask 1))(not (and (>= CPUUnit 1)(>= TaskReady 1))))(and (>= CPUUnit 1)(>= TaskReady 1))))))
