...
(assert (and (and (>= LoadingMem 1)(not (>= LoadingMem 1)))(or (or (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskSuspended 1)))(and (and (>= CPUUnit 1)(>= TaskReady 1))(>= TransferToDisk 1)))(not (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= LoadingMem 1))))))
