...
(assert (and (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (and (and (>= ExecutingTask 1)(>= TaskReady 1))(and (>= TaskReady 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskSuspended 1))))))
