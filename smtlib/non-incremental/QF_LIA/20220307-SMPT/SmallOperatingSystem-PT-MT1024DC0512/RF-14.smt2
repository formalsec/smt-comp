...
(assert (and (and (not (or (>= TaskReady 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(and (>= CPUUnit 1)(>= TaskReady 1)))(or (>= TransferToDisk 1)(not (not (>= LoadingMem 1))))))
