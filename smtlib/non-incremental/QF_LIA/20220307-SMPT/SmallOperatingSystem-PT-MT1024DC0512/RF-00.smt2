...
(assert (and (and (and (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= TransferToDisk 1)))(>= LoadingMem 1))(not (and (or (>= LoadingMem 1)(>= TaskReady 1))(or (>= LoadingMem 1)(and (>= CPUUnit 1)(>= TaskReady 1)))))))
