...
(assert (not (or (or (or (and (>= TransferToDisk 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))(and (>= CPUUnit 1)(>= TaskSuspended 1)))(or (not (and (>= CPUUnit 1)(>= TaskReady 1)))(not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))))
