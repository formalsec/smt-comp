...
(assert (not (or (or (not (>= LoadingMem 1))(not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(or (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= LoadingMem 1))(and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= TaskReady 1))))))
