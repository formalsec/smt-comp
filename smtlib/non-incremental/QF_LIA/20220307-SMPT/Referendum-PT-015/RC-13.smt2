...
(assert (or (and (or (<= 2 voted_no_7)(<= voting_1 voting_12))(and (<= 3 voted_no_6)(<= 1 voted_yes_4)))(or (and (<= 2 voted_no_6)(<= voted_no_3 voted_no_1))(and (<= 2 voted_yes_9)(<= voting_10 voted_no_15)))))
