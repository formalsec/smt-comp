...
(assert (not (or (and (not (and (>= voting_5 1)(>= voting_2 1)))(not (or (>= voting_4 1)(>= voting_6 1))))(or (not (and (>= voting_8 1)(>= voting_12 1)))(or (or (>= voting_3 1)(>= voting_8 1))(or (>= voting_7 1)(>= voting_5 1)))))))
