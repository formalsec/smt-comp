...
(assert (not (or (and (or (not (>= p5 1))(>= p7 1))(or (and (>= p18 1)(>= p6 1))(and (>= p8 1)(>= p9 1))))(or (or (and (>= p22 1)(>= p14 1))(and (>= p17 1)(and (>= p25 1)(>= p26 1)(>= p27 1))))(or (not (and (>= p8 1)(>= p9 1)))(or (>= p1 1)(>= p3 1)))))))
