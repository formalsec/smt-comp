...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-00100 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (not (and (and (>= p19 1)(>= p20 1))(and (>= p21 1)(>= p23 1))))(or (or (>= p18 1)(and (>= p21 1)(>= p23 1)))(and (>= p14 1)(>= p2 1))))(and (or (and (>= p14 1)(and (>= p21 1)(>= p23 1)))(>= p6 1))(or (or (>= p6 1)(>= p17 1))(>= p5 1))))))
