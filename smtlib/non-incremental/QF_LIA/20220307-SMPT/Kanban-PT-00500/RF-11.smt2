...
(assert (or (and (and (and (>= Pm4 1)(>= Pback2 1))(and (>= Pm1 1)(and (>= P1 1)(>= Pout2 1)(>= Pout3 1))))(or (not (>= Pback4 1))(and (>= Pm2 1)(>= Pback3 1))))(and (and (not (>= Pm2 1))(not (>= Pm1 1)))(and (or (>= Pm3 1)(>= P4 1))(or (>= Pm2 1)(>= Pm1 1))))))
