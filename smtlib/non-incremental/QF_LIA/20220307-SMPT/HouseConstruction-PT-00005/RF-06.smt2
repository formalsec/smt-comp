...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-00005 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (or (or (>= p14 1)(and (>= p15 1)(>= p4 1)))(or (and (>= p10 1)(>= p12 1)(>= p13 1))(>= p14 1)))(not (and (>= p17 1)(and (>= p10 1)(>= p12 1)(>= p13 1)))))(not (not (and (>= p1 1)(and (>= p19 1)(>= p20 1))))))))
