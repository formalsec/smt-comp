...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-32000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (and (not (>= p3 1))(or (and (>= p21 1)(>= p23 1))(and (>= p21 1)(>= p23 1))))(and (and (>= p21 1)(>= p23 1))(>= p5 1)))(or (and (not (and (>= p15 1)(>= p4 1)))(not (>= p2 1)))(not (or (>= p22 1)(>= p3 1))))))
