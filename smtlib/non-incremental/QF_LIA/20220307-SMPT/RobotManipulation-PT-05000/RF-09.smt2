...
(assert (not (or (or (or (not (>= p_rdy 1))(and (and (>= off 1)(>= r_active 1))(>= p_rdy 1)))(and (or (and (>= access 1)(>= p_rdy 1))(>= p_rdy 1))(>= p_sc 1)))(or (or (or (>= p_i1 1)(and (>= initialized 1)(>= p_i2 1)))(>= p_sc 1))(not (not (and (>= off 1)(>= r_active 1))))))))
