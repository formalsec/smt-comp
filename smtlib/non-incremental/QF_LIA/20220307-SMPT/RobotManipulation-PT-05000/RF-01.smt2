...
(assert (and (or (and (>= p_sc 1)(and (and (>= move 1)(>= r_active 1))(>= p_i1 1)))(not (not (and (>= moved 1)(>= p_m 1)))))(and (not (not (>= p_rdy 1)))(and (and (and (>= off 1)(>= r_active 1))(>= p_rel 1))(or (and (>= initialize 1)(>= r_stopped 1))(>= p_i1 1))))))
