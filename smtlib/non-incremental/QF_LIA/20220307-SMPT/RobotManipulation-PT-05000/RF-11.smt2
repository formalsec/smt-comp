...
(assert (and (or (not (or (and (>= moved 1)(>= p_m 1))(>= p_sc 1)))(and (>= off 1)(>= r_active 1)))(and (and (and (and (>= moved 1)(>= p_m 1))(and (>= access 1)(>= p_rdy 1)))(not (>= p_i1 1)))(or (and (>= access 1)(>= p_rdy 1))(not (and (>= moved 1)(>= p_m 1)))))))
