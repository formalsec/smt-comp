...
(assert (and (and (not (and (and (>= off 1)(>= r_active 1))(and (>= access 1)(>= p_rdy 1))))(not (or (>= p_i1 1)(>= r_moving 1))))(or (and (>= p_rdy 1)(and (and (>= access 1)(>= p_rdy 1))(>= r_moving 1)))(and (>= off 1)(>= r_active 1)))))
