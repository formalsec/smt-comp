...
Generator: SMPT
Application: Reachability query on the instance RobotManipulation-PT-05000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (and (and (and (and (>= move 1)(>= r_active 1))(>= p_rdy 1))(and (>= p_rel 1)(and (>= initialized 1)(>= p_i2 1))))(and (>= off 1)(>= r_active 1)))(or (or (and (>= p_sc 1)(and (>= initialized 1)(>= p_i2 1)))(not (and (>= move 1)(>= r_active 1))))(or (or (>= p_sc 1)(>= p_i1 1))(not (and (>= initialized 1)(>= p_i2 1))))))))
