...
(assert (and (and (not (or (and (>= initialized 1)(>= p_i2 1))(and (>= off 1)(>= r_active 1))))(and (and (>= off 1)(>= r_active 1))(and (>= p_rdy 1)(and (>= move 1)(>= r_active 1)))))(or (and (>= moved 1)(>= p_m 1))(not (and (>= p_rdy 1)(and (>= move 1)(>= r_active 1)))))))
