...
(assert (and (and (or (not (>= MEK_RafP 1))(and (>= MEKP 1)(>= Phase2 1)))(and (and (>= MEKPP_Phase2 1)(>= MEKP_Phase2 1))(and (>= MEKP_RafP 1)(>= Raf_RasGTP 1))))(or (and (>= ERKPP 1)(>= Phase3 1))(and (and (>= ERKP_MEKPP 1)(and (>= MEKPP 1)(>= Phase2 1)))(not (>= ERKPP_Phase3 1))))))
