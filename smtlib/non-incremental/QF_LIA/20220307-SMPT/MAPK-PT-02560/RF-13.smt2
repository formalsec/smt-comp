...
Generator: SMPT
Application: Reachability query on the instance MAPK-PT-02560 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (and (and (and (>= MEKP 1)(>= RafP 1))(>= ERKP_Phase3 1))(and (>= ERK_MEKPP 1)(>= MEK_RafP 1)))(and (or (and (>= MEKP 1)(>= Phase2 1))(>= ERKP_MEKPP 1))(not (>= RafP_Phase1 1))))(and (or (not (and (>= ERKP 1)(>= MEKPP 1)))(or (>= MEKP_RafP 1)(and (>= ERKPP 1)(>= Phase3 1))))(and (>= MEKPP 1)(>= Phase2 1)))))
