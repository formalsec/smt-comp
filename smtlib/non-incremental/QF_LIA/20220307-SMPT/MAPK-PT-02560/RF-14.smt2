...
(assert (and (and (>= MEKP 1)(>= Phase2 1))(and (and (and (>= ERKP_MEKPP 1)(and (>= MEKP 1)(>= Phase2 1)))(or (>= Raf_RasGTP 1)(and (>= MEKPP 1)(>= Phase2 1))))(and (>= Raf_RasGTP 1)(and (>= MEKP_Phase2 1)(>= MEK_RafP 1))))))
