...
(assert (and (not (or (or (>= MEKP_RafP 1)(and (>= Phase1 1)(>= RafP 1)))(and (and (>= ERKP 1)(>= MEKPP 1))(>= Raf_RasGTP 1))))(and (not (and (>= MEKP 1)(>= Phase2 1)))(not (or (and (>= Raf 1)(>= RasGTP 1))(>= MEKP_RafP 1))))))
