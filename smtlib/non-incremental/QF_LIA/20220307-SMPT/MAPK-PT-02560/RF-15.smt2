...
(assert (and (and (or (or (and (>= MEKP 1)(>= Phase2 1))(>= ERK_MEKPP 1))(or (>= ERK_MEKPP 1)(>= ERKP_Phase3 1)))(and (>= ERKP 1)(>= MEKPP 1)))(not (or (not (and (>= ERKPP 1)(>= Phase3 1)))(and (>= MEKP 1)(>= Phase2 1))))))
