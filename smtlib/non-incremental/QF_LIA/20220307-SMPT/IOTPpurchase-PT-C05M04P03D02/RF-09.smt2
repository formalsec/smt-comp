...
(assert (not (not (and (not (and (and (>= PayReceipt_p21_15 1)(>= Status_p21_14 1)(>= PaymentNote_p21_16 1)(>= p3_10 1))(and (>= Status_p22_11 1)(>= p8_2 1)(>= DeliveryNote_p22_12 1)(>= p12_7 1))))(and (not (and (>= DeliveryHandlerDelivery_p8_0 1)(>= DeliveryRequest_p12_5 1)))(and (>= p5_4 1)(and (>= PaySchemeData_p21_10 1)(>= p11_11 1)(>= p5_2 1))))))))
