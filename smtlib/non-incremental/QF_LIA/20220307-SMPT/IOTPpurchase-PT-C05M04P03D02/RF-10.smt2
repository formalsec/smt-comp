...
(assert (not (or (or (or (or (and (>= BrandList_p11_2 1)(>= p3_2 1))(>= p4_4 1))(and (>= BrandList_p11_2 1)(>= p3_2 1)))(not (not (and (>= Payment_p20 1)(>= Delivery_p20 1)(>= Order_p20 1)(>= Organization_p20_2 1)(>= Status_p20 1)(>= p2_2 1)(>= OfferResponce_p10 1)))))(not (and (>= DeliveryNote_p22_14 1)(>= p6_6 1)(>= Status_p22_13 1))))))
