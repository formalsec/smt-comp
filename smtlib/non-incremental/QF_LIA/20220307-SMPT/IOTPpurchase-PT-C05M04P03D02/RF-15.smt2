...
(assert (not (or (and (or (and (>= Organization_p22_2 1)(>= Order_p22_3 1)(>= Delivery_p22_1 1)(>= p7_2 1)(>= p12_3 1))(or (>= p2_1 1)(and (>= PaymentHandlerPayment_p5_0 1)(>= PaymentRequest_p11_9 1))))(and (not (and (>= p12_0 1)(>= p6_1 1)))(and (and (>= Organization_p21_2 1)(>= p4_5 1)(>= Payment_p21_1 1)(>= p11_7 1))(>= p6_7 1))))(not (and (>= p8_1 1)(>= Delivery_p22_8 1)(>= Organization_p22_9 1)(>= Order_p22_10 1)(>= Status_p22_11 1))))))
