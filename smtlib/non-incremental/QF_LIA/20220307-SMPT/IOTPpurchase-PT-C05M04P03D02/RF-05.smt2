...
(assert (and (not (>= p3_6 1))(or (not (not (>= p7_3 1)))(and (and (and (>= PayReceipt_p21_15 1)(>= Status_p21_14 1)(>= PaymentNote_p21_16 1)(>= p3_10 1))(>= ConsumerPayment_p3 1))(not (and (>= p11_4 1)(>= p3_4 1)))))))
