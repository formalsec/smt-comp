...
(assert (and (not (and (or (>= p7_1 1)(>= p3_6 1))(and (>= Status_p22_7 1)(>= p6_4 1)(>= Delivery_p22_4 1)(>= p12_4 1)(>= Organization_p22_5 1)(>= Order_p22_6 1))))(and (>= p6_7 1)(and (>= MerchantOffer_p2 1)(>= OfferRequest_p10 1)))))
