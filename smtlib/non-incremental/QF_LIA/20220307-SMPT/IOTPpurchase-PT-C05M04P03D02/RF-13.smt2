...
Generator: SMPT
Application: Reachability query on the instance IOTPpurchase-PT-C05M04P03D02 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= (+ BrandList_p11_2 BrandSelection_p11_5 a2 a4 DeliveryRequest_p12_5 DeliveryResponse_p12_6 a13 Delivery_p22_4 a15 HowDeliver_p12_2 OfferRequest_p10 Organization_p21_4 PaidFor_p11_1 PayReceipt_p21_12 a14 PaySchemeData_p21_10 PaymentAmount_p11_6 PaymentRequest_p11_9 PaymentResponse_p11_12 WhatDeliver_p12_1 p10_2 a6 a7 a9 a10 a12) 5))
(assert (= (+ DeliveryHandlerDelivery_p8_0 a15 p8_3) 2))
(assert (= (+ BrandList_p11_2 BrandSelection_p11_5 a13 MerchantOffer_p2 Organization_p21_4 PaidFor_p11_1 PayReceipt_p21_12 a14 PaySchemeData_p21_10 PaymentAmount_p11_6 PaymentRequest_p11_9 PaymentResponse_p11_12 WhatDeliver_p12_1 p10_2 a6 a7 a9 a10 a12 p7_3) 4))
(assert (= (+ BrandList_p11_2 BrandSelection_p11_5 a13 MerchantOffer_p2 Organization_p21_4 PaidFor_p11_1 a14 PaySchemeData_p11_10 PaySchemeData_p21_10 PaymentAmount_p11_6 PaymentRequest_p11_9 WhatDeliver_p12_1 p10_2 a6 a7 p3_9 a9 a10 a12 p7_3) 4))

(assert (not (not (or (and (or (and (>= PaymentHandlerPayment_p5_0 1)(>= PaymentRequest_p11_9 1))(and (>= BrandSelection_p11_5 1)(>= p4_3 1)))(and (and (>= PaymentHandlerPayment_p5_0 1)(>= PaymentRequest_p11_9 1))(>= p7_1 1)))(and (and (>= Status_p20_6 1)(>= p1_3 1)(>= Organization_p20_7 1)(>= Order_p20_8 1)(>= Payment_p20_9 1)(>= Delivery_p20_10 1))(and (and (>= PayReceipt_p21_12 1)(>= PaymentNote_p21_13 1)(>= Status_p21_11 1)(>= p5_3 1)(>= p11_13 1))(>= ConsumerOffer_p1 1)))))))
