...
(assert (and (or (not (and (>= p7_1 1)(and (>= PaymentHandlerPayment_p5_0 1)(>= PaymentRequest_p11_9 1))))(and (>= p2_1 1)(not (>= ConsumerOffer_p1 1))))(and (and (not (and (>= Status_p21_5 1)(>= PaySchemeData_p21_6 1)(>= p3_7 1)(>= Organization_p21_4 1)(>= Payment_p21_3 1)(>= p11_8 1)))(and (>= p3_3 1)(>= p4_4 1)))(not (or (and (>= MerchantPayment_p4_0 1)(>= PaidFor_p11_1 1))(and (>= DeliveryResponse_p12_6 1)(>= p6_5 1)))))))
