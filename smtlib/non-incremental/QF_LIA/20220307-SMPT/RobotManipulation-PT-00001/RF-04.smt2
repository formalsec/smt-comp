...
(assert (not (not (and (and (and (>= p_i1 1)(and (>= initialize 1)(>= r_stopped 1)))(and (>= p_sc 1)(and (>= initialize 1)(>= r_stopped 1))))(and (not (and (>= initialized 1)(>= p_i2 1)))(not (>= r_moving 1)))))))
