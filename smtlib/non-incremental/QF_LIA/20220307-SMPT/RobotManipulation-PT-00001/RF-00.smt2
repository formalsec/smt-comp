...
(assert (not (and (not (not (and (>= off 1)(>= r_active 1))))(or (and (not (and (>= access 1)(>= p_rdy 1)))(or (and (>= initialize 1)(>= r_stopped 1))(and (>= off 1)(>= r_active 1))))(and (and (>= moved 1)(>= p_m 1))(and (and (>= moved 1)(>= p_m 1))(>= p_rel 1)))))))
