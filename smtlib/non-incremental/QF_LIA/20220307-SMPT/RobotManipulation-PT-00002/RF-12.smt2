...
Generator: SMPT
Application: Reachability query on the instance RobotManipulation-PT-00002 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (and (or (or (not (>= p_rel 1))(and (and (>= moved 1)(>= p_m 1))(and (>= initialized 1)(>= p_i2 1))))(>= p_rel 1))(and (and (or (>= p_sc 1)(>= p_sc 1))(and (and (>= access 1)(>= p_rdy 1))(>= p_i1 1)))(and (>= moved 1)(>= p_m 1))))))
