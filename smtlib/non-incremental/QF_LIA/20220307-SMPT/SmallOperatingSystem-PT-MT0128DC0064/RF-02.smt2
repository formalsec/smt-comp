...
(assert (and (and (or (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(>= LoadingMem 1))(and (and (>= ExecutingTask 1)(>= TransferToDisk 1))(not (>= ExecutingTask 1))))(>= ExecutingTask 1)))
