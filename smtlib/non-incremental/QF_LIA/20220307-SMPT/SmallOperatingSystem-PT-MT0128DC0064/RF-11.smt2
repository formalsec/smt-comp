...
(assert (not (or (not (or (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= TransferToDisk 1))(or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskReady 1)))))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))
