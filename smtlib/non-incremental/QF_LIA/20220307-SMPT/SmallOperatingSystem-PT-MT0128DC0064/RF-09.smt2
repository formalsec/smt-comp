...
(assert (not (or (or (and (>= CPUUnit 1)(>= TaskReady 1))(or (not (and (>= CPUUnit 1)(>= TaskReady 1)))(or (>= TransferToDisk 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))(or (not (and (>= ExecutingTask 1)(and (>= CPUUnit 1)(>= TaskReady 1))))(or (and (>= CPUUnit 1)(>= TaskSuspended 1))(or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskReady 1))))))))
