...
(assert (not (and (or (or (and (and (>= CPUUnit 1)(>= TaskReady 1))(>= TaskReady 1))(not (and (>= CPUUnit 1)(>= TaskReady 1))))(and (not (>= ExecutingTask 1))(and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= LoadingMem 1))))(or (and (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(not (and (>= CPUUnit 1)(>= TaskReady 1))))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))))
