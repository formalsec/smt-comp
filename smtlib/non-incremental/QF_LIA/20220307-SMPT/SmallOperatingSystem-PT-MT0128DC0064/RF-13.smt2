...
(assert (not (or (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(or (and (>= TaskReady 1)(and (>= CPUUnit 1)(>= TaskReady 1)))(>= LoadingMem 1)))(or (or (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= TransferToDisk 1))(or (>= ExecutingTask 1)(and (>= CPUUnit 1)(>= TaskSuspended 1))))(or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))))))
