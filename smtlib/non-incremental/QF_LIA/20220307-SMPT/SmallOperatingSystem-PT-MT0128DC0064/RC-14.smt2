...
(assert (not (or (or (or (<= 3 TransferToDisk)(<= 1 ExecutingTask))(and (<= 1 CPUUnit)(<= 2 TaskOnDisk)))(and (and (<= 1 DiskControllerUnit)(<= 2 CPUUnit))(not (<= TransferToDisk TaskSuspended))))))
