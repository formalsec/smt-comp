...
(assert (not (or (not (and (not (>= TaskReady 1))(not (>= LoadingMem 1))))(or (not (>= TaskReady 1))(or (not (>= TaskReady 1))(or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= TransferToDisk 1)))))))
