...
(assert (and (not (not (not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))))(and (not (not (and (>= CPUUnit 1)(>= TaskSuspended 1))))(or (not (and (>= CPUUnit 1)(>= TaskReady 1)))(or (>= LoadingMem 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))))))
