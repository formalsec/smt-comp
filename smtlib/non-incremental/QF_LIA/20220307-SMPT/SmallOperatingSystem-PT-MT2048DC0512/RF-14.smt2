...
(assert (and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (not (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskReady 1))))(and (or (>= TaskReady 1)(>= LoadingMem 1))(or (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskSuspended 1)))))))
