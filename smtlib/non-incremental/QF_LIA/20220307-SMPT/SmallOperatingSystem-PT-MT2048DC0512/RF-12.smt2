...
(assert (and (and (and (not (>= ExecutingTask 1))(and (>= ExecutingTask 1)(and (>= CPUUnit 1)(>= TaskSuspended 1))))(or (and (>= ExecutingTask 1)(>= TransferToDisk 1))(not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))(and (or (>= LoadingMem 1)(>= LoadingMem 1))(and (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= ExecutingTask 1))(not (and (>= CPUUnit 1)(>= TaskReady 1)))))))
