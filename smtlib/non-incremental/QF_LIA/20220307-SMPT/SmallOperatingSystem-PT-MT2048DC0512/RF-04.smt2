...
Generator: SMPT
Application: Reachability query on the instance SmallOperatingSystem-PT-MT2048DC0512 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= TaskOnDisk (+ DiskControllerUnit 1536)))
...
(assert (= (+ a4 LoadingMem) 512))
(assert (= (+ FreeMemSegment LoadingMem a5) 2048))

(assert (not (or (and (and (and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskReady 1)))(and (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))
