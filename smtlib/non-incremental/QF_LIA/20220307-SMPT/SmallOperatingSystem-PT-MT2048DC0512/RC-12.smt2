...
(assert (not (and (or (not (<= CPUUnit TransferToDisk))(and (<= TaskSuspended TaskSuspended)(<= DiskControllerUnit CPUUnit)))(or (or (<= 1 TaskSuspended)(<= TransferToDisk TransferToDisk))(and (<= 2 FreeMemSegment)(<= CPUUnit TaskSuspended))))))
