...
(assert (and (and (and (>= LoadingMem 1)(or (>= TaskReady 1)(>= ExecutingTask 1)))(or (>= TransferToDisk 1)(and (>= CPUUnit 1)(>= TaskReady 1))))(not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))
