...
(assert (not (or (not (or (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= TransferToDisk 1))(or (>= TransferToDisk 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))(or (or (and (>= ExecutingTask 1)(and (>= CPUUnit 1)(>= TaskReady 1)))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(or (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= LoadingMem 1))(or (>= TransferToDisk 1)(>= TaskReady 1)))))))
