...
(assert (and (or (<= DiskControllerUnit TaskReady)(and (<= TaskOnDisk DiskControllerUnit)(<= 2 CPUUnit)))(or (not (<= 1 TaskOnDisk))(and (<= TaskOnDisk TaskOnDisk)(<= TaskOnDisk FreeMemSegment)))))
