...
(assert (not (or (not (or (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= ExecutingTask 1))(and (>= CPUUnit 1)(>= TaskReady 1))))(or (or (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= ExecutingTask 1))(or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskReady 1))))(or (>= TransferToDisk 1)(not (and (>= CPUUnit 1)(>= TaskSuspended 1))))))))
