...
(assert (not (or (not (and (and (>= ExecutingTask 1)(>= TransferToDisk 1))(or (>= TaskReady 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))(or (and (>= CPUUnit 1)(>= TaskReady 1))(or (not (and (>= CPUUnit 1)(>= TaskReady 1)))(>= TaskReady 1))))))
