...
(assert (and (or (or (<= TaskOnDisk TaskReady)(<= 3 TaskReady))(<= 3 LoadingMem))(and (and (<= CPUUnit TaskSuspended)(<= 2 TaskOnDisk))(or (<= DiskControllerUnit DiskControllerUnit)(<= 3 TaskSuspended)))))
