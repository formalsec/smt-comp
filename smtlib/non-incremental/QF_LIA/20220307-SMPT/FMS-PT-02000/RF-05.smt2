...
Generator: SMPT
Application: Reachability query on the instance FMS-PT-02000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= a7 (+ P2wP1 a6)))
(assert (= a8 (+ P3M2 P3)))
(assert (= (+ a2 P12M3 P12s a5 P2M2 a7) 2000))
(assert (= (+ M3 P12M3) 2))
(assert (= (+ M2 P2M2) 1))
(assert (= (+ a1 a2 P12M3 P12s P1M1 a4) 2000))
(assert (= (+ M1 P1M1) 3))
(assert (= (+ a8 P3s) 2000))

(assert (or (not (and (or (>= P2 1)(>= P12M3 1))(or (>= P1 1)(>= P2s 1))))(and (and (or (>= P2d 1)(>= P2M2 1))(and (>= P2d 1)(>= P12s 1)))(or (and (>= P3 1)(and (>= P3M2 1)(>= M2 1)))(and (>= P12s 1)(and (>= P3M2 1)(>= M2 1)))))))
