...
Generator: SMPT
Application: Reachability query on the instance RobotManipulation-PT-00010 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (or (and (>= access 1)(>= p_rdy 1))(or (and (>= initialize 1)(>= r_stopped 1))(>= p_rdy 1)))(and (and (>= move 1)(>= r_active 1))(and (>= move 1)(>= r_active 1))))(not (and (or (>= p_rel 1)(>= p_i1 1))(>= p_i1 1)))))
