...
(assert (not (not (and (or (not (>= p37 1))(not (and (>= p19 1)(>= p69 1))))(and (not (and (>= p22 1)(>= p52 1)(>= p53 1)(>= p54 1)(>= p55 1)(>= p56 1)(>= p57 1)(>= p58 1)(>= p59 1)(>= p60 1)(>= p61 1)(>= p62 1)(>= p63 1)(>= p64 1)(>= p65 1)(>= p66 1)(>= p67 1)(>= p68 1)(>= p69 1)(>= p70 1)(>= p71 1)))(and (>= p76 1)(>= p77 1)))))))
