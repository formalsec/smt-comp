...
(assert (not (or (or (and (>= p34 1)(>= p33 1))(not (and (>= p16 1)(>= p66 1))))(not (and (and (>= p23 1)(>= p52 1)(>= p53 1)(>= p54 1)(>= p55 1)(>= p56 1)(>= p57 1)(>= p58 1)(>= p59 1)(>= p60 1)(>= p61 1)(>= p62 1)(>= p63 1)(>= p64 1)(>= p65 1)(>= p66 1)(>= p67 1)(>= p68 1)(>= p69 1)(>= p70 1)(>= p71 1))(>= p76 1))))))
