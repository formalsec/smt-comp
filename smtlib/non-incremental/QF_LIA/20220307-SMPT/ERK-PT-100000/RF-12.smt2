...
(assert (not (and (and (>= ERK 1)(>= MEKPP 1))(or (or (and (and (>= RKIPP 1)(>= RP 1))(>= MEKPP_ERK 1))(and (>= RKIP 1)(>= Raf1Star 1)))(or (and (>= Raf1Star_RKIP 1)(>= MEKPP_ERK 1))(or (>= Raf1Star_RKIP 1)(>= Raf1Star_RKIP_ERKPP 1)))))))
