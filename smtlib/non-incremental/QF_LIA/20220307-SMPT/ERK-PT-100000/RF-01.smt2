...
(assert (not (or (not (not (or (>= MEKPP_ERK 1)(and (>= ERK 1)(>= MEKPP 1)))))(and (not (or (>= MEKPP_ERK 1)(and (>= ERK 1)(>= MEKPP 1))))(or (and (and (>= ERK 1)(>= MEKPP 1))(>= Raf1Star_RKIP_ERKPP 1))(and (>= Raf1Star_RKIP_ERKPP 1)(>= Raf1Star_RKIP 1)))))))
