...
(assert (and (and (and (and (and (>= RKIP 1)(>= Raf1Star 1))(and (>= RKIPP 1)(>= RP 1)))(or (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(>= Raf1Star_RKIP_ERKPP 1)))(not (and (>= RKIPP_RP 1)(>= MEKPP_ERK 1))))(and (and (and (>= MEKPP_ERK 1)(>= RKIPP_RP 1))(>= Raf1Star_RKIP_ERKPP 1))(and (>= MEKPP_ERK 1)(>= Raf1Star_RKIP 1)))))
