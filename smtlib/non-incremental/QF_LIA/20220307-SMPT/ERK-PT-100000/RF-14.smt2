...
(assert (not (or (and (not (or (>= MEKPP_ERK 1)(>= MEKPP_ERK 1)))(and (and (>= RKIPP_RP 1)(and (>= RKIP 1)(>= Raf1Star 1)))(or (>= Raf1Star_RKIP_ERKPP 1)(>= Raf1Star_RKIP_ERKPP 1))))(or (not (or (and (>= ERK 1)(>= MEKPP 1))(and (>= ERKPP 1)(>= Raf1Star_RKIP 1))))(or (or (and (>= RKIP 1)(>= Raf1Star 1))(>= RKIPP_RP 1))(and (>= MEKPP_ERK 1)(and (>= ERKPP 1)(>= Raf1Star_RKIP 1))))))))
