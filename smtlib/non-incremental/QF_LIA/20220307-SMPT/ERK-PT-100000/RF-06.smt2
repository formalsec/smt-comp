...
(assert (not (or (and (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(and (or (and (>= RKIPP 1)(>= RP 1))(and (>= ERK 1)(>= MEKPP 1)))(or (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(and (>= RKIP 1)(>= Raf1Star 1)))))(or (and (>= RKIP 1)(>= Raf1Star 1))(>= MEKPP_ERK 1)))))
