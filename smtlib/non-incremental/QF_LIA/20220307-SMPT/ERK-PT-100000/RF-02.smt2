...
(assert (and (and (not (and (>= RKIPP_RP 1)(>= Raf1Star_RKIP 1)))(or (and (and (>= ERK 1)(>= MEKPP 1))(>= MEKPP_ERK 1))(or (>= MEKPP_ERK 1)(>= MEKPP_ERK 1))))(and (not (not (>= RKIPP_RP 1)))(and (>= Raf1Star_RKIP 1)(and (>= RKIPP 1)(>= RP 1))))))
