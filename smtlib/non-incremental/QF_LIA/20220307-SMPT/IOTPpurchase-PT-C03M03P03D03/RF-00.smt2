...
(assert (not (or (or (not (and (>= BrandList_p11_2 1)(>= p3_2 1)))(>= p2_1 1))(not (or (or (and (>= DeliveryResponse_p12_6 1)(>= p6_5 1))(and (>= DeliveryNote_p22_14 1)(>= p6_6 1)(>= Status_p22_13 1)))(and (and (>= p11_0 1)(>= p3_1 1))(and (>= p8_1 1)(>= Delivery_p22_8 1)(>= Organization_p22_9 1)(>= Order_p22_10 1)(>= Status_p22_11 1))))))))
