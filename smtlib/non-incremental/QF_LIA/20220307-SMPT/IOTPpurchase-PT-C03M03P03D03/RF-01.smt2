...
(assert (and (and (not (or (and (>= MerchantDelivery_p4_6 1)(>= WhatDeliver_p12_1 1))(and (>= p12_0 1)(>= p6_1 1))))(and (>= p8_1 1)(>= Delivery_p22_8 1)(>= Organization_p22_9 1)(>= Order_p22_10 1)(>= Status_p22_11 1)))(and (and (or (>= ConsumerPayment_p3 1)(and (>= Status_p20_6 1)(>= p1_3 1)(>= Organization_p20_7 1)(>= Order_p20_8 1)(>= Payment_p20_9 1)(>= Delivery_p20_10 1)))(and (and (>= PaymentHandlerPayment_p5_0 1)(>= PaymentRequest_p11_9 1))(>= ConsumerPayment_p3 1)))(or (not (>= p3_3 1))(not (>= ConsumerDelivery_p6_0 1))))))
