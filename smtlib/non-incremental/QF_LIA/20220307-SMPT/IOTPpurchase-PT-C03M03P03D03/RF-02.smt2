...
(assert (and (and (not (not (and (>= MerchantDelivery_p4_6 1)(>= WhatDeliver_p12_1 1))))(not (or (>= p4_1 1)(and (>= DeliveryHandlerDelivery_p8_0 1)(>= DeliveryRequest_p12_5 1)))))(and (>= PaySchemeData_p11_10 1)(>= p3_8 1))))
