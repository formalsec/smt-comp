...
(assert (or (not (not (and (and (>= PayReceipt_p21_12 1)(>= PaymentNote_p21_13 1)(>= Status_p21_11 1)(>= p5_3 1)(>= p11_13 1))(>= p6_7 1))))(not (not (and (and (>= MerchantOffer_p2 1)(>= OfferRequest_p10 1))(>= p8_3 1))))))
