...
(assert (not (or (or (or (and (>= p11_4 1)(>= p3_4 1))(not (>= p3_3 1)))(not (and (>= MerchantDelivery_p4_6 1)(>= WhatDeliver_p12_1 1))))(and (or (and (>= ConsumerDelivery_p6_0 1)(and (>= p3_9 1)(>= PaymentResponse_p11_12 1)))(or (and (>= MerchantDelivery_p4_6 1)(>= WhatDeliver_p12_1 1))(>= ConsumerDelivery_p6_0 1)))(or (and (>= BrandList_p11_2 1)(>= p3_2 1))(>= p6_7 1))))))
