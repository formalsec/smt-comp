...
Generator: SMPT
Application: Reachability query on the instance IOTPpurchase-PT-C03M03P03D03 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= (+ PaySchemeData_p11_10 PaySchemeData_p21_10 PaymentHandlerPayment_p5_0 p11_13 p3_9 p5_4) 4))
(assert (= (+ OfferRequest_p10 p10_0) 1))
(assert (= (+ OfferResponce_p10 p10_2) 1))
(assert (= (+ PayReceipt_p21_12 PaySchemeData_p21_10 PaymentHandlerPayment_p5_0 p5_4) 3))
...
(assert (= (+ BrandList_p11_2 BrandSelection_p11_5 a2 a4 DeliveryRequest_p12_5 DeliveryResponse_p12_6 a13 Delivery_p22_4 a15 HowDeliver_p12_2 OfferRequest_p10 Organization_p21_4 PaidFor_p11_1 PayReceipt_p21_12 a14 PaySchemeData_p21_10 PaymentAmount_p11_6 PaymentRequest_p11_9 PaymentResponse_p11_12 WhatDeliver_p12_1 p10_2 a6 a7 a9 a10 a12) 3))
(assert (= (+ DeliveryHandlerDelivery_p8_0 a15 p8_3) 3))
(assert (= (+ BrandList_p11_2 BrandSelection_p11_5 a13 MerchantOffer_p2 Organization_p21_4 PaidFor_p11_1 PayReceipt_p21_12 a14 PaySchemeData_p21_10 PaymentAmount_p11_6 PaymentRequest_p11_9 PaymentResponse_p11_12 WhatDeliver_p12_1 p10_2 a6 a7 a9 a10 a12 p7_3) 3))
(assert (= (+ BrandList_p11_2 BrandSelection_p11_5 a13 MerchantOffer_p2 Organization_p21_4 PaidFor_p11_1 a14 PaySchemeData_p11_10 PaySchemeData_p21_10 PaymentAmount_p11_6 PaymentRequest_p11_9 WhatDeliver_p12_1 p10_2 a6 a7 p3_9 a9 a10 a12 p7_3) 3))

(assert (and (and (and (or (and (>= p3_9 1)(>= PaymentResponse_p11_12 1))(and (>= DeliveryHandlerDelivery_p8_0 1)(>= DeliveryRequest_p12_5 1)))(and (and (>= PaySchemeData_p21_10 1)(>= p11_11 1)(>= p5_2 1))(and (>= Status_p22_7 1)(>= p6_4 1)(>= Delivery_p22_4 1)(>= p12_4 1)(>= Organization_p22_5 1)(>= Order_p22_6 1))))(and (not (and (>= Status_p21_5 1)(>= PaySchemeData_p21_6 1)(>= p3_7 1)(>= Organization_p21_4 1)(>= Payment_p21_3 1)(>= p11_8 1)))(not (and (>= DeliveryHandlerDelivery_p8_0 1)(>= DeliveryRequest_p12_5 1)))))(not (and (not (and (>= p8_1 1)(>= Delivery_p22_8 1)(>= Organization_p22_9 1)(>= Order_p22_10 1)(>= Status_p22_11 1)))(and (and (>= DeliveryResponse_p12_6 1)(>= p6_5 1))(>= p3_3 1))))))
