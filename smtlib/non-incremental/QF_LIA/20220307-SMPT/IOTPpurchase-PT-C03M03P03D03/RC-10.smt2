...
(assert (and (and (and (<= 2 Payment_p20)(<= p1_3 PaymentAmount_p11_6))(and (<= p4_1 ConsumerDelivery_p6_0)(<= 2 PayReceipt_p21_12)))(or (not (<= 2 p3_4))(and (<= 1 DeliveryRequest_p12_5)(<= p8_1 p6_2)))))
