...
(assert (and (not (and (not (and (>= Organization_p21_2 1)(>= p4_5 1)(>= Payment_p21_1 1)(>= p11_7 1)))(not (and (>= p12_0 1)(>= p6_1 1)))))(and (and (and (and (>= MerchantDelivery_p4_6 1)(>= WhatDeliver_p12_1 1))(and (>= MerchantDelivery_p4_6 1)(>= WhatDeliver_p12_1 1)))(or (and (>= p3_5 1)(>= PaymentAmount_p11_6 1))(>= ConsumerOffer_p1 1)))(or (not (and (>= DeliveryHandlerDelivery_p8_0 1)(>= DeliveryRequest_p12_5 1)))(not (and (>= p12_0 1)(>= p6_1 1)))))))
