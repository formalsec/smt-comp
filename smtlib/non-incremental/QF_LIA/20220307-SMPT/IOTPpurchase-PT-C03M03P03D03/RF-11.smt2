...
(assert (and (or (not (and (>= p12_0 1)(>= p6_1 1)))(not (and (>= p11_3 1)(>= p4_2 1))))(and (or (and (and (>= p6_2 1)(>= HowDeliver_p12_2 1))(and (>= Status_p20_6 1)(>= p1_3 1)(>= Organization_p20_7 1)(>= Order_p20_8 1)(>= Payment_p20_9 1)(>= Delivery_p20_10 1)))(not (and (>= p10_0 1)(>= p1_1 1))))(and (not (and (>= Organization_p22_2 1)(>= Order_p22_3 1)(>= Delivery_p22_1 1)(>= p7_2 1)(>= p12_3 1)))(>= p8_3 1)))))
