...
(assert (and (and (and (and (and (>= p11_0 1)(>= p3_1 1))(and (>= PayReceipt_p21_12 1)(>= PaymentNote_p21_13 1)(>= Status_p21_11 1)(>= p5_3 1)(>= p11_13 1)))(or (and (>= Status_p21_5 1)(>= PaySchemeData_p21_6 1)(>= p3_7 1)(>= Organization_p21_4 1)(>= Payment_p21_3 1)(>= p11_8 1))(and (>= Organization_p21_2 1)(>= p4_5 1)(>= Payment_p21_1 1)(>= p11_7 1))))(and (not (>= p4_1 1))(or (>= p3_6 1)(and (>= p12_0 1)(>= p6_1 1)))))(and (and (>= Status_p22_11 1)(>= p8_2 1)(>= DeliveryNote_p22_12 1)(>= p12_7 1))(or (and (>= PaymentHandlerPayment_p5_0 1)(>= PaymentRequest_p11_9 1))(not (and (>= BrandList_p11_2 1)(>= p3_2 1)))))))
