...
(assert (and (and (or (<= 1 BrandList_p11_2)(<= 3 ConsumerDelivery_p6_0))(or (<= 2 Status_p22_11)(<= Status_p21_11 Status_p20_6)))(not (or (<= Payment_p21_1 p3_8)(<= p6_6 PaymentAmount_p11_6)))))
