...
(assert (not (or (or (not (or (and (>= p11_4 1)(>= p3_4 1))(and (>= PayReceipt_p21_12 1)(>= PaymentNote_p21_13 1)(>= Status_p21_11 1)(>= p5_3 1)(>= p11_13 1))))(not (and (>= p4_1 1)(and (>= Organization_p21_2 1)(>= p4_5 1)(>= Payment_p21_1 1)(>= p11_7 1)))))(and (or (or (and (>= p11_3 1)(>= p4_2 1))(>= ConsumerOffer_p1 1))(and (and (>= p11_3 1)(>= p4_2 1))(and (>= p6_2 1)(>= HowDeliver_p12_2 1))))(>= p5_4 1)))))
