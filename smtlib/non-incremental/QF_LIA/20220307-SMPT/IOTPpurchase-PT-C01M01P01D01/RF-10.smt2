...
(assert (not (and (and (or (and (and (>= BrandSelection_p11_5 1)(>= p4_3 1))(>= ConsumerPayment_p3 1))(not (and (>= BrandList_p11_2 1)(>= p3_2 1))))(and (>= p6_3 1)(and (and (>= p3_5 1)(>= PaymentAmount_p11_6 1))(and (>= BrandList_p11_2 1)(>= p3_2 1)))))(and (>= PaySchemeData_p21_10 1)(>= p11_11 1)(>= p5_2 1)))))
