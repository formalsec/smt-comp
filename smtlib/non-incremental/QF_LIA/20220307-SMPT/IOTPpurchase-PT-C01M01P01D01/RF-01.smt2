...
(assert (and (or (and (or (>= p6_7 1)(and (>= Payment_p20 1)(>= Delivery_p20 1)(>= Order_p20 1)(>= Organization_p20_2 1)(>= Status_p20 1)(>= p2_2 1)(>= OfferResponce_p10 1)))(and (>= Payment_p20 1)(>= Delivery_p20 1)(>= Order_p20 1)(>= Organization_p20_2 1)(>= Status_p20 1)(>= p2_2 1)(>= OfferResponce_p10 1)))(and (>= p12_0 1)(>= p6_1 1)))(and (and (not (and (>= p6_2 1)(>= HowDeliver_p12_2 1)))(and (and (>= DeliveryHandlerDelivery_p8_0 1)(>= DeliveryRequest_p12_5 1))(>= p7_3 1)))(not (not (>= p3_3 1))))))
