...
(assert (not (or (>= p3_6 1)(or (or (not (and (>= PayReceipt_p21_12 1)(>= PaymentNote_p21_13 1)(>= Status_p21_11 1)(>= p5_3 1)(>= p11_13 1)))(or (and (>= p3_5 1)(>= PaymentAmount_p11_6 1))(>= ConsumerOffer_p1 1)))(or (>= p7_1 1)(not (and (>= Status_p22_11 1)(>= p8_2 1)(>= DeliveryNote_p22_12 1)(>= p12_7 1))))))))
