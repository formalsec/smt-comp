...
(assert (and (and (>= p11_0 1)(>= p3_1 1))(not (and (and (>= p5_4 1)(and (>= PayReceipt_p21_12 1)(>= PaymentNote_p21_13 1)(>= Status_p21_11 1)(>= p5_3 1)(>= p11_13 1)))(or (and (>= PayReceipt_p21_15 1)(>= Status_p21_14 1)(>= PaymentNote_p21_16 1)(>= p3_10 1))(>= p4_1 1))))))
