...
(assert (and (and (and (>= Organization_p21_2 1)(>= p4_5 1)(>= Payment_p21_1 1)(>= p11_7 1))(or (and (and (>= DeliveryNote_p22_14 1)(>= p6_6 1)(>= Status_p22_13 1))(>= p7_3 1))(and (>= p2_1 1)(>= p7_1 1))))(>= p3_3 1)))
