...
(assert (not (and (or (or (<= 3 PaySchemeData_p21_10)(<= 2 PaymentRequest_p11_9))(and (<= Organization_p20_7 p5_2)(<= p11_11 p5_2)))(and (or (<= 1 Status_p22_13)(<= p3_6 p8_3))(and (<= Order_p20 MerchantPayment_p4_0)(<= 3 MerchantDelivery_p4_6))))))
