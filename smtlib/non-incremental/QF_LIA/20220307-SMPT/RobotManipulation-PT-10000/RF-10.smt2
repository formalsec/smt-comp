...
Generator: SMPT
Application: Reachability query on the instance RobotManipulation-PT-10000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (or (or (>= p_i1 1)(and (>= off 1)(>= r_active 1)))(or (and (>= access 1)(>= p_rdy 1))(>= p_rel 1)))(and (>= initialized 1)(>= p_i2 1)))(and (>= r_moving 1)(and (>= p_sc 1)(and (>= moved 1)(>= p_m 1))))))
