...
(assert (not (or (or (or (or (and (>= Queue_1 1)(>= Ext_Bus 1)(>= Memory_5 1))(and (>= Memory_2 1)(>= Queue_1 1)(>= Ext_Bus 1)))(>= Ext_Mem_Acc_4_3 1))(and (>= OwnMemAcc_4 1)(>= Memory_4 1)))(or (not (not (and (>= OwnMemAcc_4 1)(>= Memory_4 1))))(or (not (and (>= OwnMemAcc_2 1)(>= Memory_2 1)))(or (>= Ext_Mem_Acc_4_2 1)(>= Ext_Mem_Acc_2_4 1)))))))
