...
(assert (and (and (and (<= (+ Queue_1 Queue_2 Queue_5 Queue_3 Queue_4) (+ OwnMemAcc_1 OwnMemAcc_4 OwnMemAcc_5 OwnMemAcc_2 OwnMemAcc_3))(<= 2 (+ Queue_1 Queue_2 Queue_5 Queue_3 Queue_4)))(not (<= 1 Ext_Bus)))(not (not (<= 3 (+ Memory_2 Memory_1 Memory_4 Memory_3 Memory_5))))))
