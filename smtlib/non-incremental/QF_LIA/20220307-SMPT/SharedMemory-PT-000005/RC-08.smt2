...
(assert (and (or (<= Memory_5 Ext_Mem_Acc_4_5)(and (<= Memory_5 Ext_Mem_Acc_5_1)(<= 3 OwnMemAcc_5)))(and (and (<= Ext_Mem_Acc_3_1 Ext_Mem_Acc_1_2)(<= OwnMemAcc_4 Active_4))(and (<= 3 Queue_4)(<= 2 Memory_2)))))
