...
Generator: SMPT
Application: Reachability query on the instance Kanban-PT-00050 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (not (not (and (>= P1 1)(>= Pout2 1)(>= Pout3 1))))(not (not (>= Pm1 1))))(and (and (not (and (>= P2 1)(>= P3 1)(>= Pout4 1)))(>= Pm1 1))(and (not (>= Pback2 1))(>= Pm2 1)))))
