...
(assert (not (or (or (or (and (and (>= p35 1)(>= p5 1))(and (>= p24 1)(>= p3 1)))(or (and (>= p20 1)(>= p5 1))(and (>= p12 1)(>= p3 1))))(or (or (and (>= p36 1)(>= p2 1))(and (>= p27 1)(>= p3 1)))(and (>= p49 1)(>= p7 1))))(and (and (and (and (>= p39 1)(>= p13 1))(and (>= p36 1)(>= p6 1)))(and (>= p20 1)(>= p10 1)))(not (and (>= p50 1)(>= p10 1)))))))
