...
(assert (and (not (or (or (and (>= p48 1)(>= p16 1))(and (>= p6 1)(>= p3 1)))(and (and (>= p36 1)(>= p4 1))(and (>= p46 1)(>= p2 1)))))(and (or (or (and (>= p46 1)(>= p23 1))(and (>= p48 1)(>= p16 1)))(and (and (>= p20 1)(>= p10 1))(and (>= p34 1)(>= p2 1))))(and (and (and (>= p33 1)(>= p3 1))(and (>= p48 1)(>= p8 1)))(not (and (>= p40 1)(>= p2 1)))))))
