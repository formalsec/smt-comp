...
(assert (not (or (and (and (or (and (>= p46 1)(>= p2 1))(and (>= p16 1)(>= p8 1)))(and (>= p24 1)(>= p8 1)))(or (and (>= p14 1)(>= p7 1))(not (and (>= p50 1)(>= p2 1)))))(or (and (>= p24 1)(>= p2 1))(or (or (and (>= p16 1)(>= p8 1))(and (>= p6 1)(>= p3 1)))(or (and (>= p30 1)(>= p6 1))(and (>= p42 1)(>= p2 1))))))))
