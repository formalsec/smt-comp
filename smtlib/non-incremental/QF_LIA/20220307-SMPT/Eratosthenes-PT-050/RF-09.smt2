...
(assert (not (or (not (and (or (and (>= p36 1)(>= p12 1))(and (>= p24 1)(>= p2 1)))(and (and (>= p18 1)(>= p6 1))(and (>= p25 1)(>= p5 1)))))(or (or (not (and (>= p48 1)(>= p8 1)))(or (and (>= p14 1)(>= p2 1))(and (>= p48 1)(>= p6 1))))(and (and (>= p12 1)(>= p4 1))(and (>= p27 1)(>= p9 1)))))))
