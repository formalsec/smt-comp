...
(assert (or (and (and (or (and (>= p36 1)(>= p3 1))(and (>= p39 1)(>= p13 1)))(not (and (>= p6 1)(>= p2 1))))(and (not (and (>= p14 1)(>= p2 1)))(or (and (>= p36 1)(>= p4 1))(and (>= p18 1)(>= p2 1)))))(not (or (or (and (>= p12 1)(>= p4 1))(and (>= p48 1)(>= p6 1)))(not (and (>= p24 1)(>= p2 1)))))))
