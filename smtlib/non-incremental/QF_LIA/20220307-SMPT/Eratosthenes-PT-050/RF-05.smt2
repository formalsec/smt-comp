...
(assert (not (or (or (or (or (and (>= p4 1)(>= p2 1))(and (>= p21 1)(>= p3 1)))(or (and (>= p18 1)(>= p9 1))(and (>= p27 1)(>= p9 1))))(not (and (>= p38 1)(>= p2 1))))(or (not (and (and (>= p21 1)(>= p7 1))(and (>= p35 1)(>= p5 1))))(and (>= p25 1)(>= p5 1))))))
