...
(assert (not (or (or (and (>= MEKP 1)(>= Phase2 1))(or (or (>= ERK_MEKPP 1)(>= ERK_MEKPP 1))(not (>= ERK_MEKPP 1))))(or (or (and (>= MEKPP_Phase2 1)(>= ERKP_Phase3 1))(and (>= MEK 1)(>= RafP 1)))(or (not (>= MEKP_Phase2 1))(>= ERK_MEKPP 1))))))
