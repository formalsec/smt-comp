...
(assert (and (and (and (and (>= Raf 1)(>= RasGTP 1))(>= MEK_RafP 1))(and (and (>= ERKPP_Phase3 1)(and (>= ERKP 1)(>= MEKPP 1)))(not (>= ERKP_MEKPP 1))))(or (or (or (>= ERKP_MEKPP 1)(>= MEKPP_Phase2 1))(not (and (>= ERKP 1)(>= Phase3 1))))(>= ERKP_MEKPP 1))))
