...
(assert (not (or (and (not (and (>= ERKPP_Phase3 1)(>= MEKP_Phase2 1)))(not (and (and (>= ERK 1)(>= MEKPP 1))(and (>= Phase1 1)(>= RafP 1)))))(or (and (>= MEKPP 1)(>= Phase2 1))(or (not (>= RafP_Phase1 1))(not (>= ERKP_MEKPP 1)))))))
