...
(assert (and (and (not (or (>= Raf_RasGTP 1)(>= Raf_RasGTP 1)))(and (or (and (>= ERK 1)(>= MEKPP 1))(>= ERK_MEKPP 1))(not (and (>= MEKP 1)(>= RafP 1)))))(or (or (or (>= MEKP_Phase2 1)(>= MEKP_Phase2 1))(or (>= ERKP_Phase3 1)(>= ERKP_Phase3 1)))(>= ERKP_MEKPP 1))))
