...
Generator: SMPT
Application: Reachability query on the instance MAPK-PT-00020 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (not (and (and (and (>= MEKP 1)(>= Phase2 1))(>= MEKPP_Phase2 1))(or (>= ERKPP_Phase3 1)(and (>= MEKP 1)(>= RafP 1)))))(and (and (and (and (>= ERKP 1)(>= MEKPP 1))(>= ERK_MEKPP 1))(and (>= RafP_Phase1 1)(>= MEK_RafP 1)))(not (or (>= ERKP_MEKPP 1)(>= RafP_Phase1 1))))))
