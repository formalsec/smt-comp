...
Generator: SMPT
Application: Reachability query on the instance Diffusion2D-PT-D05N250 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (or (<= cAMP__2_4_ cAMP__4_2_)(<= cAMP__1_5_ cAMP__5_3_))(or (<= cAMP__5_1_ cAMP__5_2_)(<= cAMP__1_2_ cAMP__5_3_)))(or (and (<= 1 cAMP__1_4_)(<= cAMP__1_4_ cAMP__3_3_))(<= cAMP__1_5_ cAMP__2_1_)))))
