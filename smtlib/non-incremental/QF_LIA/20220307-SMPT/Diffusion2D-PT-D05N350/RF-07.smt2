...
Generator: SMPT
Application: Reachability query on the instance Diffusion2D-PT-D05N350 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (not (and (or (>= cAMP__4_4_ 1)(>= cAMP__2_3_ 1))(and (>= cAMP__3_2_ 1)(>= cAMP__3_2_ 1))))(and (or (>= cAMP__4_1_ 1)(not (>= cAMP__4_2_ 1)))(and (or (>= cAMP__3_1_ 1)(>= cAMP__2_5_ 1))(and (>= cAMP__1_5_ 1)(>= cAMP__2_2_ 1))))))
