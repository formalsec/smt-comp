...
Generator: SMPT
Application: Reachability query on the instance RobotManipulation-PT-00100 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (and (and (>= p_rdy 1)(not (>= p_rel 1)))(or (not (>= p_sc 1))(not (>= p_sc 1))))(or (and (and (and (>= move 1)(>= r_active 1))(and (>= moved 1)(>= p_m 1)))(and (and (>= initialize 1)(>= r_stopped 1))(>= p_rel 1)))(not (or (and (>= initialized 1)(>= p_i2 1))(>= p_rdy 1))))))
