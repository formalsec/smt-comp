...
(assert (or (and (and (or (and (>= initialized 1)(>= p_i2 1))(>= p_rel 1))(not (>= p_i1 1)))(and (>= off 1)(>= r_active 1)))(not (or (not (and (>= off 1)(>= r_active 1)))(or (and (>= initialize 1)(>= r_stopped 1))(and (>= off 1)(>= r_active 1)))))))
