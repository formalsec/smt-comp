...
(assert (and (and (and (>= initialized 1)(>= p_i2 1))(not (or (and (>= access 1)(>= p_rdy 1))(and (>= move 1)(>= r_active 1)))))(not (and (or (>= p_rdy 1)(and (>= initialized 1)(>= p_i2 1)))(or (and (>= moved 1)(>= p_m 1))(and (>= initialized 1)(>= p_i2 1)))))))
