...
(assert (or (not (not (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))(and (not (not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(not (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= LoadingMem 1))))))
