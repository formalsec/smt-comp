...
(assert (not (or (or (or (and (>= LoadingMem 1)(>= ExecutingTask 1))(or (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(and (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= TaskReady 1)(>= TaskReady 1))))(not (and (>= CPUUnit 1)(>= TaskSuspended 1))))))
