...
(assert (not (or (or (not (<= TransferToDisk TaskReady))(or (<= 1 TransferToDisk)(<= 3 DiskControllerUnit)))(or (and (<= TransferToDisk LoadingMem)(<= DiskControllerUnit CPUUnit))(not (<= TaskReady TransferToDisk))))))
