...
(assert (or (not (or (not (and (>= CPUUnit 1)(>= TaskReady 1)))(or (>= TaskReady 1)(>= LoadingMem 1))))(and (and (>= TransferToDisk 1)(not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(not (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))))
