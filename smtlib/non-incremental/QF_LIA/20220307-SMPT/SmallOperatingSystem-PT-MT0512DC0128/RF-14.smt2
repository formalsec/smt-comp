...
Generator: SMPT
Application: Reachability query on the instance SmallOperatingSystem-PT-MT0512DC0128 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= TaskOnDisk (+ DiskControllerUnit 384)))
...
(assert (= (+ a4 LoadingMem) 128))
(assert (= (+ FreeMemSegment LoadingMem a5) 512))

(assert (and (and (and (or (>= TaskReady 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))(or (and (>= CPUUnit 1)(>= TaskReady 1))(>= TaskReady 1)))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(and (and (not (and (>= CPUUnit 1)(>= TaskSuspended 1)))(and (>= ExecutingTask 1)(and (>= CPUUnit 1)(>= TaskSuspended 1))))(not (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= TaskReady 1))))))
