...
(assert (not (not (and (and (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(or (not (>= TransferToDisk 1))(and (>= CPUUnit 1)(>= TaskSuspended 1)))))))
