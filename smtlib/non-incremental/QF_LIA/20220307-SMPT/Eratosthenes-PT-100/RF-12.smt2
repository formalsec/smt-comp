...
(assert (not (or (and (or (and (and (>= p84 1)(>= p12 1))(and (>= p63 1)(>= p21 1)))(and (and (>= p48 1)(>= p4 1))(and (>= p87 1)(>= p29 1))))(or (and (>= p100 1)(>= p20 1))(and (and (>= p20 1)(>= p4 1))(and (>= p74 1)(>= p37 1)))))(or (or (not (and (>= p68 1)(>= p4 1)))(and (and (>= p14 1)(>= p7 1))(and (>= p80 1)(>= p2 1))))(not (not (and (>= p88 1)(>= p22 1))))))))
