...
(assert (and (and (and (not (and (>= p20 1)(>= p5 1)))(not (and (>= p10 1)(>= p5 1))))(not (and (and (>= p18 1)(>= p6 1))(and (>= p36 1)(>= p12 1)))))(and (or (and (and (>= p98 1)(>= p7 1))(and (>= p36 1)(>= p6 1)))(and (and (>= p66 1)(>= p2 1))(and (>= p54 1)(>= p3 1))))(and (>= p48 1)(>= p6 1)))))
