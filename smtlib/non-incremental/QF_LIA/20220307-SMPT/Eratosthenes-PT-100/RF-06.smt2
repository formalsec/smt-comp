...
(assert (not (or (or (or (or (and (>= p66 1)(>= p22 1))(and (>= p33 1)(>= p3 1)))(not (and (>= p80 1)(>= p8 1))))(and (not (and (>= p85 1)(>= p5 1)))(and (>= p28 1)(>= p2 1))))(not (and (not (and (>= p84 1)(>= p7 1)))(and (and (>= p84 1)(>= p28 1))(and (>= p42 1)(>= p7 1))))))))
