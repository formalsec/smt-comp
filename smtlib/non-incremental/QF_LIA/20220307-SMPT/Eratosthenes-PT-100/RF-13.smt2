...
(assert (and (or (not (or (and (>= p12 1)(>= p6 1))(and (>= p27 1)(>= p3 1))))(or (and (and (>= p16 1)(>= p2 1))(and (>= p60 1)(>= p5 1)))(not (and (>= p22 1)(>= p11 1)))))(and (and (not (and (>= p76 1)(>= p38 1)))(not (and (>= p30 1)(>= p3 1))))(not (and (>= p48 1)(>= p3 1))))))
