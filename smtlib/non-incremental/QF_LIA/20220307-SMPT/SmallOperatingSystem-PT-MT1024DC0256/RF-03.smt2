...
(assert (and (or (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(not (not (>= ExecutingTask 1))))(and (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (>= CPUUnit 1)(>= TaskSuspended 1)))))
