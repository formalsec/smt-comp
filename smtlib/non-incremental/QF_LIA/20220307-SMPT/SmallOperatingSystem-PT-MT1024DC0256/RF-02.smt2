...
(assert (not (or (or (and (>= TransferToDisk 1)(or (>= LoadingMem 1)(>= TaskReady 1)))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (>= TaskReady 1)(and (>= CPUUnit 1)(>= TaskSuspended 1))))))
