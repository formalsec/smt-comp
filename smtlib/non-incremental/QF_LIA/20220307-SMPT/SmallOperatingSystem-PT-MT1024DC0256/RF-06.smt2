...
(assert (not (or (or (>= ExecutingTask 1)(not (>= LoadingMem 1)))(or (and (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= TaskReady 1))(or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskReady 1))))(or (not (>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskReady 1)))))))
