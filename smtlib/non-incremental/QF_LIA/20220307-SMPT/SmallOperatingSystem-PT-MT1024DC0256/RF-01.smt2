...
(assert (and (not (or (>= TaskReady 1)(>= TransferToDisk 1)))(and (or (>= TransferToDisk 1)(and (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(and (and (>= TaskReady 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))(not (>= TaskReady 1))))))
