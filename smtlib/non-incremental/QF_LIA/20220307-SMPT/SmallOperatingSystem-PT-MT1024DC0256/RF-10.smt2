...
(assert (not (or (and (or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskReady 1)))(and (>= CPUUnit 1)(>= TaskReady 1)))(not (and (>= TaskReady 1)(>= LoadingMem 1))))))
