...
(assert (not (or (not (>= ExecutingTask 1))(or (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (>= CPUUnit 1)(>= TaskReady 1)))(and (>= CPUUnit 1)(>= TaskSuspended 1))))))
