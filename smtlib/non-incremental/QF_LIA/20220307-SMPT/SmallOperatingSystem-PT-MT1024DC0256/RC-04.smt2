...
(assert (or (or (<= DiskControllerUnit ExecutingTask)(and (<= 3 TaskReady)(<= CPUUnit ExecutingTask)))(and (and (<= TransferToDisk TransferToDisk)(<= FreeMemSegment LoadingMem))(not (<= 2 DiskControllerUnit)))))
