...
(assert (and (not (or (or (and (>= Raf 1)(>= RasGTP 1))(>= ERK_MEKPP 1))(>= ERK_MEKPP 1)))(or (or (and (>= MEKPP_Phase2 1)(>= ERKP_MEKPP 1))(or (and (>= ERKP 1)(>= Phase3 1))(and (>= MEKP 1)(>= Phase2 1))))(>= MEKPP_Phase2 1))))
