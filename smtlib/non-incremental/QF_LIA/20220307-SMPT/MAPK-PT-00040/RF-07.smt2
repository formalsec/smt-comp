...
(assert (and (and (or (not (>= MEK_RafP 1))(>= ERKPP_Phase3 1))(and (and (>= ERK_MEKPP 1)(>= MEK_RafP 1))(and (and (>= MEKP 1)(>= RafP 1))(>= ERKPP_Phase3 1))))(and (>= MEKP_RafP 1)(not (not (and (>= Phase1 1)(>= RafP 1)))))))
