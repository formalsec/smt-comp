...
(assert (not (or (not (and (and (>= ERKPP_Phase3 1)(and (>= ERKP 1)(>= Phase3 1)))(and (and (>= MEKP 1)(>= Phase2 1))(>= Raf_RasGTP 1))))(and (not (and (>= Phase1 1)(>= RafP 1)))(or (or (>= Raf_RasGTP 1)(>= ERKPP_Phase3 1))(or (>= ERK_MEKPP 1)(>= ERKP_MEKPP 1)))))))
