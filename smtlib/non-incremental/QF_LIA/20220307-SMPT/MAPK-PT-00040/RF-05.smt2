...
(assert (and (>= ERKP_MEKPP 1)(and (and (or (and (>= Raf 1)(>= RasGTP 1))(and (>= ERKP 1)(>= Phase3 1)))(and (and (>= MEKP 1)(>= RafP 1))(>= ERKP_Phase3 1)))(or (and (>= MEK_RafP 1)(and (>= ERKP 1)(>= Phase3 1)))(not (and (>= Raf 1)(>= RasGTP 1)))))))
