...
(assert (not (or (or (or (or (and (>= MEK 1)(>= RafP 1))(and (>= ERKP 1)(>= MEKPP 1)))(or (and (>= ERKP 1)(>= MEKPP 1))(>= Raf_RasGTP 1)))(or (or (and (>= Phase1 1)(>= RafP 1))(>= MEKP_RafP 1))(or (>= MEKPP_Phase2 1)(>= MEKP_RafP 1))))(or (and (>= Raf 1)(>= RasGTP 1))(and (>= MEKPP 1)(>= Phase2 1))))))
