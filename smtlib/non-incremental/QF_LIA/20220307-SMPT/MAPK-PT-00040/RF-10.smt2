...
(assert (and (and (not (not (>= ERKP_Phase3 1)))(or (and (>= ERKP_MEKPP 1)(>= MEKP_Phase2 1))(and (and (>= ERKP 1)(>= MEKPP 1))(>= ERK_MEKPP 1))))(or (or (not (>= MEKP_RafP 1))(not (and (>= MEKP 1)(>= Phase2 1))))(and (>= MEK_RafP 1)(>= MEK_RafP 1)))))
