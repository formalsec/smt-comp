...
(assert (and (not (or (or (and (>= Cabins 1)(>= Entered 1))(and (>= Cabins 1)(>= InBath 1)))(>= Out 1)))(and (and (or (>= Dressed 1)(and (>= Bags 1)(>= WaitBag 1)))(or (>= Out 1)(>= Out 1)))(and (and (>= Out 1)(and (>= Bags 1)(>= WaitBag 1)))(not (>= Dressed 1))))))
