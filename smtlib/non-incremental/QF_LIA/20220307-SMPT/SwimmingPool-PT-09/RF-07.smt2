...
(assert (not (or (or (or (not (>= Dress 1))(or (>= Undress 1)(>= Dressed 1)))(or (and (and (>= Cabins 1)(>= Entered 1))(>= Undress 1))(and (and (>= Cabins 1)(>= InBath 1))(and (>= Cabins 1)(>= Entered 1)))))(>= Dress 1))))
