...
(assert (and (and (not (or (>= Out 1)(and (>= Cabins 1)(>= Entered 1))))(not (not (and (>= Cabins 1)(>= Entered 1)))))(and (or (not (and (>= Bags 1)(>= WaitBag 1)))(and (>= Dressed 1)(and (>= Bags 1)(>= WaitBag 1))))(or (or (>= Dress 1)(and (>= Cabins 1)(>= Entered 1)))(not (>= Undress 1))))))
