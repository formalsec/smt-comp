...
Generator: SMPT
Application: Reachability query on the instance SwimmingPool-PT-05 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= (+ Dress Dressed InBath a1 Undress WaitBag) 100))
(assert (= (+ Bags Dress InBath Undress) 75))
(assert (= (+ Cabins Dress Dressed Undress WaitBag) 50))

(assert (and (or (or (and (>= Out 1)(and (>= Cabins 1)(>= InBath 1)))(and (>= Undress 1)(>= Out 1)))(and (or (>= Dress 1)(and (>= Cabins 1)(>= Entered 1)))(or (and (>= Bags 1)(>= WaitBag 1))(>= Dressed 1))))(not (>= Out 1))))
