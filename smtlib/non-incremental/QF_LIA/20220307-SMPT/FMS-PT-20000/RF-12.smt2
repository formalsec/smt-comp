...
Generator: SMPT
Application: Reachability query on the instance FMS-PT-20000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= a7 (+ P2wP1 a6)))
(assert (= a8 (+ P3M2 P3)))
(assert (= (+ a2 P12M3 P12s a5 P2M2 a7) 20000))
(assert (= (+ M3 P12M3) 2))
(assert (= (+ M2 P2M2) 1))
(assert (= (+ a1 a2 P12M3 P12s P1M1 a4) 20000))
(assert (= (+ M1 P1M1) 3))
(assert (= (+ a8 P3s) 20000))

(assert (not (and (or (or (not (>= P2M2 1))(not (and (>= M3 1)(>= P12wM3 1))))(not (and (>= P3M2 1)(>= M2 1))))(or (and (>= P1d 1)(and (>= P2M2 1)(and (>= M1 1)(>= P1wM1 1))))(or (>= P1d 1)(not (>= P12M3 1)))))))
