...
(assert (and (or (or (not (and (>= moved 1)(>= p_m 1)))(or (>= p_i1 1)(>= p_rel 1)))(and (or (>= p_sc 1)(>= p_sc 1))(and (and (>= moved 1)(>= p_m 1))(and (>= moved 1)(>= p_m 1)))))(not (or (and (>= off 1)(>= r_active 1))(or (and (>= move 1)(>= r_active 1))(and (>= move 1)(>= r_active 1)))))))
