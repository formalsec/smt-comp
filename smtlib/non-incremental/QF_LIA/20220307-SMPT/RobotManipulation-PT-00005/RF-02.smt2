...
(assert (not (and (or (and (and (and (>= off 1)(>= r_active 1))(>= r_moving 1))(and (>= p_sc 1)(>= r_moving 1)))(or (or (and (>= initialize 1)(>= r_stopped 1))(>= r_moving 1))(>= p_i1 1)))(or (>= p_rdy 1)(>= p_rdy 1)))))
