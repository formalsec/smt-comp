...
(assert (not (or (or (not (and (>= p_i1 1)(and (>= initialize 1)(>= r_stopped 1))))(and (>= access 1)(>= p_rdy 1)))(or (or (or (and (>= initialize 1)(>= r_stopped 1))(>= r_moving 1))(not (and (>= initialize 1)(>= r_stopped 1))))(and (not (and (>= off 1)(>= r_active 1)))(not (>= p_rel 1)))))))
