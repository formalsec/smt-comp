...
(assert (and (and (not (and (>= p_rel 1)(and (>= initialize 1)(>= r_stopped 1))))(and (not (>= p_rdy 1))(and (and (>= moved 1)(>= p_m 1))(and (>= initialize 1)(>= r_stopped 1)))))(and (and (and (>= p_sc 1)(and (>= off 1)(>= r_active 1)))(and (and (>= moved 1)(>= p_m 1))(>= p_i1 1)))(and (and (>= p_sc 1)(and (>= access 1)(>= p_rdy 1)))(not (and (>= access 1)(>= p_rdy 1)))))))
