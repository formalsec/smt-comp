...
(assert (not (or (and (not (not (>= Pback3 1)))(and (and (>= P2 1)(>= P3 1)(>= Pout4 1))(and (>= P2 1)(>= P3 1)(>= Pout4 1))))(or (or (or (and (>= P2 1)(>= P3 1)(>= Pout4 1))(>= Pback3 1))(or (>= Pm3 1)(>= Pout1 1)))(or (not (>= Pout1 1))(or (>= Pback4 1)(>= Pm4 1)))))))
