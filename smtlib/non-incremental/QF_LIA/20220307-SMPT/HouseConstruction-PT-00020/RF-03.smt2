...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-00020 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (not (and (and (or (>= p17 1)(and (>= p8 1)(>= p9 1)))(and (and (>= p8 1)(>= p9 1))(and (>= p10 1)(>= p12 1)(>= p13 1))))(and (and (>= p11 1)(>= p22 1))(and (>= p6 1)(>= p6 1)))))))
