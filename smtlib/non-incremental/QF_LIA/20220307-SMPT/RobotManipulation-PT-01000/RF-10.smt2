...
(assert (not (or (or (or (>= p_sc 1)(>= p_i1 1))(and (and (and (>= moved 1)(>= p_m 1))(>= p_sc 1))(or (and (>= move 1)(>= r_active 1))(>= p_rdy 1))))(or (and (>= moved 1)(>= p_m 1))(and (and (and (>= initialize 1)(>= r_stopped 1))(>= p_i1 1))(>= p_sc 1))))))
