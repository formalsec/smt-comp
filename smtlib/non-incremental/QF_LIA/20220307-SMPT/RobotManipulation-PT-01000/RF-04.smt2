...
(assert (and (not (or (or (>= r_moving 1)(and (>= off 1)(>= r_active 1)))(or (and (>= move 1)(>= r_active 1))(and (>= move 1)(>= r_active 1)))))(or (and (>= initialize 1)(>= r_stopped 1))(and (>= off 1)(>= r_active 1)))))
