...
(assert (and (and (and (and (and (>= off 1)(>= r_active 1))(>= p_rdy 1))(and (>= p_rel 1)(and (>= access 1)(>= p_rdy 1))))(and (or (>= p_rel 1)(and (>= access 1)(>= p_rdy 1)))(not (and (>= initialize 1)(>= r_stopped 1)))))(and (>= moved 1)(>= p_m 1))))
