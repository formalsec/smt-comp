...
(assert (not (or (or (or (or (and (>= access 1)(>= p_rdy 1))(>= p_rdy 1))(not (>= p_rdy 1)))(>= p_i1 1))(not (and (or (and (>= off 1)(>= r_active 1))(and (>= off 1)(>= r_active 1)))(and (and (>= move 1)(>= r_active 1))(>= p_rel 1)))))))
