...
Generator: SMPT
Application: Reachability query on the instance RobotManipulation-PT-01000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (not (and (not (and (>= initialized 1)(>= p_i2 1)))(or (and (>= move 1)(>= r_active 1))(>= r_moving 1))))(and (and (and (>= r_moving 1)(>= p_rdy 1))(and (>= r_moving 1)(>= p_sc 1)))(and (not (and (>= initialized 1)(>= p_i2 1)))(or (>= p_rdy 1)(and (>= initialized 1)(>= p_i2 1)))))))
