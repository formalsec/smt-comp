...
(assert (not (or (and (or (or (>= p_1_2 1)(>= p_2_0 1))(or (>= p_1_1 1)(>= p_0_1 1)))(and (or (>= p_1_1 1)(>= p_2_2 1))(and (>= p_0_1 1)(>= p_1_2 1))))(or (and (or (>= p_2_1 1)(>= p_2_2 1))(or (>= p_0_0 1)(>= p_1_0 1)))(>= p_2_0 1)))))
