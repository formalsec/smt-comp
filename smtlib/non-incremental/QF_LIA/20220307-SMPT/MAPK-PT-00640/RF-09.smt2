...
(assert (and (and (and (not (and (>= ERKP 1)(>= Phase3 1)))(or (and (>= MEKPP 1)(>= Phase2 1))(and (>= MEK 1)(>= RafP 1))))(and (>= ERKP 1)(>= MEKPP 1)))(not (or (not (>= ERKP_Phase3 1))(and (>= MEKP_Phase2 1)(>= MEKP_Phase2 1))))))
