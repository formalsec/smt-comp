...
(assert (and (and (>= ERKPP_Phase3 1)(not (not (>= MEKPP_Phase2 1))))(and (or (and (>= MEKPP 1)(>= Phase2 1))(and (>= ERKPP_Phase3 1)(>= ERKP_MEKPP 1)))(or (not (and (>= ERK 1)(>= MEKPP 1)))(and (>= ERKPP_Phase3 1)(>= ERKP_MEKPP 1))))))
