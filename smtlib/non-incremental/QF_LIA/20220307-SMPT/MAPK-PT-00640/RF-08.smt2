...
Generator: SMPT
Application: Reachability query on the instance MAPK-PT-00640 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (and (or (or (>= MEK_RafP 1)(and (>= ERKP 1)(>= MEKPP 1)))(or (and (>= ERKPP 1)(>= Phase3 1))(>= MEKP_RafP 1)))(and (not (and (>= MEK 1)(>= RafP 1)))(>= Raf_RasGTP 1)))(or (and (not (>= ERKP_Phase3 1))(and (>= MEKP_Phase2 1)(and (>= MEK 1)(>= RafP 1))))(and (>= Raf 1)(>= RasGTP 1))))))
