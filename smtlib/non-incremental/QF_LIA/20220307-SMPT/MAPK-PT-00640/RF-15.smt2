...
(assert (not (and (and (not (and (>= MEKP_Phase2 1)(>= RafP_Phase1 1)))(and (and (>= MEKPP_Phase2 1)(>= ERKP_MEKPP 1))(and (>= MEKP_RafP 1)(>= MEK_RafP 1))))(and (or (and (>= Raf_RasGTP 1)(>= ERKP_MEKPP 1))(or (>= ERKP_Phase3 1)(and (>= MEKP 1)(>= RafP 1))))(and (>= MEK 1)(>= RafP 1))))))
