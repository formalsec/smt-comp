...
(assert (not (or (not (not (or (and (>= Raf 1)(>= RasGTP 1))(>= MEKPP_Phase2 1))))(or (or (or (and (>= ERK 1)(>= MEKPP 1))(>= RafP_Phase1 1))(or (>= ERKP_MEKPP 1)(>= ERKP_MEKPP 1)))(not (or (>= MEKPP_Phase2 1)(>= ERK_MEKPP 1)))))))
