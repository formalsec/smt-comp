...
(assert (not (or (and (and (<= TaskOnDisk DiskControllerUnit)(<= 2 TransferToDisk))(<= ExecutingTask LoadingMem))(or (<= TaskReady CPUUnit)(or (<= 1 TaskReady)(<= TaskReady TaskOnDisk))))))
