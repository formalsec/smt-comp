...
(assert (or (and (not (<= TaskSuspended TaskSuspended))(and (<= 3 FreeMemSegment)(<= 3 TransferToDisk)))(and (not (<= TaskOnDisk TaskOnDisk))(or (<= CPUUnit DiskControllerUnit)(<= 1 TaskOnDisk)))))
