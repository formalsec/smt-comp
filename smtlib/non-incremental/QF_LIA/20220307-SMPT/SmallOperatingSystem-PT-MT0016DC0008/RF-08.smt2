...
(assert (and (and (and (and (>= TaskReady 1)(>= TransferToDisk 1))(and (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))))(or (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= LoadingMem 1))(>= LoadingMem 1)))(not (not (not (>= LoadingMem 1))))))
