...
(assert (and (and (or (and (>= CPUUnit 1)(>= TaskReady 1))(not (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(not (and (>= CPUUnit 1)(>= TaskReady 1))))(and (and (>= TransferToDisk 1)(>= TransferToDisk 1))(and (and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(>= LoadingMem 1))(and (>= TransferToDisk 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))))))
