...
(assert (not (or (not (or (<= 1 CPUUnit)(<= 1 TaskOnDisk)))(and (or (<= TransferToDisk TaskOnDisk)(<= TransferToDisk ExecutingTask))(or (<= TransferToDisk FreeMemSegment)(<= 1 TaskSuspended))))))
