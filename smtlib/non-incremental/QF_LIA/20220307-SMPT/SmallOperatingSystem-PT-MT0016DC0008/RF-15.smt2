...
(assert (not (or (not (and (or (>= LoadingMem 1)(>= TransferToDisk 1))(and (and (>= CPUUnit 1)(>= TaskReady 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))))(and (>= CPUUnit 1)(>= TaskSuspended 1)))))
