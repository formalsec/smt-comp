...
(assert (not (or (and (or (<= LoadingMem TaskSuspended)(<= 2 DiskControllerUnit))(and (<= 2 TaskSuspended)(<= TransferToDisk TaskReady)))(or (and (<= 1 DiskControllerUnit)(<= ExecutingTask TaskSuspended))(or (<= TaskReady CPUUnit)(<= 3 CPUUnit))))))
