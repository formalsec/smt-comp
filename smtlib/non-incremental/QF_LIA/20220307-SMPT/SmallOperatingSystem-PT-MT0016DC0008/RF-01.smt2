...
(assert (and (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (and (not (and (>= CPUUnit 1)(>= TaskSuspended 1)))(not (and (>= CPUUnit 1)(>= TaskSuspended 1))))(and (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(not (>= ExecutingTask 1))))))
