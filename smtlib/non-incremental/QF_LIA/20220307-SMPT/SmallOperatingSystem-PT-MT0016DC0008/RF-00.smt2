...
(assert (and (not (or (and (>= CPUUnit 1)(>= TaskReady 1))(or (>= LoadingMem 1)(>= LoadingMem 1))))(or (or (not (>= ExecutingTask 1))(not (>= TransferToDisk 1)))(or (or (>= TaskReady 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))))
