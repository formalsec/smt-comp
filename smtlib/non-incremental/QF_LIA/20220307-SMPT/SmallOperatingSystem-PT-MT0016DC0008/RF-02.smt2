...
(assert (and (and (or (and (>= ExecutingTask 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(and (>= TaskReady 1)(>= ExecutingTask 1)))(not (>= ExecutingTask 1)))(not (>= TaskReady 1))))
