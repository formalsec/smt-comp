...
Generator: SMPT
Application: Reachability query on the instance FMS-PT-00010 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= a7 (+ P2wP1 a6)))
(assert (= a8 (+ P3M2 P3)))
(assert (= (+ a2 P12M3 P12s a5 P2M2 a7) 10))
(assert (= (+ M3 P12M3) 2))
(assert (= (+ M2 P2M2) 1))
(assert (= (+ a1 a2 P12M3 P12s P1M1 a4) 10))
(assert (= (+ M1 P1M1) 3))
(assert (= (+ a8 P3s) 10))

(assert (not (or (or (or (or (and (>= M3 1)(>= P12wM3 1))(>= P2d 1))(and (>= P2s 1)(and (>= M2 1)(>= P2wM2 1))))(or (or (>= P2M2 1)(>= P1 1))(not (>= P1d 1))))(and (>= P2d 1)(or (and (>= P2d 1)(>= P3 1))(>= P12s 1))))))
