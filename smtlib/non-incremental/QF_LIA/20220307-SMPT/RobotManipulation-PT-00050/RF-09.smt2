...
(assert (not (or (not (and (or (>= r_moving 1)(and (>= moved 1)(>= p_m 1)))(not (>= p_sc 1))))(or (or (>= p_rdy 1)(not (>= p_sc 1)))(or (and (and (>= move 1)(>= r_active 1))(and (>= move 1)(>= r_active 1)))(not (>= p_rel 1)))))))
