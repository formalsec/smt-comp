...
(assert (not (not (and (and (and (and (>= moved 1)(>= p_m 1))(and (>= off 1)(>= r_active 1)))(>= p_sc 1))(and (and (and (>= initialize 1)(>= r_stopped 1))(and (>= move 1)(>= r_active 1)))(not (and (>= initialize 1)(>= r_stopped 1))))))))
