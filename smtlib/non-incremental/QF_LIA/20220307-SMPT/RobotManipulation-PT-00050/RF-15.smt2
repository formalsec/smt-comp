...
Generator: SMPT
Application: Reachability query on the instance RobotManipulation-PT-00050 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (not (or (or (>= p_i1 1)(and (>= initialized 1)(>= p_i2 1)))(or (and (>= move 1)(>= r_active 1))(and (>= off 1)(>= r_active 1)))))(or (or (and (>= initialized 1)(>= p_i2 1))(or (>= p_i1 1)(and (>= off 1)(>= r_active 1))))(not (and (>= p_rdy 1)(>= p_sc 1)))))))
