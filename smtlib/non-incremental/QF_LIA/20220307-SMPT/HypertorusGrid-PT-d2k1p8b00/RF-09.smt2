...
(assert (not (or (or (not (or (and (>= pbl_1_1 1)(>= po_d1_n1_1_1 1))(and (>= pbl_1_1 1)(>= pi_d2_n1_1_1 1))))(or (not (and (>= pb_d2_n2_1_1 1)(>= pil_d2_n1_1_1 1)))(not (and (>= pbl_1_1 1)(>= po_d1_n1_1_1 1)))))(or (and (>= pbl_1_1 1)(>= po_d1_n1_1_1 1))(and (>= pbl_1_1 1)(>= pi_d1_n1_1_1 1))))))
