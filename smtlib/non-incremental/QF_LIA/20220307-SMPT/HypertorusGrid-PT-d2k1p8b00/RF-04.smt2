...
(assert (and (and (not (not (and (>= pb_d1_n2_1_1 1)(>= pil_d1_n1_1_1 1))))(not (not (and (>= pbl_1_1 1)(>= po_d2_n1_1_1 1)))))(and (and (and (and (>= pbl_1_1 1)(>= pi_d1_n1_1_1 1))(and (>= pbl_1_1 1)(>= po_d2_n1_1_1 1)))(and (>= pbl_1_1 1)(>= pi_d2_n1_1_1 1)))(and (>= pb_d2_n1_1_1 1)(>= pol_d2_n1_1_1 1)))))
