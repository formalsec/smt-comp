...
(assert (not (or (not (and (and (and (>= pbl_1_1 1)(>= pi_d2_n1_1_1 1))(and (>= pbl_1_1 1)(>= po_d2_n1_1_1 1)))(not (and (>= pbl_1_1 1)(>= po_d2_n1_1_1 1)))))(or (not (not (and (>= pbl_1_1 1)(>= pi_d1_n1_1_1 1))))(and (or (and (>= pbl_1_1 1)(>= pi_d2_n1_1_1 1))(and (>= pbl_1_1 1)(>= po_d2_n1_1_1 1)))(not (and (>= pbl_1_1 1)(>= po_d1_n1_1_1 1))))))))
