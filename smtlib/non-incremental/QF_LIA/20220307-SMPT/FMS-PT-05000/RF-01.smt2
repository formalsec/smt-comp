...
Generator: SMPT
Application: Reachability query on the instance FMS-PT-05000 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= a7 (+ P2wP1 a6)))
(assert (= a8 (+ P3M2 P3)))
(assert (= (+ a2 P12M3 P12s a5 P2M2 a7) 5000))
(assert (= (+ M3 P12M3) 2))
(assert (= (+ M2 P2M2) 1))
(assert (= (+ a1 a2 P12M3 P12s P1M1 a4) 5000))
(assert (= (+ M1 P1M1) 3))
(assert (= (+ a8 P3s) 5000))

(assert (not (or (and (>= P1 1)(>= P2d 1))(or (or (and (and (>= P3M2 1)(>= M2 1))(>= P12M3 1))(and (and (>= M3 1)(>= P12wM3 1))(>= P1s 1)))(not (and (>= P2d 1)(>= P12s 1)))))))
