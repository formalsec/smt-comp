...
(assert (not (or (or (and (not (>= TransferToDisk 1))(and (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= TaskReady 1)))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1)))(or (not (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskReady 1))))(not (not (and (>= CPUUnit 1)(>= TaskReady 1))))))))
