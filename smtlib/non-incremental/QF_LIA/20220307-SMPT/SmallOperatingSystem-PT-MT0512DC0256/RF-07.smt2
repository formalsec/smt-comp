...
(assert (not (or (and (or (and (and (>= CPUUnit 1)(>= TaskReady 1))(>= TransferToDisk 1))(>= ExecutingTask 1))(not (>= TaskReady 1)))(not (not (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= TransferToDisk 1)))))))
