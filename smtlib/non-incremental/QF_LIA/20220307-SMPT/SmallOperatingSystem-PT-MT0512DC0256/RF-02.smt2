...
(assert (not (and (or (or (>= ExecutingTask 1)(>= ExecutingTask 1))(>= TaskReady 1))(or (and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))(or (>= ExecutingTask 1)(and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))))))
