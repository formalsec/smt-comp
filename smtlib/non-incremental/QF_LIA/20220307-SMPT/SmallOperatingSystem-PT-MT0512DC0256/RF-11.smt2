...
(assert (and (not (and (>= CPUUnit 1)(>= TaskReady 1)))(or (and (>= TaskReady 1)(and (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(and (>= CPUUnit 1)(>= TaskSuspended 1))))(and (and (and (>= CPUUnit 1)(>= TaskReady 1))(>= TaskReady 1))(and (>= CPUUnit 1)(>= TaskReady 1))))))
