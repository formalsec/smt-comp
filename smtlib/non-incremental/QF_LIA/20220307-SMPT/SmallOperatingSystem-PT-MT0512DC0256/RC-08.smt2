...
(assert (and (and (and (<= TransferToDisk TaskOnDisk)(<= 2 CPUUnit))(not (<= FreeMemSegment LoadingMem)))(and (or (<= 2 TransferToDisk)(<= ExecutingTask TransferToDisk))(and (<= DiskControllerUnit LoadingMem)(<= LoadingMem CPUUnit)))))
