...
(assert (and (and (and (and (>= ExecutingTask 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))(not (>= ExecutingTask 1)))(and (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= CPUUnit 1)(>= TaskSuspended 1)))(or (and (>= CPUUnit 1)(>= TaskReady 1))(>= LoadingMem 1))))(and (and (or (>= ExecutingTask 1)(>= ExecutingTask 1))(or (>= TransferToDisk 1)(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(not (and (>= ExecutingTask 1)(and (>= CPUUnit 1)(>= TaskSuspended 1)))))))
