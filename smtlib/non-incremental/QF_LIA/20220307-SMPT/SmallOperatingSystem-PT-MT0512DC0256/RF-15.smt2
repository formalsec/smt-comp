...
Generator: SMPT
Application: Reachability query on the instance SmallOperatingSystem-PT-MT0512DC0256 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (= TaskOnDisk (+ DiskControllerUnit 256)))
...
(assert (= (+ a4 LoadingMem) 256))
(assert (= (+ FreeMemSegment LoadingMem a5) 512))

(assert (and (and (or (or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= LoadingMem 1))(or (and (>= CPUUnit 1)(>= TaskSuspended 1))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(and (not (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1)))(and (>= DiskControllerUnit 1)(>= TaskOnDisk 1)(>= TaskSuspended 1))))(and (not (or (and (>= DiskControllerUnit 1)(>= FreeMemSegment 1)(>= TaskOnDisk 1))(>= TaskReady 1)))(or (not (>= ExecutingTask 1))(or (and (>= CPUUnit 1)(>= TaskSuspended 1))(>= LoadingMem 1))))))
