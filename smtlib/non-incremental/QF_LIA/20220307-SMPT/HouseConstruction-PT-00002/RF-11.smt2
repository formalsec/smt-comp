...
Generator: SMPT
Application: Reachability query on the instance HouseConstruction-PT-00002 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (not (>= p14 1))(>= p14 1))(and (or (or (>= p14 1)(>= p22 1))(and (>= p22 1)(>= p1 1)))(and (and (and (>= p19 1)(>= p20 1))(>= p7 1))(not (and (>= p25 1)(>= p26 1)(>= p27 1))))))))
