...
(assert (and (and (or (not (>= P2s 1))(not (and (>= P3M2 1)(>= M2 1))))(or (or (>= P3s 1)(>= P3s 1))(>= P2M2 1)))(and (and (or (>= P12s 1)(>= P12 1))(or (and (>= M3 1)(>= P12wM3 1))(and (>= M1 1)(>= P1wM1 1))))(or (not (>= P12M3 1))(>= P1M1 1)))))
