...
(assert (not (or (or (or (and (>= RKIPP_RP 1)(and (>= ERKPP 1)(>= Raf1Star_RKIP 1)))(or (>= Raf1Star_RKIP_ERKPP 1)(>= MEKPP_ERK 1)))(not (>= MEKPP_ERK 1)))(or (not (and (>= MEKPP_ERK 1)(>= MEKPP_ERK 1)))(and (or (>= Raf1Star_RKIP 1)(>= MEKPP_ERK 1))(not (>= Raf1Star_RKIP_ERKPP 1)))))))
