...
(assert (not (or (or (and (and (and (>= ERK 1)(>= MEKPP 1))(and (>= RKIP 1)(>= Raf1Star 1)))(>= MEKPP_ERK 1))(not (not (and (>= RKIP 1)(>= Raf1Star 1)))))(or (not (or (and (>= RKIP 1)(>= Raf1Star 1))(>= RKIPP_RP 1)))(>= Raf1Star_RKIP_ERKPP 1)))))
