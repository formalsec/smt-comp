...
(assert (and (and (and (and (>= Raf1Star_RKIP 1)(>= RKIPP_RP 1))(and (and (>= RKIP 1)(>= Raf1Star 1))(>= Raf1Star_RKIP 1)))(and (not (>= Raf1Star_RKIP 1))(or (and (>= ERKPP 1)(>= Raf1Star_RKIP 1))(>= RKIPP_RP 1))))(or (and (not (>= RKIPP_RP 1))(and (and (>= ERK 1)(>= MEKPP 1))(and (>= RKIP 1)(>= Raf1Star 1))))(and (not (>= Raf1Star_RKIP_ERKPP 1))(and (>= ERKPP 1)(>= Raf1Star_RKIP 1))))))
