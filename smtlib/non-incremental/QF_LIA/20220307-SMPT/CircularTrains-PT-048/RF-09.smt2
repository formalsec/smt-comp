...
(assert (and (or (and (>= F6 1)(>= Section_5 1))(not (and (>= F7 1)(>= Section_6 1))))(and (and (and (and (>= F27 1)(>= Section_26 1))(and (>= F45 1)(>= Section_44 1)))(and (and (>= F15 1)(>= Section_14 1))(and (>= F15 1)(>= Section_14 1))))(and (not (and (>= F7 1)(>= Section_6 1)))(not (and (>= F43 1)(>= Section_42 1)))))))
