...
(assert (not (or (and (not (and (>= Bags 1)(>= WaitBag 1)))(or (and (>= Dressed 1)(>= Out 1))(and (and (>= Bags 1)(>= WaitBag 1))(>= Dress 1))))(or (not (not (and (>= Cabins 1)(>= InBath 1))))(or (>= Dress 1)(not (>= Dress 1)))))))
