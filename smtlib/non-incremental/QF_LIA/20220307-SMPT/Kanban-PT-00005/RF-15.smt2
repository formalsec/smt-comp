...
Generator: SMPT
Application: Reachability query on the instance Kanban-PT-00005 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (>= Pm2 1)(or (>= Pback3 1)(not (and (>= P1 1)(>= Pout2 1)(>= Pout3 1)))))(and (>= P1 1)(>= Pout2 1)(>= Pout3 1)))))
