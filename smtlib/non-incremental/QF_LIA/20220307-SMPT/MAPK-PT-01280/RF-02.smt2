...
(assert (and (not (and (or (and (>= Raf 1)(>= RasGTP 1))(and (>= Raf 1)(>= RasGTP 1)))(or (>= MEK_RafP 1)(and (>= ERKP 1)(>= Phase3 1)))))(and (not (or (>= MEKPP_Phase2 1)(and (>= ERK 1)(>= MEKPP 1))))(not (not (>= MEK_RafP 1))))))
