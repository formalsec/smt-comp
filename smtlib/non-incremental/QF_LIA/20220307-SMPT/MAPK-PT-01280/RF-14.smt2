...
(assert (and (not (or (and (>= ERK_MEKPP 1)(and (>= Raf 1)(>= RasGTP 1)))(not (>= RafP_Phase1 1))))(and (and (or (and (>= MEKP 1)(>= RafP 1))(>= MEK_RafP 1))(>= ERK_MEKPP 1))(or (or (and (>= MEKP 1)(>= RafP 1))(>= ERK_MEKPP 1))(and (>= Phase1 1)(>= RafP 1))))))
