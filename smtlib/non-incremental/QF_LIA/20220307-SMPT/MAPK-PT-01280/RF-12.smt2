...
Generator: SMPT
Application: Reachability query on the instance MAPK-PT-01280 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (not (or (or (or (and (>= Raf_RasGTP 1)(and (>= MEK 1)(>= RafP 1)))(>= RafP_Phase1 1))(or (or (and (>= Raf 1)(>= RasGTP 1))(>= MEKP_Phase2 1))(and (>= MEKPP_Phase2 1)(>= ERKP_Phase3 1))))(not (and (and (>= MEKPP 1)(>= Phase2 1))(and (>= MEKPP_Phase2 1)(>= RafP_Phase1 1)))))))
