...
(assert (not (or (or (and (and (>= p_i1 1)(and (>= initialized 1)(>= p_i2 1)))(or (>= p_sc 1)(and (>= moved 1)(>= p_m 1))))(and (>= moved 1)(>= p_m 1)))(or (or (not (and (>= initialized 1)(>= p_i2 1)))(or (and (>= initialized 1)(>= p_i2 1))(and (>= moved 1)(>= p_m 1))))(not (or (and (>= initialize 1)(>= r_stopped 1))(>= p_rdy 1)))))))
