...
Generator: SMPT
Application: Reachability query on the instance RobotManipulation-PT-00500 from the Model Checking Contest 2021 using the SMPT model-checker
Target solver: z3
...
(assert (and (or (and (or (and (>= initialize 1)(>= r_stopped 1))(and (>= off 1)(>= r_active 1)))(and (>= off 1)(>= r_active 1)))(and (not (>= p_rdy 1))(and (>= p_i1 1)(and (>= move 1)(>= r_active 1)))))(and (not (or (>= p_rel 1)(and (>= moved 1)(>= p_m 1))))(and (not (and (>= move 1)(>= r_active 1)))(or (and (>= moved 1)(>= p_m 1))(and (>= move 1)(>= r_active 1)))))))
