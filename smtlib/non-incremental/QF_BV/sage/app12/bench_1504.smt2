...
(assert (let ((?v_2 (bvult (_ bv0 32) T4_10467)) (?v_1 (bvsub (_ bv0 32) ((_ zero_extend 24) (ite (bvult T4_10467 (_ bv0 32)) (_ bv1 8) (_ bv0 8)))))) (let ((?v_0 (bvule ?v_1 (_ bv0 32)))) (and true (= T4_962 (bvor (bvshl (bvor (bvshl (bvor (bvshl ((_ zero_extend 24) T1_965) (_ bv8 32)) ((_ zero_extend 24) T1_964)) (_ bv8 32)) ((_ zero_extend 24) T1_963)) (_ bv8 32)) ((_ zero_extend 24) T1_962))) (= T4_10467 (bvor (bvshl (bvor (bvshl (bvor (bvshl ((_ zero_extend 24) T1_10470) (_ bv8 32)) ((_ zero_extend 24) T1_10469)) (_ bv8 32)) ((_ zero_extend 24) T1_10468)) (_ bv8 32)) ((_ zero_extend 24) T1_10467))) (bvult T4_10467 (_ bv258 32)) ?v_0 ?v_0 (bvule (_ bv0 32) ?v_1) (not (= T4_962 (_ bv4294967295 32))) ?v_2 ?v_2 (bvule T4_10467 (_ bv2048 32)) (not (= (_ bv0 32) T4_10467)) (bvule (_ bv0 32) T4_10467) (= T4_962 T4_10467) (not (= T4_10467 (_ bv0 32)))))))
(check-sat)
(exit)
