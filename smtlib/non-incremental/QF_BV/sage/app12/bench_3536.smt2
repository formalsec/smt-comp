...
(assert (and true (= T4_5786 (bvor (bvshl (bvor (bvshl (bvor (bvshl ((_ zero_extend 24) T1_5789) (_ bv8 32)) ((_ zero_extend 24) T1_5788)) (_ bv8 32)) ((_ zero_extend 24) T1_5787)) (_ bv8 32)) ((_ zero_extend 24) T1_5786))) (= T4_10796 (bvor (bvshl (bvor (bvshl (bvor (bvshl ((_ zero_extend 24) T1_10799) (_ bv8 32)) ((_ zero_extend 24) T1_10798)) (_ bv8 32)) ((_ zero_extend 24) T1_10797)) (_ bv8 32)) ((_ zero_extend 24) T1_10796))) (bvslt T4_10796 (_ bv0 32)) (not (= T4_5786 (_ bv4294967295 32))) (not (= (_ bv0 32) T4_10796)) (bvule (_ bv0 32) T4_10796) (= T4_5786 T4_10796) (not (= T4_10796 (_ bv0 32)))))
(check-sat)
(exit)
